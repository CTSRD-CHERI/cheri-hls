...
rm -rf ${FLUTE}/builds/RV64ACIMUxCHERI_Flute_verilator_cap
...
mv ${FLUTE}/builds/RV64ACIMUxCHERI_Flute_verilator \
   ${FLUTE}/builds/RV64ACIMUxCHERI_Flute_verilator_cap
cd ${FLUTE}/builds/RV64ACIMUxCHERI_Flute_verilator_cap
