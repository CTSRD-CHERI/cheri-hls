...
define void @_Z7hls_topiPiS_S_(i32 %size, i32* "fpga.decayed.dim.hint"="10" %a, i32* "fpga.decayed.dim.hint"="10" %b, i32* "fpga.decayed.dim.hint"="10" %c, i32* %flag, i32* "fpga.decayed.dim.hint"="12" %cap) #100017 !dbg !101493 !fpga.function.pragma !101496 {
entry:
  ...
  call void @llvm.dbg.value(metadata i32* %c, metadata !22, metadata !DIExpression()), !dbg !23
  call void @llvm.sideeffect() #4 [ "xlx_m_axi"(i32* %a, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !24
  call void @llvm.sideeffect() #4 [ "xlx_m_axi"(i32* %b, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !25
  call void @llvm.sideeffect() #4 [ "xlx_m_axi"(i32* %c, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !26
  ...
  %arraydecay = getelementptr inbounds [12 x i32], [12 x i32]* %buffer, i32 0, i32 0, !dbg !101508
  %arraydecay1 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i32 0, i32 0, !dbg !101509
  call void @_Z8load_capiPjS_P3Cap(i32 3, i32* %arraydecay, i32* %cap, %struct.Cap* %arraydecay1), !dbg !101510
  br label %VITIS_LOOP_19_1, !dbg !28

VITIS_LOOP_19_1:                                  ; preds = %entry
  call void @llvm.dbg.value(metadata i32 0, metadata !29, metadata !DIExpression()), !dbg !31
  br label %for.cond, !dbg !32

for.cond:                                         ; preds = %for.inc, %VITIS_LOOP_19_1
  %i.0 = phi i32 [ 0, %VITIS_LOOP_19_1 ], [ %inc, %for.inc ]
  call void @llvm.dbg.value(metadata i32 %i.0, metadata !29, metadata !DIExpression()), !dbg !31
  %cmp = icmp slt i32 %i.0, %size, !dbg !33
...
for.body:                                         ; preds = %for.cond
  %arrayidx0 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101550
  ...
  %0 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %a, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %0, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arrayidx1 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101550
  %load.1 = load %struct.Cap, %struct.Cap* %arrayidx1, align 4, !dbg !101550
  store %struct.Cap %load.1, %struct.Cap* %agg.tmp1, align 4, !dbg !101550
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %b, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101552
  ...
  %arrayidx2 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101563
  %store.2 = load %struct.Cap, %struct.Cap* %arrayidx2, align 4, !dbg !101563
  store %struct.Cap %store.2, %struct.Cap* %agg.tmp2, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %c, i32 %i.0, i32 %mul, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101564
...
attributes #4 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="320" "xlx.source"="user" }
...
!7 = distinct !DISubprogram(name: "hls_top", linkageName: "_Z7hls_topiPiS_S_", scope: !8, file: !8, line: 12, type: !9, isLocal: false, isDefinition: true, scopeLine: 12, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
...
!13 = !{!14}
!14 = !{!"fpga.top", !"user", !15}
!15 = !DILocation(line: 12, column: 16, scope: !7)
!16 = !DILocalVariable(name: "size", arg: 1, scope: !7, file: !8, line: 12, type: !11)
!17 = !DILocation(line: 12, column: 60, scope: !7)
!18 = !DILocalVariable(name: "a", arg: 2, scope: !7, file: !8, line: 12, type: !12)
!19 = !DILocation(line: 12, column: 70, scope: !7)
!20 = !DILocalVariable(name: "b", arg: 3, scope: !7, file: !8, line: 12, type: !12)
!21 = !DILocation(line: 12, column: 81, scope: !7)
!22 = !DILocalVariable(name: "c", arg: 4, scope: !7, file: !8, line: 12, type: !12)
!23 = !DILocation(line: 12, column: 92, scope: !7)
...
!29 = !DILocalVariable(name: "i", scope: !30, file: !8, line: 19, type: !11)
!30 = distinct !DILexicalBlock(scope: !7, file: !8, line: 19, column: 19)
!31 = !DILocation(line: 19, column: 28, scope: !30)
!32 = !DILocation(line: 19, column: 24, scope: !30)
!33 = !DILocation(line: 19, column: 37, scope: !34)
!34 = distinct !DILexicalBlock(scope: !30, file: !8, line: 19, column: 19)
!35 = !DILocation(line: 19, column: 19, scope: !30)
!36 = !DILocation(line: 21, column: 9, scope: !37)
!37 = distinct !DILexicalBlock(scope: !34, file: !8, line: 20, column: 1)
!38 = !DILocation(line: 21, column: 16, scope: !37)
!39 = !DILocation(line: 21, column: 14, scope: !37)
!40 = !DILocation(line: 21, column: 2, scope: !37)
!41 = !DILocation(line: 21, column: 7, scope: !37)
!42 = !DILocation(line: 21, column: 19, scope: !37)
!43 = !DILocation(line: 19, column: 46, scope: !34)
!44 = !DILocation(line: 19, column: 19, scope: !34)
!45 = distinct !{!45, !35, !46, !47, !49}
!46 = !DILocation(line: 21, column: 19, scope: !30)
!47 = !{!"llvm.loop.pipeline.enable", i32 -1, i1 false, i8 -1, !"user", !48}
!48 = !DILocation(line: 20, column: 9, scope: !30)
!49 = !{!"llvm.loop.name", !"VITIS_LOOP_19_1"}
!50 = !DILocation(line: 22, column: 1, scope: !7)
