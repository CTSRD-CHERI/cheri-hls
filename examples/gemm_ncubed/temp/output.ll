...
; Function Attrs: nounwind
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="4096" %xm1, i32* "fpga.decayed.dim.hint"="4096" %xm2, i32* "fpga.decayed.dim.hint"="4096" %xprod, i32* %flag, i32* "fpga.decayed.dim.hint"="12" %cap) #3 !dbg !101603 !fpga.function.pragma !101606 {
entry:
...
for.body23:                                       ; preds = %for.cond21
  ...
  %5 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer4, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101527
  ...
  %6 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer5, i32 %add27, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101527
...
for.end34:                                        ; preds = %for.cond21
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer6, i32 %add35, i32 %sum.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101539
...
for.end43:                                        ; preds = %for.cond14
  ...
  %decay.7 = getelementptr inbounds [4096 x i32], [4096 x i32]* %prod, i32 0, i32 0, !dbg !101539

  %cap.arrayidx7 = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101539
  %store.7 = load %struct.Cap, %struct.Cap* %cap.arrayidx7, align 4, !dbg !101539
  store %struct.Cap %store.7, %struct.Cap* %agg.tmp2, align 4, !dbg !101539

  %cap.arrayidx7b = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i64 0, i64 5, !dbg !101539
  %store.7b = load %struct.Cap, %struct.Cap* %cap.arrayidx7b, align 4, !dbg !101539
  store %struct.Cap %store.7b, %struct.Cap* %agg.tmp5, align 4, !dbg !101539

  call void @_Z18cheri_stream_writejPiS_Pj3CapS1_(i32 %mul44, i32* %xprod, i32* %decay.7, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101539
