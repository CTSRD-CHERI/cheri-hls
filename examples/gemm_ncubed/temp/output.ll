...
for.body23:                                       ; preds = %for.cond21
  ...
  %5 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer4, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101552
  ...
  %6 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer5, i32 %add27, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101552
...
for.end34:                                        ; preds = %for.cond21
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer6, i32 %add35, i32 %sum.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101564
...
for.body47:                                       ; preds = %for.cond44
  ...
  %7 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer7, i32 %i.3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101552
  ...
  store %struct.Cap %store.8, %struct.Cap* %agg.tmp2, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xprod, i32 %i.3, i32 %7, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101564
