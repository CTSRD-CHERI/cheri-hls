...
for.body47:                                       ; preds = %for.cond44
  ...
  store %struct.Cap %load.7, %struct.Cap* %agg.tmp5, align 4, !dbg !101550
  %7 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer7, i32 %i.3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %7, metadata !101521, metadata !DIExpression()), !dbg !101529
  %cap.arrayidx8 = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101550
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xprod, i32 %i.3, i32 %7, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101539
