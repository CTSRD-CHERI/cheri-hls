...
void XHls_top_Set_key_array(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_KEY_ARRAY_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
...
u64 XHls_top_Get_key_array(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_KEY_ARRAY_DATA);
...
void XHls_top_Set_enckey_array(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_ENCKEY_ARRAY_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
...
u64 XHls_top_Get_enckey_array(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_ENCKEY_ARRAY_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_ENCKEY_ARRAY_DATA + 4)
          << 32;
  return Data;
...
void XHls_top_Set_deckey_array(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_DECKEY_ARRAY_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
...
u64 XHls_top_Get_deckey_array(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_DECKEY_ARRAY_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_DECKEY_ARRAY_DATA + 4)
          << 32;
  return Data;
