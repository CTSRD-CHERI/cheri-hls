open_project -reset vect_mult_local_prj
set_top hls_top 
add_files { vect_mult_local.cpp }
add_files -tb { vect_mult_local.cpp }
...
set ::LLVM_CUSTOM_CMD {/local/ecad/xilinx/new/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/bin/llvm-dis /workspace/examples/vect_mult_local/temp/test.bc}
#a.g.ld.6.user.ll
