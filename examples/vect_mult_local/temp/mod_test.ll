...
define void @_Z7hls_topiPiS_PjS0_(i32 %size, i32* "fpga.decayed.dim.hint"="1000" %a, i32* "fpga.decayed.dim.hint"="1000" %c, i32* %flag, i32* "fpga.decayed.dim.hint"="8" %cap) #100018 !dbg !101522 !fpga.function.pragma !101525 {
entry:
  ...
  call void @llvm.dbg.value(metadata i32 %size, metadata !101528, metadata !DIExpression()), !dbg !101529
  call void @llvm.dbg.value(metadata i32* %a, metadata !101530, metadata !DIExpression()), !dbg !101531
  call void @llvm.dbg.value(metadata i32* %c, metadata !101532, metadata !DIExpression()), !dbg !101533
  call void @llvm.dbg.value(metadata i32* %flag, metadata !101534, metadata !DIExpression()), !dbg !101535
  call void @llvm.dbg.value(metadata i32* %cap, metadata !101536, metadata !DIExpression()), !dbg !101537
  call void @llvm.sideeffect() #100021 [ "xlx_m_axi"(i32* %a, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !101538
  call void @llvm.sideeffect() #100021 [ "xlx_m_axi"(i32* %c, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !101539
  call void @llvm.sideeffect() #100022 [ "xlx_m_axi"(i32* %cap, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !101540
  call void @llvm.sideeffect() #100023 [ "xlx_s_axilite"(i32 %size, [0 x i8] zeroinitializer, i64 -1, i1 false, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer) ], !dbg !101541
  call void @llvm.sideeffect() #100024 [ "xlx_s_axilite"(i32* %flag, [0 x i8] zeroinitializer, i64 -1, i1 false, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer) ], !dbg !101542
  call void @llvm.sideeffect() #100024 [ "xlx_s_axilite"(i8* null, [0 x i8] zeroinitializer, i64 -1, i1 false, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer) ], !dbg !101543
  %0 = bitcast [1000 x i32]* %b to i8*, !dbg !101544
  call void @llvm.lifetime.start.p0i8(i64 4000, i8* %0) #100020, !dbg !101544
  call void @llvm.dbg.declare(metadata [1000 x i32]* %b, metadata !101545, metadata !DIExpression()), !dbg !101549
  %1 = bitcast [1000 x i32]* %b to i8*, !dbg !101549
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %1, i8* align 4 bitcast ([1000 x i32]* @_ZZ7hls_topiPiS_PjS0_E1b to i8*), i64 4000, i1 false), !dbg !101549
  %2 = bitcast i32* %flag_buf to i8*, !dbg !101550
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %2) #100020, !dbg !101550
  call void @llvm.dbg.declare(metadata i32* %flag_buf, metadata !101551, metadata !DIExpression()), !dbg !101552
  store i32 0, i32* %flag_buf, align 4, !dbg !101552
  %3 = bitcast [3 x %struct.Cap]* %caps to i8*, !dbg !101553
  call void @llvm.lifetime.start.p0i8(i64 36, i8* %3) #100020, !dbg !101553
  call void @llvm.dbg.declare(metadata [3 x %struct.Cap]* %caps, metadata !101554, metadata !DIExpression()), !dbg !101558
  %4 = bitcast [12 x i32]* %buffer to i8*, !dbg !101559
  call void @llvm.lifetime.start.p0i8(i64 48, i8* %4) #100020, !dbg !101559
  call void @llvm.dbg.declare(metadata [12 x i32]* %buffer, metadata !101560, metadata !DIExpression()), !dbg !101564
  call void @llvm.sideeffect() #100025 [ "xlx_array_partition"([12 x i32]* %buffer, i32 2, i32 0, i32 1, i1 false) ], !dbg !101565
  call void @llvm.sideeffect() #100026 [ "xlx_array_partition"([3 x %struct.Cap]* %caps, i32 2, i32 0, i32 1, i1 false) ], !dbg !101566
  %arraydecay = getelementptr inbounds [12 x i32], [12 x i32]* %buffer, i32 0, i32 0, !dbg !101567
  %arraydecay1 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i32 0, i32 0, !dbg !101568
  call void @_Z8load_capiPjS_P3Cap(i32 2, i32* %arraydecay, i32* %cap, %struct.Cap* %arraydecay1), !dbg !101569
  %arraydecay2 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i32 0, i32 0, !dbg !101570
  call void @_Z10create_capiP3Caph(i32 1000, %struct.Cap* %arraydecay2, i8 zeroext 2), !dbg !101571
  br label %VITIS_LOOP_172_1, !dbg !101571

VITIS_LOOP_172_1:                                 ; preds = %entry
  call void @llvm.dbg.value(metadata i32 0, metadata !101572, metadata !DIExpression()), !dbg !101574
  br label %for.cond, !dbg !101575

for.cond:                                         ; preds = %for.inc, %VITIS_LOOP_172_1
  %i.0 = phi i32 [ 0, %VITIS_LOOP_172_1 ], [ %inc, %for.inc ]
  call void @llvm.dbg.value(metadata i32 %i.0, metadata !101572, metadata !DIExpression()), !dbg !101574
  %cmp = icmp slt i32 %i.0, %size, !dbg !101576
  br i1 %cmp, label %for.body, label %for.cond.cleanup, !dbg !101578

for.cond.cleanup:                                 ; preds = %for.cond
  br label %for.end

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101579
  %5 = load %struct.Cap, %struct.Cap* %arrayidx, align 4, !dbg !101579
  store %struct.Cap %5, %struct.Cap* %agg.tmp, align 4, !dbg !101579
  %call = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %a, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp), !dbg !101581
  call void @llvm.dbg.value(metadata i32 %call, metadata !101582, metadata !DIExpression()), !dbg !101583
  %arraydecay3 = getelementptr inbounds [1000 x i32], [1000 x i32]* %b, i32 0, i32 0, !dbg !101584
  %arrayidx5 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101585
  %6 = load %struct.Cap, %struct.Cap* %arrayidx5, align 4, !dbg !101585
  store %struct.Cap %6, %struct.Cap* %agg.tmp4, align 4, !dbg !101585
  %call6 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraydecay3, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101586
  call void @llvm.dbg.value(metadata i32 %call6, metadata !101587, metadata !DIExpression()), !dbg !101588
  %mul = mul nsw i32 %call, %call6, !dbg !101589
  call void @llvm.dbg.value(metadata i32 %mul, metadata !101590, metadata !DIExpression()), !dbg !101591
  %arrayidx8 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101592
  %7 = load %struct.Cap, %struct.Cap* %arrayidx8, align 4, !dbg !101592
  store %struct.Cap %7, %struct.Cap* %agg.tmp7, align 4, !dbg !101592
  call void @_Z11cheri_storePiiiPj3Cap(i32* %c, i32 %i.0, i32 %mul, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101593
  br label %for.inc, !dbg !101594

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !dbg !101595
  call void @llvm.dbg.value(metadata i32 %inc, metadata !101572, metadata !DIExpression()), !dbg !101574
  br label %for.cond, !dbg !101596, !llvm.loop !101597

for.end:                                          ; preds = %for.cond.cleanup
  %arraydecay9 = getelementptr inbounds [1000 x i32], [1000 x i32]* %b, i32 0, i32 0, !dbg !101602
  %arrayidx11 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101603
  %8 = load %struct.Cap, %struct.Cap* %arrayidx11, align 4, !dbg !101603
  store %struct.Cap %8, %struct.Cap* %agg.tmp10, align 4, !dbg !101603
  call void @_Z18cheri_stream_writejPiS_Pj3Cap(i32 %size, i32* %a, i32* %arraydecay9, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101604
  %9 = load i32, i32* %flag_buf, align 4, !dbg !101605
  store i32 %9, i32* %flag, align 4, !dbg !101606
  %10 = bitcast [12 x i32]* %buffer to i8*, !dbg !101607
  call void @llvm.lifetime.end.p0i8(i64 48, i8* %10) #100020, !dbg !101607
  %11 = bitcast [3 x %struct.Cap]* %caps to i8*, !dbg !101607
  call void @llvm.lifetime.end.p0i8(i64 36, i8* %11) #100020, !dbg !101607
  %12 = bitcast i32* %flag_buf to i8*, !dbg !101607
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %12) #100020, !dbg !101607
  %13 = bitcast [1000 x i32]* %b to i8*, !dbg !101607
  call void @llvm.lifetime.end.p0i8(i64 4000, i8* %13) #100020, !dbg !101607
  ret void, !dbg !101607
}
