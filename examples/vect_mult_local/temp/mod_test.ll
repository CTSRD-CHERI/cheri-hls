...
define void @_Z7hls_topiPiS_PjS0_(i32 %size, i32* "fpga.decayed.dim.hint"="1000" %a, i32* "fpga.decayed.dim.hint"="1000" %c, i32* %flag, i32* "fpga.decayed.dim.hint"="8" %cap) #100019 !dbg !101603 !fpga.function.pragma !101606 {
entry:
  ...
  call void @llvm.dbg.value(metadata i32 %size, metadata !101609, metadata !DIExpression()), !dbg !101610
  call void @llvm.dbg.value(metadata i32* %a, metadata !101611, metadata !DIExpression()), !dbg !101612
  call void @llvm.dbg.value(metadata i32* %c, metadata !101613, metadata !DIExpression()), !dbg !101614
  call void @llvm.dbg.value(metadata i32* %flag, metadata !101615, metadata !DIExpression()), !dbg !101616
  call void @llvm.dbg.value(metadata i32* %cap, metadata !101617, metadata !DIExpression()), !dbg !101618
  call void @llvm.sideeffect() #100022 [ "xlx_m_axi"(i32* %a, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !101619
  call void @llvm.sideeffect() #100022 [ "xlx_m_axi"(i32* %c, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !101620
  call void @llvm.sideeffect() #100023 [ "xlx_m_axi"(i32* %cap, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !101621
  call void @llvm.sideeffect() #100024 [ "xlx_s_axilite"(i32 %size, [0 x i8] zeroinitializer, i64 -1, i1 false, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer) ], !dbg !101622
  call void @llvm.sideeffect() #100025 [ "xlx_s_axilite"(i32* %flag, [0 x i8] zeroinitializer, i64 -1, i1 false, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer) ], !dbg !101623
  call void @llvm.sideeffect() #100025 [ "xlx_s_axilite"(i8* null, [0 x i8] zeroinitializer, i64 -1, i1 false, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer) ], !dbg !101624
  %0 = bitcast [1000 x i32]* %b to i8*, !dbg !101625
  call void @llvm.lifetime.start.p0i8(i64 4000, i8* %0) #100021, !dbg !101625
  call void @llvm.dbg.declare(metadata [1000 x i32]* %b, metadata !101626, metadata !DIExpression()), !dbg !101630
  %1 = bitcast [1000 x i32]* %b to i8*, !dbg !101630
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %1, i8* align 4 bitcast ([1000 x i32]* @_ZZ7hls_topiPiS_PjS0_E1b to i8*), i64 4000, i1 false), !dbg !101630
  %2 = bitcast i32* %flag_buf to i8*, !dbg !101631
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %2) #100021, !dbg !101631
  call void @llvm.dbg.declare(metadata i32* %flag_buf, metadata !101632, metadata !DIExpression()), !dbg !101633
  store i32 1, i32* %flag_buf, align 4, !dbg !101633
  %3 = bitcast [3 x %struct.Cap]* %caps to i8*, !dbg !101634
  call void @llvm.lifetime.start.p0i8(i64 36, i8* %3) #100021, !dbg !101634
  call void @llvm.dbg.declare(metadata [3 x %struct.Cap]* %caps, metadata !101635, metadata !DIExpression()), !dbg !101639
  %4 = bitcast [12 x i32]* %buffer to i8*, !dbg !101640
  call void @llvm.lifetime.start.p0i8(i64 48, i8* %4) #100021, !dbg !101640
  call void @llvm.dbg.declare(metadata [12 x i32]* %buffer, metadata !101641, metadata !DIExpression()), !dbg !101645
  call void @llvm.sideeffect() #100026 [ "xlx_array_partition"([12 x i32]* %buffer, i32 2, i32 0, i32 1, i1 false) ], !dbg !101646
  call void @llvm.sideeffect() #100027 [ "xlx_array_partition"([3 x %struct.Cap]* %caps, i32 2, i32 0, i32 1, i1 false) ], !dbg !101647
  %arraydecay = getelementptr inbounds [12 x i32], [12 x i32]* %buffer, i32 0, i32 0, !dbg !101648
  %arraydecay1 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i32 0, i32 0, !dbg !101649
  call void @_Z8load_capiPjS_P3Cap(i32 2, i32* %arraydecay, i32* %cap, %struct.Cap* %arraydecay1), !dbg !101650
  %arraydecay2 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i32 0, i32 0, !dbg !101651
  call void @_Z10create_capiP3Caph(i32 1000, %struct.Cap* %arraydecay2, i8 zeroext 2), !dbg !101652
  br label %VITIS_LOOP_188_1, !dbg !101652

VITIS_LOOP_188_1:                                 ; preds = %entry
  call void @llvm.dbg.value(metadata i32 0, metadata !101653, metadata !DIExpression()), !dbg !101655
  br label %for.cond, !dbg !101656

for.cond:                                         ; preds = %for.inc, %VITIS_LOOP_188_1
  %i.0 = phi i32 [ 0, %VITIS_LOOP_188_1 ], [ %inc, %for.inc ]
  call void @llvm.dbg.value(metadata i32 %i.0, metadata !101653, metadata !DIExpression()), !dbg !101655
  %cmp = icmp slt i32 %i.0, %size, !dbg !101657
  br i1 %cmp, label %for.body, label %for.cond.cleanup, !dbg !101659

for.cond.cleanup:                                 ; preds = %for.cond
  br label %for.end

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101660
  %5 = load %struct.Cap, %struct.Cap* %arrayidx, align 4, !dbg !101660
  store %struct.Cap %5, %struct.Cap* %agg.tmp, align 4, !dbg !101660
  %call = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %a, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp), !dbg !101662
  call void @llvm.dbg.value(metadata i32 %call, metadata !101663, metadata !DIExpression()), !dbg !101664
  %arraydecay3 = getelementptr inbounds [1000 x i32], [1000 x i32]* %b, i32 0, i32 0, !dbg !101665
  %arrayidx5 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101666
  %6 = load %struct.Cap, %struct.Cap* %arrayidx5, align 4, !dbg !101666
  store %struct.Cap %6, %struct.Cap* %agg.tmp4, align 4, !dbg !101666
  %call6 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraydecay3, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101667
  call void @llvm.dbg.value(metadata i32 %call6, metadata !101668, metadata !DIExpression()), !dbg !101669
  %mul = mul nsw i32 %call, %call6, !dbg !101670
  call void @llvm.dbg.value(metadata i32 %mul, metadata !101671, metadata !DIExpression()), !dbg !101672
  %arrayidx8 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101673
  %7 = load %struct.Cap, %struct.Cap* %arrayidx8, align 4, !dbg !101673
  store %struct.Cap %7, %struct.Cap* %agg.tmp7, align 4, !dbg !101673
  call void @_Z11cheri_storePiiiPj3Cap(i32* %c, i32 %i.0, i32 %mul, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101674
  br label %for.inc, !dbg !101675

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !dbg !101676
  call void @llvm.dbg.value(metadata i32 %inc, metadata !101653, metadata !DIExpression()), !dbg !101655
  br label %for.cond, !dbg !101677, !llvm.loop !101678

for.end:                                          ; preds = %for.cond.cleanup
  %arraydecay9 = getelementptr inbounds [1000 x i32], [1000 x i32]* %b, i32 0, i32 0, !dbg !101683
  %arrayidx11 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101684
  %8 = load %struct.Cap, %struct.Cap* %arrayidx11, align 4, !dbg !101684
  store %struct.Cap %8, %struct.Cap* %agg.tmp10, align 4, !dbg !101684
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 %size, i32* %a, i32* %arraydecay9, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101685
  %arraydecay12 = getelementptr inbounds [1000 x i32], [1000 x i32]* %b, i32 0, i32 0, !dbg !101686
  %arrayidx14 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101687
  %9 = load %struct.Cap, %struct.Cap* %arrayidx14, align 4, !dbg !101687
  store %struct.Cap %9, %struct.Cap* %agg.tmp13, align 4, !dbg !101687
  %arrayidx16 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101688
  %10 = load %struct.Cap, %struct.Cap* %arrayidx16, align 4, !dbg !101688
  store %struct.Cap %10, %struct.Cap* %agg.tmp15, align 4, !dbg !101688
  call void @_Z18cheri_stream_writejPiS_Pj3CapS1_(i32 %size, i32* %a, i32* %arraydecay12, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp13, %struct.Cap* byval align 4 %agg.tmp15), !dbg !101689
  %11 = load i32, i32* %flag_buf, align 4, !dbg !101690
  store i32 %11, i32* %flag, align 4, !dbg !101691
  %12 = bitcast [12 x i32]* %buffer to i8*, !dbg !101692
  call void @llvm.lifetime.end.p0i8(i64 48, i8* %12) #100021, !dbg !101692
  %13 = bitcast [3 x %struct.Cap]* %caps to i8*, !dbg !101692
  call void @llvm.lifetime.end.p0i8(i64 36, i8* %13) #100021, !dbg !101692
  %14 = bitcast i32* %flag_buf to i8*, !dbg !101692
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %14) #100021, !dbg !101692
  %15 = bitcast [1000 x i32]* %b to i8*, !dbg !101692
  call void @llvm.lifetime.end.p0i8(i64 4000, i8* %15) #100021, !dbg !101692
  ret void, !dbg !101692
}
