...
define void @merge(i32* "fpga.decayed.dim.hint"="2048" %a, i32 %start, i32 %m, i32 %stop, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="4" %caps) #0 !dbg !101493 {
entry:
...
for.body:                                         ; preds = %for.cond
  %arrayidx0 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 2, !dbg !101550
  ...
  %arrayidx1 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 3, !dbg !101550
...
for.body5:                                        ; preds = %for.cond3
  %arrayidx2 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 2, !dbg !101550
  ...
  %2 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %a, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101552
  ...
  %arrayidx3 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 3, !dbg !101550
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer3, i32 %i.0, i32 %2, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101564
...
for.body17:                                       ; preds = %for.cond15
  ...
  %arrayidx4 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 3, !dbg !101550
  ...
  %3 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer4, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101552
  ...
  %arrayidx5 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 3, !dbg !101550
  %load.5 = load %struct.Cap, %struct.Cap* %arrayidx5, align 4, !dbg !101550
  store %struct.Cap %load.5, %struct.Cap* %agg.tmp3, align 4, !dbg !101550
  %4 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer5, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101552
...
if.then:                                          ; preds = %for.body17
  %arraypointer6 = getelementptr inbounds [2048 x i32], [2048 x i32]* %a, i32 0, i32 0, !dbg !101555
  %arrayidx6 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 2, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %3, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.6 = load %struct.Cap, %struct.Cap* %arrayidx6, align 4, !dbg !101563
  store %struct.Cap %store.6, %struct.Cap* %agg.tmp2, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer6, i32 %i.0, i32 %3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101564
...
if.else:                                          ; preds = %for.body17
  %arraypointer7 = getelementptr inbounds [2048 x i32], [2048 x i32]* %a, i32 0, i32 0, !dbg !101555
  %arrayidx7 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 2, !dbg !101550
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer7, i32 %i.0, i32 %4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101564
...
; Function Attrs: nounwind
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="2048" %xa, i32* "fpga.decayed.dim.hint"="2048" %xb, i32* %flag, i32* "fpga.decayed.dim.hint"="16" %cap) #3 !dbg !101493 !fpga.function.pragma !101496 {
entry:
...
for.body:                                         ; preds = %for.cond
  %arrayidx8 = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101550
  ...
  %arrayidx9 = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %1, metadata !101528, metadata !DIExpression()), !dbg !101562
...
for.body24:                                       ; preds = %for.cond22
  ...
  %arrayidx10 = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101550
  ...
  %2 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer10, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %2, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arrayidx11 = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %2, metadata !101528, metadata !DIExpression()), !dbg !101562
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xb, i32 %i.0, i32 %2, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101564
