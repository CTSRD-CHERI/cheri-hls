...
; Function Attrs: nounwind
define void @merge(i32* "fpga.decayed.dim.hint"="2048" %a, i32 %start, i32 %m, i32 %stop, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="2" %caps) #0 !dbg !101522 {
entry:
...
; Function Attrs: nounwind
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="2048" %xa, i32* "fpga.decayed.dim.hint"="2048" %xb, i32* %flag, i32* "fpga.decayed.dim.hint"="8" %cap) #3 !dbg !101522 !fpga.function.pragma !101525 {
entry:
...
for.end21:                                        ; preds = %for.cond3
  ...
  %decay.1 = getelementptr inbounds [2048 x i32], [2048 x i32]* %a, i32 0, i32 0, !dbg !101539
  %cap.arrayidx1 = getelementptr inbounds [2 x %struct.Cap], [2 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101539
  ...
  call void @_Z18cheri_stream_writejPiS_Pj3Cap(i32 %size, i32* %xb, i32* %decay.1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101539
