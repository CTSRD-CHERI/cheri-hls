...
define void @merge(i32* "fpga.decayed.dim.hint"="2048" %a, i32 %start, i32 %m, i32 %stop, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="4" %caps) #0 !dbg !101468 {
entry:
...
; Function Attrs: nounwind
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="2048" %xa, i32* "fpga.decayed.dim.hint"="2048" %xb, i32* %flag, i32* "fpga.decayed.dim.hint"="8" %cap) #3 !dbg !101468 !fpga.function.pragma !101471 {
entry:
...
if.then:                                          ; preds = %for.body8
  ...
  call void @merge(i32* %arraydecay, i32 %i.1, i32 %sub9, i32 %sub12, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !170
  br label %if.end, !dbg !171

if.else:                                          ; preds = %for.body8
  %arraydecay14 = getelementptr inbounds [2048 x i32], [2048 x i32]* %a, i32 0, i32 0, !dbg !172
  call void @merge(i32* %arraydecay14, i32 %i.1, i32 %sub9, i32 %size, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !174
  br label %if.end
...
for.body24:                                       ; preds = %for.cond22
  %arraypointer10 = getelementptr inbounds [2048 x i32], [2048 x i32]* %a, i32 0, i32 0, !dbg !101530
  %cap.arrayidx10 = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101550
  %load.10 = load %struct.Cap, %struct.Cap* %cap.arrayidx10, align 4, !dbg !101550
  store %struct.Cap %load.10, %struct.Cap* %agg.tmp3, align 4, !dbg !101550
  %2 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer10, i32 %i.2, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %2, metadata !101521, metadata !DIExpression()), !dbg !101529
  ...
  store %struct.Cap %store.11, %struct.Cap* %agg.tmp1, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xb, i32 %i.2, i32 %2, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101539
