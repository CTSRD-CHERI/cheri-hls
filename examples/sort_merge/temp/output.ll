...
; Function Attrs: nounwind
define void @merge(i32* "fpga.decayed.dim.hint"="2048" %a, i32 %start, i32 %m, i32 %stop, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="4" %caps) #0 !dbg !101603 {
entry:
...
for.body:                                         ; preds = %for.cond
  %cap.arrayidx0 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 3, !dbg !101550
  ...
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %a, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %1, metadata !101521, metadata !DIExpression()), !dbg !101529
  %arraypointer1 = getelementptr inbounds [2048 x i32], [2048 x i32]* %temp, i32 0, i32 0, !dbg !101530
  ...
  store %struct.Cap %store.1, %struct.Cap* %agg.tmp2, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer1, i32 %i.0, i32 %1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101539
...
for.body5:                                        ; preds = %for.cond3
  %cap.arrayidx2 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 3, !dbg !101550
  ...
  %2 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %a, i32 %j.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101527
  ...
  %arraypointer3 = getelementptr inbounds [2048 x i32], [2048 x i32]* %temp, i32 0, i32 0, !dbg !101530
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer3, i32 %sub, i32 %2, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101539
...
for.body17:                                       ; preds = %for.cond15
  %arraypointer4 = getelementptr inbounds [2048 x i32], [2048 x i32]* %temp, i32 0, i32 0, !dbg !101530
  %cap.arrayidx4 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 2, !dbg !101550
  ...
  %3 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer4, i32 %j.1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101527
  ...
  %arraypointer5 = getelementptr inbounds [2048 x i32], [2048 x i32]* %temp, i32 0, i32 0, !dbg !101530
  %cap.arrayidx5 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 2, !dbg !101550
  %load.5 = load %struct.Cap, %struct.Cap* %cap.arrayidx5, align 4, !dbg !101550
  store %struct.Cap %load.5, %struct.Cap* %agg.tmp2, align 4, !dbg !101550
  %4 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer5, i32 %i.1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101527
...
if.then:                                          ; preds = %for.body17
  %cap.arrayidx6 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 3, !dbg !101550
  ...
  store %struct.Cap %store.6, %struct.Cap* %agg.tmp3, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %a, i32 %k.0, i32 %3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539
...
if.else:                                          ; preds = %for.body17
  %cap.arrayidx7 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 3, !dbg !101550
  ...
  store %struct.Cap %store.7, %struct.Cap* %agg.tmp3, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %a, i32 %k.0, i32 %4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539
...
; Function Attrs: nounwind
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="2048" %xa, i32* "fpga.decayed.dim.hint"="2048" %xb, i32* %flag, i32* "fpga.decayed.dim.hint"="8" %cap) #3 !dbg !101603 !fpga.function.pragma !101606 {
entry:
  ...
  call void @_Z10create_capiP3Caph(i32 2048, %struct.Cap* %cap.arraydecay1, i8 2), !dbg !101542
  call void @_Z10create_capiP3Caph(i32 2048, %struct.Cap* %cap.arraydecay1, i8 3), !dbg !101542
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xa, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %1, metadata !101521, metadata !DIExpression()), !dbg !101529
  %arraypointer9 = getelementptr inbounds [2048 x i32], [2048 x i32]* %a, i32 0, i32 0, !dbg !101530
  %cap.arrayidx9 = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %1, metadata !101528, metadata !DIExpression()), !dbg !101539
  %store.9 = load %struct.Cap, %struct.Cap* %cap.arrayidx9, align 4, !dbg !101539
  store %struct.Cap %store.9, %struct.Cap* %agg.tmp3, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer9, i32 %i.0, i32 %1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539
...
if.then:                                          ; preds = %for.body8
  ...
  call void @merge(i32* %arraydecay, i32 %i.1, i32 %sub9, i32 %sub12, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !204
  br label %if.end, !dbg !205

if.else:                                          ; preds = %for.body8
  %arraydecay14 = getelementptr inbounds [2048 x i32], [2048 x i32]* %a, i32 0, i32 0, !dbg !206
  call void @merge(i32* %arraydecay14, i32 %i.1, i32 %sub9, i32 %size, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !208
  br label %if.end
...
for.end21:                                        ; preds = %for.cond3
  ...
  %decay.10 = getelementptr inbounds [2048 x i32], [2048 x i32]* %a, i32 0, i32 0, !dbg !101539

  %cap.arrayidx10 = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101539
  %store.10 = load %struct.Cap, %struct.Cap* %cap.arrayidx10, align 4, !dbg !101539
  store %struct.Cap %store.10, %struct.Cap* %agg.tmp1, align 4, !dbg !101539

  %cap.arrayidx10b = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101539
  %store.10b = load %struct.Cap, %struct.Cap* %cap.arrayidx10b, align 4, !dbg !101539
  store %struct.Cap %store.10b, %struct.Cap* %agg.tmp3, align 4, !dbg !101539

  call void @_Z18cheri_stream_writejPiS_Pj3CapS1_(i32 %size, i32* %xb, i32* %decay.10, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539
...
attributes #9000 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="512" "xlx.source"="user" }
attributes #9001 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="0" "xlx.source"="user" }
attributes #9002 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="384" "xlx.source"="user" }
