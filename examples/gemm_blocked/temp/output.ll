...
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="4096" %xm1, i32* "fpga.decayed.dim.hint"="4096" %xm2, i32* "fpga.decayed.dim.hint"="4096" %xprod, i32* %flag, i32* "fpga.decayed.dim.hint"="24" %cap) #0 !dbg !101665 !fpga.function.pragma !101668 {
entry:
  ...
  call void @_Z10create_capiP3Capi(i32 4096, %struct.Cap* %cap.arraydecay1, i32 4), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 4096, %struct.Cap* %cap.arraydecay1, i32 5), !dbg !101542
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xm1, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %3, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer1 = getelementptr inbounds [4096 x i32], [4096 x i32]* %m1, i32 0, i32 0, !dbg !101555
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer1, i32 %i.0, i32 %3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101564
...
for.body7:                                        ; preds = %for.cond4
  ...
  %4 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xm2, i32 %i.1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %4, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer3 = getelementptr inbounds [4096 x i32], [4096 x i32]* %m2, i32 0, i32 0, !dbg !101555
  ...
  store %struct.Cap %store.3, %struct.Cap* %agg.tmp4, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer3, i32 %i.1, i32 %4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101564
...
for.body26:                                       ; preds = %for.cond24
  ...
  %arraypointer4 = getelementptr inbounds [4096 x i32], [4096 x i32]* %m1, i32 0, i32 0, !dbg !101555
  ...
  %5 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer4, i32 %add30, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101552
...
for.body35:                                       ; preds = %for.cond33
  ...
  %arraypointer5 = getelementptr inbounds [4096 x i32], [4096 x i32]* %m2, i32 0, i32 0, !dbg !101555
  ...
  %6 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer5, i32 %add37, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101552
  ...
  %arraypointer6 = getelementptr inbounds [4096 x i32], [4096 x i32]* %prod, i32 0, i32 0, !dbg !101555
  ...
  %7 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer6, i32 %add42, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101552
  ...
  %arraypointer7 = getelementptr inbounds [4096 x i32], [4096 x i32]* %prod, i32 0, i32 0, !dbg !101555
  %cap.arrayidx7 = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i64 0, i64 5, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %add45, metadata !101528, metadata !DIExpression()), !dbg !101562
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer7, i32 %add47, i32 %add45, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101564
...
for.body68:                                       ; preds = %for.cond65
  %arraypointer8 = getelementptr inbounds [4096 x i32], [4096 x i32]* %prod, i32 0, i32 0, !dbg !101555
  ...
  %8 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer8, i32 %i.3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101552
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xprod, i32 %i.3, i32 %8, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101564
