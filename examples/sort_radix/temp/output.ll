...
; Function Attrs: nounwind
define void @local_scan(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="4" %caps) #0 !dbg !101603 {
entry:
...
; Function Attrs: nounwind
define void @sum_scan(i32* "fpga.decayed.dim.hint"="128" %sum, i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="4" %caps) #0 !dbg !101603 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
; Function Attrs: nounwind
define void @last_step_scan(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* "fpga.decayed.dim.hint"="128" %sum, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="4" %caps) #0 !dbg !101603 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
; Function Attrs: nounwind
define void @init(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="4" %caps) #0 !dbg !101603 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
; Function Attrs: nounwind
define void @hist(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* "fpga.decayed.dim.hint"="2048" %a, i32 %exp, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="4" %caps) #0 !dbg !101603 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
; Function Attrs: nounwind
define void @update(i32* "fpga.decayed.dim.hint"="2048" %b, i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* "fpga.decayed.dim.hint"="2048" %a, i32 %exp, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="4" %caps) #0 !dbg !101603 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
; Function Attrs: nounwind
define void @hls_top(i32* "fpga.decayed.dim.hint"="2048" %xa, i32* "fpga.decayed.dim.hint"="2048" %xb, i32* "fpga.decayed.dim.hint"="2048" %xbucket, i32* "fpga.decayed.dim.hint"="128" %xsum, i32* %flag, i32* "fpga.decayed.dim.hint"="16" %cap) #3 !dbg !101603 !fpga.function.pragma !101606 {
entry:
...
for.body:                                         ; preds = %for.cond
  %cap.arrayidx0 = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101550
...
for.end27:                                        ; preds = %for.cond3
  ...
  %decay.1 = getelementptr inbounds [2048 x i32], [2048 x i32]* %b, i32 0, i32 0, !dbg !101539
  %cap.arrayidx1 = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101539
  ...
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 2048, i32* %xb, i32* %decay.1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101539
