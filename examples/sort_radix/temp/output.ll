...
define void @local_scan(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101665 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  ...
  %cap.arrayidx0 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  ...
  %0 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %0, metadata !101521, metadata !DIExpression()), !dbg !101554
  %sub = sub nsw i32 %add, 1, !dbg !38
  %cap.arrayidx1 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  %load.1 = load %struct.Cap, %struct.Cap* %cap.arrayidx1, align 4, !dbg !101550
  store %struct.Cap %load.1, %struct.Cap* %agg.tmp6, align 4, !dbg !101550
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %sub, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %1, metadata !101521, metadata !DIExpression()), !dbg !101554
  %add6 = add nsw i32 %0, %1, !dbg !40
  %cap.arrayidx2 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %add6, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.2 = load %struct.Cap, %struct.Cap* %cap.arrayidx2, align 4, !dbg !101563
  store %struct.Cap %store.2, %struct.Cap* %agg.tmp6, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %bucket, i32 %add, i32 %add6, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101564
...
; Function Attrs: nounwind
define void @sum_scan(i32* "fpga.decayed.dim.hint"="128" %sum, i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101665 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
  ...
  %cap.arrayidx3 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 7, !dbg !101550
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %sum, i32 0, i32 0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101564
...
for.body:                                         ; preds = %for.cond
  ...
  %cap.arrayidx4 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  %load.4 = load %struct.Cap, %struct.Cap* %cap.arrayidx4, align 4, !dbg !101550
  store %struct.Cap %load.4, %struct.Cap* %agg.tmp6, align 4, !dbg !101550
  %0 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %shl, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %0, metadata !101521, metadata !DIExpression()), !dbg !101554
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %sum, i32 %radixID.0, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101564
...
; Function Attrs: nounwind
define void @last_step_scan(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* "fpga.decayed.dim.hint"="128" %sum, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101665 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %cap.arrayidx6 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  ...
  %0 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %0, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx7 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 7, !dbg !101550
  ...
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %sum, i32 %radixID.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %1, metadata !101521, metadata !DIExpression()), !dbg !101554
  %add6 = add nsw i32 %0, %1, !dbg !119
  %cap.arrayidx8 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %add6, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.8 = load %struct.Cap, %struct.Cap* %cap.arrayidx8, align 4, !dbg !101563
  store %struct.Cap %store.8, %struct.Cap* %agg.tmp6, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %bucket, i32 %add, i32 %add6, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101564
...
; Function Attrs: nounwind
define void @init(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101665 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
for.body:                                         ; preds = %for.cond
  %cap.arrayidx9 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  call void @llvm.dbg.value(metadata i32 0, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.9 = load %struct.Cap, %struct.Cap* %cap.arrayidx9, align 4, !dbg !101563
  store %struct.Cap %store.9, %struct.Cap* %agg.tmp6, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %bucket, i32 %i.0, i32 0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101564
...
; Function Attrs: nounwind
define void @hist(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* "fpga.decayed.dim.hint"="2048" %a, i32 %exp, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101665 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %cap.arrayidx10 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 4, !dbg !101550
  ...
  %0 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %a, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %0, metadata !101521, metadata !DIExpression()), !dbg !101554
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %cap.arrayidx11 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  %load.11 = load %struct.Cap, %struct.Cap* %cap.arrayidx11, align 4, !dbg !101550
  store %struct.Cap %load.11, %struct.Cap* %agg.tmp6, align 4, !dbg !101550
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %bucket_indx.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %1, metadata !101521, metadata !DIExpression()), !dbg !101554
  %add10 = add nsw i32 %1, 1, !dbg !200
  %cap.arrayidx12 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %add10, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.12 = load %struct.Cap, %struct.Cap* %cap.arrayidx12, align 4, !dbg !101563
  store %struct.Cap %store.12, %struct.Cap* %agg.tmp6, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %bucket, i32 %bucket_indx.0, i32 %add10, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101564
...
; Function Attrs: nounwind
define void @update(i32* "fpga.decayed.dim.hint"="2048" %b, i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* "fpga.decayed.dim.hint"="2048" %a, i32 %exp, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101665 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %a, i32 %add7, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %1, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx15 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  %load.15 = load %struct.Cap, %struct.Cap* %cap.arrayidx15, align 4, !dbg !101550
  store %struct.Cap %load.15, %struct.Cap* %agg.tmp6, align 4, !dbg !101550
  %2 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %add5, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %2, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx16 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 5, !dbg !101550
  ...
  store %struct.Cap %store.16, %struct.Cap* %agg.tmp5, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %b, i32 %2, i32 %1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101564
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %cap.arrayidx17 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  %load.17 = load %struct.Cap, %struct.Cap* %cap.arrayidx17, align 4, !dbg !101550
  store %struct.Cap %load.17, %struct.Cap* %agg.tmp6, align 4, !dbg !101550
  %3 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %bucket_indx.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %3, metadata !101521, metadata !DIExpression()), !dbg !101554
  %add17 = add nsw i32 %3, 1, !dbg !267
  %cap.arrayidx18 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %add17, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.18 = load %struct.Cap, %struct.Cap* %cap.arrayidx18, align 4, !dbg !101563
  store %struct.Cap %store.18, %struct.Cap* %agg.tmp6, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %bucket, i32 %bucket_indx.0, i32 %add17, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101564
...
; Function Attrs: nounwind
define void @hls_top(i32* "fpga.decayed.dim.hint"="2048" %xa, i32* "fpga.decayed.dim.hint"="2048" %xb, i32* "fpga.decayed.dim.hint"="2048" %xbucket, i32* "fpga.decayed.dim.hint"="128" %xsum, i32* %flag, i32* "fpga.decayed.dim.hint"="32" %cap) #3 !dbg !101665 !fpga.function.pragma !101668 {
entry:
  ...
  call void @_Z10create_capiP3Capi(i32 2048, %struct.Cap* %cap.arraydecay1, i32 4), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 2048, %struct.Cap* %cap.arraydecay1, i32 5), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 2048, %struct.Cap* %cap.arraydecay1, i32 6), !dbg !101542
...
for.body:                                         ; preds = %for.cond
  %cap.arrayidx19 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101550
  ...
  %4 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xa, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %4, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer20 = getelementptr inbounds [2048 x i32], [2048 x i32]* %a, i32 0, i32 0, !dbg !101555
  %cap.arrayidx20 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 4, !dbg !101550
  ...
  store %struct.Cap %store.20, %struct.Cap* %agg.tmp4, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer20, i32 %i.0, i32 %4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101564
...
for.body5:                                        ; preds = %for.cond3
  ...
  call void @init(i32* %arraydecay, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !346
...
if.then:                                          ; preds = %for.body5
  ...
  call void @hist(i32* %arraydecay7, i32* %arraydecay8, i32 %exp.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !353
...
if.else:                                          ; preds = %for.body5
  ...
  call void @hist(i32* %arraydecay9, i32* %arraydecay10, i32 %exp.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !358
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %arraydecay11 = getelementptr inbounds [2048 x i32], [2048 x i32]* %bucket, i32 0, i32 0, !dbg !359
  call void @local_scan(i32* %arraydecay11, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !360
  ...
  call void @sum_scan(i32* %arraydecay12, i32* %arraydecay13, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !363
  ...
  call void @last_step_scan(i32* %arraydecay14, i32* %arraydecay15, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !366
...
if.then17:                                        ; preds = %if.end
  ...
  call void @update(i32* %arraydecay18, i32* %arraydecay19, i32* %arraydecay20, i32 %exp.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !374
...
if.else21:                                        ; preds = %if.end
  ...
  call void @update(i32* %arraydecay22, i32* %arraydecay23, i32* %arraydecay24, i32 %exp.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !380
  call void @llvm.dbg.value(metadata i32 0, metadata !304, metadata !DIExpression()), !dbg !305
  br label %if.end25
...
for.body32:                                       ; preds = %for.cond29
  %arraypointer21 = getelementptr inbounds [2048 x i32], [2048 x i32]* %b, i32 0, i32 0, !dbg !101555
  ...
  %5 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer21, i32 %i28.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %5, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx22 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101550
  ...
  store %struct.Cap %store.22, %struct.Cap* %agg.tmp1, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xb, i32 %i28.0, i32 %5, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101564
