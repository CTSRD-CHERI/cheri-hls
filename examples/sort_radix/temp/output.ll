...
; Function Attrs: nounwind
define void @local_scan(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101522 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  ...
  %0 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101527
  ...
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %sub, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101527
  ...
  call void @llvm.dbg.value(metadata i32 %add6, metadata !101528, metadata !DIExpression()), !dbg !101539
  %store.2 = load %struct.Cap, %struct.Cap* %cap.arrayidx2, align 4, !dbg !101539
  store %struct.Cap %store.2, %struct.Cap* %agg.tmp6, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %bucket, i32 %add, i32 %add6, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101539
...
; Function Attrs: nounwind
define void @sum_scan(i32* "fpga.decayed.dim.hint"="128" %sum, i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101522 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %sum, i32 0, i32 0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101539
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %shl, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %0, metadata !101521, metadata !DIExpression()), !dbg !101529
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %sum, i32 %radixID.0, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101539
...
; Function Attrs: nounwind
define void @last_step_scan(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* "fpga.decayed.dim.hint"="128" %sum, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101522 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %sum, i32 %radixID.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %1, metadata !101521, metadata !DIExpression()), !dbg !101529
  ...
  store %struct.Cap %store.8, %struct.Cap* %agg.tmp6, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %bucket, i32 %add, i32 %add6, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101539
...
; Function Attrs: nounwind
define void @init(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101522 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  store %struct.Cap %store.9, %struct.Cap* %agg.tmp6, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %bucket, i32 %i.0, i32 0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101539
...
; Function Attrs: nounwind
define void @hist(i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* "fpga.decayed.dim.hint"="2048" %a, i32 %exp, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101522 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %0 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %a, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %0, metadata !101521, metadata !DIExpression()), !dbg !101529
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %bucket_indx.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %1, metadata !101521, metadata !DIExpression()), !dbg !101529
  %add10 = add nsw i32 %1, 1, !dbg !200
  %cap.arrayidx12 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 6, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %add10, metadata !101528, metadata !DIExpression()), !dbg !101539
  %store.12 = load %struct.Cap, %struct.Cap* %cap.arrayidx12, align 4, !dbg !101539
  store %struct.Cap %store.12, %struct.Cap* %agg.tmp6, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %bucket, i32 %bucket_indx.0, i32 %add10, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101539
...
; Function Attrs: nounwind
define void @update(i32* "fpga.decayed.dim.hint"="2048" %b, i32* "fpga.decayed.dim.hint"="2048" %bucket, i32* "fpga.decayed.dim.hint"="2048" %a, i32 %exp, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101522 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %a, i32 %add7, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %1, metadata !101521, metadata !DIExpression()), !dbg !101529
  ...
  %2 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %add5, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101527
  ...
  store %struct.Cap %store.16, %struct.Cap* %agg.tmp5, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %b, i32 %2, i32 %1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101539
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %3 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %bucket, i32 %bucket_indx.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101527
  ...
  call void @llvm.dbg.value(metadata i32 %add17, metadata !101528, metadata !DIExpression()), !dbg !101539
  %store.18 = load %struct.Cap, %struct.Cap* %cap.arrayidx18, align 4, !dbg !101539
  store %struct.Cap %store.18, %struct.Cap* %agg.tmp6, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %bucket, i32 %bucket_indx.0, i32 %add17, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101539
...
; Function Attrs: nounwind
define void @hls_top(i32* "fpga.decayed.dim.hint"="2048" %xa, i32* "fpga.decayed.dim.hint"="2048" %xb, i32* "fpga.decayed.dim.hint"="2048" %xbucket, i32* "fpga.decayed.dim.hint"="128" %xsum, i32* %flag, i32* "fpga.decayed.dim.hint"="16" %cap) #3 !dbg !101522 !fpga.function.pragma !101525 {
entry:
  ...
  call void @_Z10create_capiP3Caph(i32 2048, %struct.Cap* %cap.arraydecay1, i8 4), !dbg !101542
  call void @_Z10create_capiP3Caph(i32 2048, %struct.Cap* %cap.arraydecay1, i8 5), !dbg !101542
  call void @_Z10create_capiP3Caph(i32 2048, %struct.Cap* %cap.arraydecay1, i8 6), !dbg !101542
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xa, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %4, metadata !101521, metadata !DIExpression()), !dbg !101529
  %arraypointer20 = getelementptr inbounds [2048 x i32], [2048 x i32]* %a, i32 0, i32 0, !dbg !101530
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer20, i32 %i.0, i32 %4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101539
...
for.body5:                                        ; preds = %for.cond3
  ...
  call void @init(i32* %arraydecay, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !380
...
if.then:                                          ; preds = %for.body5
  ...
  call void @hist(i32* %arraydecay7, i32* %arraydecay8, i32 %exp.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !387
...
if.else:                                          ; preds = %for.body5
  ...
  call void @hist(i32* %arraydecay9, i32* %arraydecay10, i32 %exp.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !392
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %arraydecay11 = getelementptr inbounds [2048 x i32], [2048 x i32]* %bucket, i32 0, i32 0, !dbg !393
  call void @local_scan(i32* %arraydecay11, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !394
  ...
  call void @sum_scan(i32* %arraydecay12, i32* %arraydecay13, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !397
  ...
  call void @last_step_scan(i32* %arraydecay14, i32* %arraydecay15, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !400
...
if.then17:                                        ; preds = %if.end
  ...
  call void @update(i32* %arraydecay18, i32* %arraydecay19, i32* %arraydecay20, i32 %exp.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !408
...
if.else21:                                        ; preds = %if.end
  ...
  call void @update(i32* %arraydecay22, i32* %arraydecay23, i32* %arraydecay24, i32 %exp.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !414
  call void @llvm.dbg.value(metadata i32 0, metadata !338, metadata !DIExpression()), !dbg !339
  br label %if.end25
...
for.end27:                                        ; preds = %for.cond3
  ...
  %decay.21 = getelementptr inbounds [2048 x i32], [2048 x i32]* %b, i32 0, i32 0, !dbg !101539
  %cap.arrayidx21 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101539
  %store.21 = load %struct.Cap, %struct.Cap* %cap.arrayidx21, align 4, !dbg !101539
  store %struct.Cap %store.21, %struct.Cap* %agg.tmp1, align 4, !dbg !101539
  call void @_Z18cheri_stream_writejPiS_Pj3Cap(i32 2048, i32* %xb, i32* %decay.21, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101539
