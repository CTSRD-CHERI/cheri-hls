...
void XHls_top_Set_xpattern(XHls_top *InstancePtr, u64 Data) {
  Xil_AssertVoid(InstancePtr != 0);
  Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XPATTERN_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XPATTERN_DATA + 4, (u32)(Data >> 32));
}

u64 XHls_top_Get_xpattern(XHls_top *InstancePtr) {
  u64 Data;
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XPATTERN_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XPATTERN_DATA + 4)
          << 32;
  return Data;
}

void XHls_top_Set_xinput(XHls_top *InstancePtr, u64 Data) {
  Xil_AssertVoid(InstancePtr != 0);
  Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XINPUT_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XINPUT_DATA + 4, (u32)(Data >> 32));
}

u64 XHls_top_Get_xinput(XHls_top *InstancePtr) {
  u64 Data;
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XINPUT_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XINPUT_DATA + 4)
          << 32;
  return Data;
}

void XHls_top_Set_xkmpNext(XHls_top *InstancePtr, u64 Data) {
  Xil_AssertVoid(InstancePtr != 0);
  Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XKMPNEXT_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XKMPNEXT_DATA + 4, (u32)(Data >> 32));
}

u64 XHls_top_Get_xkmpNext(XHls_top *InstancePtr) {
  u64 Data;
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XKMPNEXT_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XKMPNEXT_DATA + 4)
          << 32;
  return Data;
}

void XHls_top_Set_xn_matches(XHls_top *InstancePtr, u64 Data) {
  Xil_AssertVoid(InstancePtr != 0);
  Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XN_MATCHES_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XN_MATCHES_DATA + 4,
                    (u32)(Data >> 32));
}

u64 XHls_top_Get_xn_matches(XHls_top *InstancePtr) {
  u64 Data;
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XN_MATCHES_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XN_MATCHES_DATA + 4)
          << 32;
  return Data;
