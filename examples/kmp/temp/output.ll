...
define void @CPF(i32* "fpga.decayed.dim.hint"="4" %pattern, i32* "fpga.decayed.dim.hint"="4" %kmpNext, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="8" %caps) #0 !dbg !101493 {
entry:
...
; Function Attrs: nounwind
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="4" %xpattern, i32* "fpga.decayed.dim.hint"="16206" %xinput, i32* "fpga.decayed.dim.hint"="4" %xkmpNext, i32* "fpga.decayed.dim.hint"="1" %xn_matches, i32* %flag, i32* "fpga.decayed.dim.hint"="16" %cap) #3 !dbg !101493 !fpga.function.pragma !101496 {
entry:
