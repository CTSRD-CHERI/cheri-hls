...
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="2" %xC, i32* "fpga.decayed.dim.hint"="16384" %xorig, i32* "fpga.decayed.dim.hint"="16384" %xsol, i32* %flag, i32* "fpga.decayed.dim.hint"="12" %cap) #0 !dbg !101467 !fpga.function.pragma !101470 {
entry:
  ...
  %3 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xC, i32 0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101527
  ...
  %4 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xC, i32 1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101527
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xorig, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101527
...
for.body204:                                      ; preds = %for.cond200
  ...
  %cap.arrayidx3 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101550
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xsol, i32 %i.4, i32 %21, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101539
