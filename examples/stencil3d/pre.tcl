open_project -reset stencil3d_prj
set_top hls_top 
...
set ::LLVM_CUSTOM_CMD {/local/ecad/xilinx/new/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/bin/llvm-dis /workspace/examples/stencil3d/temp/test.bc}
#a.g.ld.6.user.ll
