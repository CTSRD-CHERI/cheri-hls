...
for.end87:                                        ; preds = %if.then, %for.cond33
  ...
  %decay.3 = getelementptr inbounds [256 x i32], [256 x i32]* %level, i32 0, i32 0, !dbg !101539
  %cap.arrayidx3 = getelementptr inbounds [5 x %struct.Cap], [5 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101539
  ...
  call void @_Z18cheri_stream_writejPiS_Pj3Cap(i32 %node, i32* %xlevel, i32* %decay.3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539

  %decay.4 = getelementptr inbounds [10 x i32], [10 x i32]* %level_counts, i32 0, i32 0, !dbg !101539
  %cap.arrayidx4 = getelementptr inbounds [5 x %struct.Cap], [5 x %struct.Cap]* %caps, i64 0, i64 4, !dbg !101539
  ...
  call void @_Z18cheri_stream_writejPiS_Pj3Cap(i32 %levels, i32* %xlevel_counts, i32* %decay.4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101539
