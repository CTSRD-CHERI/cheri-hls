...
define void @hls_top(i32 %starting_node, i32 %levels, i32 %node, i32* "fpga.decayed.dim.hint"="256" %xnodes_b, i32* "fpga.decayed.dim.hint"="256" %xnodes_e, i32* "fpga.decayed.dim.hint"="4096" %xedges, i32* "fpga.decayed.dim.hint"="256" %xlevel, i32* "fpga.decayed.dim.hint"="10" %xlevel_counts, i32* %flag, i32* "fpga.decayed.dim.hint"="44" %cap) #0 !dbg !101665 !fpga.function.pragma !101668 {
entry:
  ...
  call void @_Z10create_capiP3Capi(i32 4096, %struct.Cap* %cap.arraydecay1, i32 8), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 256, %struct.Cap* %cap.arraydecay1, i32 9), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 10, %struct.Cap* %cap.arraydecay1, i32 10), !dbg !101542
...
for.body:                                         ; preds = %for.cond
  ...
  %8 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xnodes_b, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %8, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer1 = getelementptr inbounds [256 x i32], [256 x i32]* %nodes_edge_begin, i32 0, i32 0, !dbg !101555
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer1, i32 %i.0, i32 %8, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101564
...
for.body7:                                        ; preds = %for.cond4
  ...
  %9 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xnodes_e, i32 %i3.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %9, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer3 = getelementptr inbounds [256 x i32], [256 x i32]* %nodes_edge_end, i32 0, i32 0, !dbg !101555
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer3, i32 %i3.0, i32 %9, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101564
...
for.body19:                                       ; preds = %for.cond16
  ...
  %10 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xedges, i32 %i15.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101552
  ...
  store %struct.Cap %store.5, %struct.Cap* %agg.tmp8, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer5, i32 %i15.0, i32 %10, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101564
...
for.end26:                                        ; preds = %for.cond.cleanup18
  ...
  store %struct.Cap %store.6, %struct.Cap* %agg.tmp9, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer6, i32 %starting_node, i32 0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101564
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer7, i32 0, i32 1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101564
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %arraypointer8 = getelementptr inbounds [256 x i32], [256 x i32]* %queue, i32 0, i32 0, !dbg !101555
  %cap.arrayidx8 = getelementptr inbounds [11 x %struct.Cap], [11 x %struct.Cap]* %caps, i64 0, i64 5, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %starting_node, metadata !101528, metadata !DIExpression()), !dbg !101562
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer8, i32 %cond, i32 %starting_node, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101564
...
if.end:                                           ; preds = %land.lhs.true, %cond.false40, %cond.true37
  %arraypointer9 = getelementptr inbounds [256 x i32], [256 x i32]* %queue, i32 0, i32 0, !dbg !101555
  ...
  %11 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer9, i32 %q_out.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101552
  ...
  %arraypointer10 = getelementptr inbounds [256 x i32], [256 x i32]* %nodes_edge_begin, i32 0, i32 0, !dbg !101555
  ...
  %12 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer10, i32 %11, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
  ...
  %arraypointer11 = getelementptr inbounds [256 x i32], [256 x i32]* %nodes_edge_end, i32 0, i32 0, !dbg !101555
  ...
  %13 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer11, i32 %11, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101552
...
for.body53:                                       ; preds = %for.cond51
  %arraypointer12 = getelementptr inbounds [4096 x i32], [4096 x i32]* %edges_dst, i32 0, i32 0, !dbg !101555
  ...
  %14 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer12, i32 %e.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101552
  ...
  %15 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer13, i32 %14, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101552
...
if.then59:                                        ; preds = %for.body53
  %arraypointer14 = getelementptr inbounds [256 x i32], [256 x i32]* %level, i32 0, i32 0, !dbg !101555
  ...
  %16 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer14, i32 %11, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101552
  ...
  call void @llvm.dbg.value(metadata i32 %add63, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.15 = load %struct.Cap, %struct.Cap* %cap.arrayidx15, align 4, !dbg !101563
  store %struct.Cap %store.15, %struct.Cap* %agg.tmp9, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer15, i32 %14, i32 %add63, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101564
  %arraypointer16 = getelementptr inbounds [10 x i32], [10 x i32]* %level_counts, i32 0, i32 0, !dbg !101555
  ...
  %17 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer16, i32 %add63, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101552
  ...
  call void @llvm.dbg.value(metadata i32 %add68, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.17 = load %struct.Cap, %struct.Cap* %cap.arrayidx17, align 4, !dbg !101563
  store %struct.Cap %store.17, %struct.Cap* %agg.tmp10, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer17, i32 %add63, i32 %add68, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101564
...
cond.end75:                                       ; preds = %cond.false73, %cond.true72
  ...
  %arraypointer18 = getelementptr inbounds [256 x i32], [256 x i32]* %queue, i32 0, i32 0, !dbg !101555
  ...
  store %struct.Cap %store.18, %struct.Cap* %agg.tmp5, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer18, i32 %cond76, i32 %14, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101564
...
for.body92:                                       ; preds = %for.cond89
  %arraypointer19 = getelementptr inbounds [256 x i32], [256 x i32]* %level, i32 0, i32 0, !dbg !101555
  ...
  store %struct.Cap %load.19, %struct.Cap* %agg.tmp9, align 4, !dbg !101550
  %18 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer19, i32 %i88.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %18, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx20 = getelementptr inbounds [11 x %struct.Cap], [11 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101550
  ...
  store %struct.Cap %store.20, %struct.Cap* %agg.tmp3, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xlevel, i32 %i88.0, i32 %18, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101564
...
for.body104:                                      ; preds = %for.cond101
  %arraypointer21 = getelementptr inbounds [10 x i32], [10 x i32]* %level_counts, i32 0, i32 0, !dbg !101555
  %cap.arrayidx21 = getelementptr inbounds [11 x %struct.Cap], [11 x %struct.Cap]* %caps, i64 0, i64 10, !dbg !101550
  ...
  %19 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer21, i32 %i100.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %19, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx22 = getelementptr inbounds [11 x %struct.Cap], [11 x %struct.Cap]* %caps, i64 0, i64 4, !dbg !101550
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xlevel_counts, i32 %i100.0, i32 %19, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101564
