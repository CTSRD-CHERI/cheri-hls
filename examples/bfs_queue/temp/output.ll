...
for.end87:                                        ; preds = %if.then, %for.cond33
  ...
  %cap.arrayidx19b = getelementptr inbounds [11 x %struct.Cap], [11 x %struct.Cap]* %caps, i64 0, i64 9, !dbg !101539
  %store.19b = load %struct.Cap, %struct.Cap* %cap.arrayidx19b, align 4, !dbg !101539
  store %struct.Cap %store.19b, %struct.Cap* %agg.tmp9, align 4, !dbg !101539

  call void @_Z18cheri_stream_writejPiS_Pj3CapS1_(i32 %node, i32* %xlevel, i32* %decay.19, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101539
  ...
  %cap.arrayidx20b = getelementptr inbounds [11 x %struct.Cap], [11 x %struct.Cap]* %caps, i64 0, i64 10, !dbg !101539
  %store.20b = load %struct.Cap, %struct.Cap* %cap.arrayidx20b, align 4, !dbg !101539
  store %struct.Cap %store.20b, %struct.Cap* %agg.tmp10, align 4, !dbg !101539

  call void @_Z18cheri_stream_writejPiS_Pj3CapS1_(i32 %levels, i32* %xlevel_counts, i32* %decay.20, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101539
...
!255 = !DILocation(line: 129, column: 30, scope: !44)
!256 = !DILocation(line: 129, column: 3, scope: !44)
!257 = !DILocation(line: 130, column: 39, scope: !44)
!258 = !DILocation(line: 130, column: 3, scope: !44)
!259 = !DILocation(line: 162, column: 1, scope: !44)
