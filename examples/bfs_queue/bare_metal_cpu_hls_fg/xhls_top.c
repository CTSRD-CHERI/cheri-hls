...
void XHls_top_Set_xnodes_b(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XNODES_B_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XNODES_B_DATA + 4, (u32)(Data >> 32));
}
...
u64 XHls_top_Get_xnodes_b(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XNODES_B_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XNODES_B_DATA + 4)
          << 32;
  return Data;
}
...
void XHls_top_Set_xnodes_e(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XNODES_E_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XNODES_E_DATA + 4, (u32)(Data >> 32));
}
...
u64 XHls_top_Get_xnodes_e(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XNODES_E_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XNODES_E_DATA + 4)
          << 32;
  return Data;
}
...
void XHls_top_Set_xedges(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XEDGES_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XEDGES_DATA + 4, (u32)(Data >> 32));
}
...
u64 XHls_top_Get_xedges(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XEDGES_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XEDGES_DATA + 4)
          << 32;
  return Data;
}
...
void XHls_top_Set_xlevel(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XLEVEL_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XLEVEL_DATA + 4, (u32)(Data >> 32));
}
...
u64 XHls_top_Get_xlevel(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XLEVEL_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XLEVEL_DATA + 4)
          << 32;
  return Data;
}
...
void XHls_top_Set_xlevel_counts(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XLEVEL_COUNTS_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XLEVEL_COUNTS_DATA + 4,
                    (u32)(Data >> 32));
}
...
u64 XHls_top_Get_xlevel_counts(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XLEVEL_COUNTS_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XLEVEL_COUNTS_DATA + 4)
          << 32;
  return Data;
