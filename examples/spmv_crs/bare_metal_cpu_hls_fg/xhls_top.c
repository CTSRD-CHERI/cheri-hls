...
void XHls_top_Set_xval(XHls_top *InstancePtr, u64 Data) {
  Xil_AssertVoid(InstancePtr != 0);
  Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XVAL_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XVAL_DATA + 4, (u32)(Data >> 32));
}

u64 XHls_top_Get_xval(XHls_top *InstancePtr) {
  u64 Data;
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XVAL_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XVAL_DATA + 4)
          << 32;
  return Data;
}
...
void XHls_top_Set_xrowDelimiters(XHls_top *InstancePtr, u64 Data) {
  Xil_AssertVoid(InstancePtr != 0);
  Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XROWDELIMITERS_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XROWDELIMITERS_DATA + 4,
                    (u32)(Data >> 32));
}

u64 XHls_top_Get_xrowDelimiters(XHls_top *InstancePtr) {
  u64 Data;
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XROWDELIMITERS_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XROWDELIMITERS_DATA + 4)
          << 32;
  return Data;
