...
; Function Attrs: nounwind
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="1666" %xval, i32* "fpga.decayed.dim.hint"="1666" %xcols, i32* "fpga.decayed.dim.hint"="495" %xrowDelimiters, i32* "fpga.decayed.dim.hint"="494" %xvec, i32* "fpga.decayed.dim.hint"="494" %xout, i32* %flag, i32* "fpga.decayed.dim.hint"="20" %cap) #3 !dbg !101522 !fpga.function.pragma !101525 {
entry:
...
for.end56:                                        ; preds = %for.cond34
  ...
  call void @_Z18cheri_stream_writejPiS_Pj3Cap(i32 494, i32* %xout, i32* %decay.5, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101539
