...
define void @twiddles8(i32* "fpga.decayed.dim.hint"="8" %data_x, i32* "fpga.decayed.dim.hint"="8" %data_y, i32 %i, i32 %n) #0 !dbg !9 {
entry:
...
; Function Attrs: nounwind
define void @loady8(i32* %data_y, i32* %smem, i32 %offset, i32 %sx) #0 !dbg !72 {
entry:
...
; Function Attrs: nounwind
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="512" %work_x, i32* "fpga.decayed.dim.hint"="512" %work_y) #3 !dbg !122 !fpga.function.pragma !125 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %idxprom = sext i32 %add to i64, !dbg !180
  %arrayidx = getelementptr inbounds i32, i32* %work_x, i64 %idxprom, !dbg !180
  %7 = load i32, i32* %arrayidx, align 4, !dbg !180
  ...
  %idxprom4 = sext i32 %add3 to i64, !dbg !185
  %arrayidx5 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom4, !dbg !185
  %8 = load i32, i32* %arrayidx5, align 4, !dbg !185
  ...
  %idxprom9 = sext i32 %add8 to i64, !dbg !190
  %arrayidx10 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom9, !dbg !190
  %9 = load i32, i32* %arrayidx10, align 4, !dbg !190
  ...
  %idxprom14 = sext i32 %add13 to i64, !dbg !195
  %arrayidx15 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom14, !dbg !195
  %10 = load i32, i32* %arrayidx15, align 4, !dbg !195
  ...
  %idxprom19 = sext i32 %add18 to i64, !dbg !200
  %arrayidx20 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom19, !dbg !200
  %11 = load i32, i32* %arrayidx20, align 4, !dbg !200
  ...
  %idxprom24 = sext i32 %add23 to i64, !dbg !205
  %arrayidx25 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom24, !dbg !205
  %12 = load i32, i32* %arrayidx25, align 4, !dbg !205
  ...
  %idxprom29 = sext i32 %add28 to i64, !dbg !210
  %arrayidx30 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom29, !dbg !210
  %13 = load i32, i32* %arrayidx30, align 4, !dbg !210
  ...
  %idxprom34 = sext i32 %add33 to i64, !dbg !215
  %arrayidx35 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom34, !dbg !215
  %14 = load i32, i32* %arrayidx35, align 4, !dbg !215
  ...
  %idxprom39 = sext i32 %add38 to i64, !dbg !220
  %arrayidx40 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom39, !dbg !220
  %15 = load i32, i32* %arrayidx40, align 4, !dbg !220
  ...
  %idxprom44 = sext i32 %add43 to i64, !dbg !225
  %arrayidx45 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom44, !dbg !225
  %16 = load i32, i32* %arrayidx45, align 4, !dbg !225
  ...
  %idxprom49 = sext i32 %add48 to i64, !dbg !230
  %arrayidx50 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom49, !dbg !230
  %17 = load i32, i32* %arrayidx50, align 4, !dbg !230
  ...
  %idxprom54 = sext i32 %add53 to i64, !dbg !235
  %arrayidx55 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom54, !dbg !235
  %18 = load i32, i32* %arrayidx55, align 4, !dbg !235
  ...
  %idxprom59 = sext i32 %add58 to i64, !dbg !240
  %arrayidx60 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom59, !dbg !240
  %19 = load i32, i32* %arrayidx60, align 4, !dbg !240
  ...
  %idxprom64 = sext i32 %add63 to i64, !dbg !245
  %arrayidx65 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom64, !dbg !245
  %20 = load i32, i32* %arrayidx65, align 4, !dbg !245
  ...
  %idxprom69 = sext i32 %add68 to i64, !dbg !250
  %arrayidx70 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom69, !dbg !250
  %21 = load i32, i32* %arrayidx70, align 4, !dbg !250
  ...
  %idxprom74 = sext i32 %add73 to i64, !dbg !255
  %arrayidx75 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom74, !dbg !255
  %22 = load i32, i32* %arrayidx75, align 4, !dbg !255
  ...
  call void @twiddles8(i32* %arraydecay, i32* %arraydecay333, i32 %tid.0, i32 512), !dbg !719
...
for.body634:                                      ; preds = %for.cond632
  ...
  call void @loady8(i32* %arraydecay677, i32* %arraydecay678, i32 %add680, i32 8), !dbg !1083
...
for.body725:                                      ; preds = %for.cond723
  ...
  call void @twiddles8(i32* %arraydecay1076, i32* %arraydecay1077, i32 %shr1075, i32 %size), !dbg !1677
...
for.body1383:                                     ; preds = %for.cond1381
  ...
  call void @loady8(i32* %arraydecay1426, i32* %arraydecay1427, i32 %add1429, i32 8), !dbg !2033
...
for.body1475:                                     ; preds = %for.cond1473
  ...
  %idxprom1828 = sext i32 %add1827 to i64, !dbg !2627
  %arrayidx1829 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom1828, !dbg !2627
  store i32 %444, i32* %arrayidx1829, align 4, !dbg !2628
  ...
  %idxprom1835 = sext i32 %add1834 to i64, !dbg !2633
  %arrayidx1836 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom1835, !dbg !2633
  store i32 %446, i32* %arrayidx1836, align 4, !dbg !2634
  ...
  %idxprom1842 = sext i32 %add1841 to i64, !dbg !2639
  %arrayidx1843 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom1842, !dbg !2639
  store i32 %448, i32* %arrayidx1843, align 4, !dbg !2640
  ...
  %idxprom1849 = sext i32 %add1848 to i64, !dbg !2645
  %arrayidx1850 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom1849, !dbg !2645
  store i32 %450, i32* %arrayidx1850, align 4, !dbg !2646
  ...
  %idxprom1856 = sext i32 %add1855 to i64, !dbg !2651
  %arrayidx1857 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom1856, !dbg !2651
  store i32 %452, i32* %arrayidx1857, align 4, !dbg !2652
  ...
  %idxprom1863 = sext i32 %add1862 to i64, !dbg !2657
  %arrayidx1864 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom1863, !dbg !2657
  store i32 %454, i32* %arrayidx1864, align 4, !dbg !2658
  ...
  %idxprom1870 = sext i32 %add1869 to i64, !dbg !2663
  %arrayidx1871 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom1870, !dbg !2663
  store i32 %456, i32* %arrayidx1871, align 4, !dbg !2664
  ...
  %idxprom1877 = sext i32 %add1876 to i64, !dbg !2669
  %arrayidx1878 = getelementptr inbounds i32, i32* %work_x, i64 %idxprom1877, !dbg !2669
  store i32 %458, i32* %arrayidx1878, align 4, !dbg !2670
  ...
  %idxprom1884 = sext i32 %add1883 to i64, !dbg !2675
  %arrayidx1885 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom1884, !dbg !2675
  store i32 %460, i32* %arrayidx1885, align 4, !dbg !2676
  ...
  %idxprom1891 = sext i32 %add1890 to i64, !dbg !2681
  %arrayidx1892 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom1891, !dbg !2681
  store i32 %462, i32* %arrayidx1892, align 4, !dbg !2682
  ...
  %idxprom1898 = sext i32 %add1897 to i64, !dbg !2687
  %arrayidx1899 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom1898, !dbg !2687
  store i32 %464, i32* %arrayidx1899, align 4, !dbg !2688
  ...
  %idxprom1905 = sext i32 %add1904 to i64, !dbg !2693
  %arrayidx1906 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom1905, !dbg !2693
  store i32 %466, i32* %arrayidx1906, align 4, !dbg !2694
  ...
  %idxprom1912 = sext i32 %add1911 to i64, !dbg !2699
  %arrayidx1913 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom1912, !dbg !2699
  store i32 %468, i32* %arrayidx1913, align 4, !dbg !2700
  ...
  %idxprom1919 = sext i32 %add1918 to i64, !dbg !2705
  %arrayidx1920 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom1919, !dbg !2705
  store i32 %470, i32* %arrayidx1920, align 4, !dbg !2706
  ...
  %idxprom1926 = sext i32 %add1925 to i64, !dbg !2711
  %arrayidx1927 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom1926, !dbg !2711
  store i32 %472, i32* %arrayidx1927, align 4, !dbg !2712
  ...
  %idxprom1933 = sext i32 %add1932 to i64, !dbg !2717
  %arrayidx1934 = getelementptr inbounds i32, i32* %work_y, i64 %idxprom1933, !dbg !2717
  store i32 %474, i32* %arrayidx1934, align 4, !dbg !2718
