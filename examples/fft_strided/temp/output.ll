...
define void @_Z7hls_topiPiS_S_S_S_S_(i32 %size, i32* "fpga.decayed.dim.hint"="1024" %xreal, i32* "fpga.decayed.dim.hint"="1024" %ximg, i32* "fpga.decayed.dim.hint"="512" %xreal_twid, i32* "fpga.decayed.dim.hint"="512" %ximg_twid, i32* "fpga.decayed.dim.hint"="1024" %yreal, i32* "fpga.decayed.dim.hint"="1024" %yimg, i32* %flag, i32* "fpga.decayed.dim.hint"="24" %cap) #0 !dbg !101468 !fpga.function.pragma !101471 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %8 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xreal, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101527
...
for.body7:                                        ; preds = %for.cond4
  ...
  %9 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %ximg, i32 %i3.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101527
...
for.body19:                                       ; preds = %for.cond16
  ...
  %10 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xreal_twid, i32 %i15.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101527
...
for.body32:                                       ; preds = %for.cond28
  ...
  %11 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %ximg_twid, i32 %i27.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101527
...
for.body109:                                      ; preds = %for.cond106
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %yreal, i32 %i105.0, i32 %28, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101539
...
for.body121:                                      ; preds = %for.cond118
  ...
  call void @llvm.dbg.value(metadata i32 %29, metadata !101528, metadata !DIExpression()), !dbg !101539
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %yimg, i32 %i117.0, i32 %29, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101539
