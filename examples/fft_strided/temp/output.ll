...
define void @_Z7hls_topiPiS_S_S_S_S_(i32 %size, i32* "fpga.decayed.dim.hint"="1024" %xreal, i32* "fpga.decayed.dim.hint"="1024" %ximg, i32* "fpga.decayed.dim.hint"="512" %xreal_twid, i32* "fpga.decayed.dim.hint"="512" %ximg_twid, i32* "fpga.decayed.dim.hint"="1024" %yreal, i32* "fpga.decayed.dim.hint"="1024" %yimg, i32* %flag, i32* "fpga.decayed.dim.hint"="24" %cap) #0 !dbg !101467 !fpga.function.pragma !101470 {
entry:
