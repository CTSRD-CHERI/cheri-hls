...
entry:
  ...
  br label %VITIS_LOOP_109_1, !dbg !1294
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  br label %VITIS_LOOP_114_2, !dbg !1317
...
entry:
  ...
  %idxprom = sext i32 %i to i64, !dbg !1404
  %arrayidx = getelementptr inbounds i32, i32* %buf, i64 %idxprom, !dbg !1404
  %1 = load i32, i32* %arrayidx, align 4, !dbg !1404
  call void @llvm.dbg.value(metadata i32 %1, metadata !1405, metadata !DIExpression()), !dbg !1406
  %2 = load i32, i32* %flag_buf, align 4, !dbg !1407
  %tobool = icmp ne i32 %2, 0, !dbg !1408
  br i1 %tobool, label %cond.true, label %cond.false, !dbg !1408
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %1, %cond.true ], [ 0, %cond.false ], !dbg !1408
  ret i32 %cond, !dbg !1409
}
...
; Function Attrs: alwaysinline nounwind
define void @_Z11cheri_storePiiiPj3Cap(i32* %buf, i32 %i, i32 %val, i32* %flag_buf, %struct.Cap* byval align 4 %cap) #15 !dbg !1410 !fpga.function.pragma !1413 {
entry:
  %agg.tmp = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %"struct.ap_uint<3>", align 1
  call void @llvm.dbg.value(metadata i32* %buf, metadata !1416, metadata !DIExpression()), !dbg !1417
  call void @llvm.dbg.value(metadata i32 %i, metadata !1418, metadata !DIExpression()), !dbg !1419
  call void @llvm.dbg.value(metadata i32 %val, metadata !1420, metadata !DIExpression()), !dbg !1421
  call void @llvm.dbg.value(metadata i32* %flag_buf, metadata !1422, metadata !DIExpression()), !dbg !1423
  call void @llvm.dbg.declare(metadata %struct.Cap* %cap, metadata !1424, metadata !DIExpression()), !dbg !1425
  %0 = load %struct.Cap, %struct.Cap* %cap, align 4, !dbg !1426
  store %struct.Cap %0, %struct.Cap* %agg.tmp, align 4, !dbg !1426
  %conv = trunc i32 %i to i16, !dbg !1427
  call void @_ZN7ap_uintILi3EEC2Ei(%"struct.ap_uint<3>"* %agg.tmp1, i32 4), !dbg !1428
  call void @_Z11checkAccessPj3Capt7ap_uintILi3EEb(i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp, i16 zeroext %conv, %"struct.ap_uint<3>"* byval align 1 %agg.tmp1, i1 zeroext true), !dbg !1429
  %1 = load i32, i32* %flag_buf, align 4, !dbg !1430
...
cond.false:                                       ; preds = %entry
  ...
  %2 = load i32, i32* %arrayidx, align 4, !dbg !1432
  br label %cond.end, !dbg !1431

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %val, %cond.true ], [ %2, %cond.false ], !dbg !1431
  %idxprom2 = sext i32 %i to i64, !dbg !1433
  %arrayidx3 = getelementptr inbounds i32, i32* %buf, i64 %idxprom2, !dbg !1433
  store i32 %cond, i32* %arrayidx3, align 4, !dbg !1434
  ret void, !dbg !1435
}

; Function Attrs: nounwind
define void @_Z7hls_topiPiS_S_S_S_S_PjS0_(i32 %size, i32* "fpga.decayed.dim.hint"="1024" %xreal, i32* "fpga.decayed.dim.hint"="1024" %ximg, i32* "fpga.decayed.dim.hint"="512" %xreal_twid, i32* "fpga.decayed.dim.hint"="512" %ximg_twid, i32* "fpga.decayed.dim.hint"="1024" %yreal, i32* "fpga.decayed.dim.hint"="1024" %yimg, i32* %flag, i32* "fpga.decayed.dim.hint"="24" %cap) #16 !dbg !1436 !fpga.function.pragma !1439 {
entry:
  ...
  %agg.tmp35 = alloca %struct.Cap, align 4
  %agg.tmp115 = alloca %struct.Cap, align 4
  %agg.tmp127 = alloca %struct.Cap, align 4
  call void @llvm.dbg.value(metadata i32 %size, metadata !1442, metadata !DIExpression()), !dbg !1443
  call void @llvm.dbg.value(metadata i32* %xreal, metadata !1444, metadata !DIExpression()), !dbg !1445
  call void @llvm.dbg.value(metadata i32* %ximg, metadata !1446, metadata !DIExpression()), !dbg !1447
  call void @llvm.dbg.value(metadata i32* %xreal_twid, metadata !1448, metadata !DIExpression()), !dbg !1449
  call void @llvm.dbg.value(metadata i32* %ximg_twid, metadata !1450, metadata !DIExpression()), !dbg !1451
  call void @llvm.dbg.value(metadata i32* %yreal, metadata !1452, metadata !DIExpression()), !dbg !1453
  call void @llvm.dbg.value(metadata i32* %yimg, metadata !1454, metadata !DIExpression()), !dbg !1455
  call void @llvm.dbg.value(metadata i32* %flag, metadata !1456, metadata !DIExpression()), !dbg !1457
  call void @llvm.dbg.value(metadata i32* %cap, metadata !1458, metadata !DIExpression()), !dbg !1459
  call void @llvm.sideeffect() #19 [ "xlx_m_axi"(i32* %xreal, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !1460
  call void @llvm.sideeffect() #19 [ "xlx_m_axi"(i32* %ximg, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !1461
  call void @llvm.sideeffect() #19 [ "xlx_m_axi"(i32* %yreal, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !1462
  call void @llvm.sideeffect() #19 [ "xlx_m_axi"(i32* %yimg, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !1463
  call void @llvm.sideeffect() #20 [ "xlx_m_axi"(i32* %xreal_twid, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !1464
  call void @llvm.sideeffect() #20 [ "xlx_m_axi"(i32* %ximg_twid, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !1465
  call void @llvm.sideeffect() #21 [ "xlx_m_axi"(i32* %cap, [0 x i8] zeroinitializer, i64 -1, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, [0 x i8] zeroinitializer) ], !dbg !1466
  call void @llvm.sideeffect() #22 [ "xlx_s_axilite"(i32 %size, [0 x i8] zeroinitializer, i64 -1, i1 false, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer) ], !dbg !1467
  call void @llvm.sideeffect() #23 [ "xlx_s_axilite"(i32* %flag, [0 x i8] zeroinitializer, i64 -1, i1 false, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer) ], !dbg !1468
  call void @llvm.sideeffect() #23 [ "xlx_s_axilite"(i8* null, [0 x i8] zeroinitializer, i64 -1, i1 false, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer, [0 x i8] zeroinitializer) ], !dbg !1469
  %0 = bitcast i32* %flag_buf to i8*, !dbg !1470
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #18, !dbg !1470
  call void @llvm.dbg.declare(metadata i32* %flag_buf, metadata !1471, metadata !DIExpression()), !dbg !1472
  store i32 0, i32* %flag_buf, align 4, !dbg !1472
  %1 = bitcast [6 x %struct.Cap]* %caps to i8*, !dbg !1473
  call void @llvm.lifetime.start.p0i8(i64 72, i8* %1) #18, !dbg !1473
  call void @llvm.dbg.declare(metadata [6 x %struct.Cap]* %caps, metadata !1474, metadata !DIExpression()), !dbg !1478
  %2 = bitcast [24 x i32]* %buffer to i8*, !dbg !1479
  call void @llvm.lifetime.start.p0i8(i64 96, i8* %2) #18, !dbg !1479
  call void @llvm.dbg.declare(metadata [24 x i32]* %buffer, metadata !1480, metadata !DIExpression()), !dbg !1484
  call void @llvm.sideeffect() #21 [ "xlx_array_partition"([24 x i32]* %buffer, i32 2, i32 0, i32 1, i1 false) ], !dbg !1485
  call void @llvm.sideeffect() #24 [ "xlx_array_partition"([6 x %struct.Cap]* %caps, i32 2, i32 0, i32 1, i1 false) ], !dbg !1486
  %arraydecay = getelementptr inbounds [24 x i32], [24 x i32]* %buffer, i32 0, i32 0, !dbg !1487
  %arraydecay1 = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i32 0, i32 0, !dbg !1488
  call void @_Z8load_capiPjS_P3Cap(i32 6, i32* %arraydecay, i32* %cap, %struct.Cap* %arraydecay1), !dbg !1489
  call void @llvm.dbg.value(metadata i32 0, metadata !1490, metadata !DIExpression()), !dbg !1491
  %3 = bitcast [1024 x i32]* %real to i8*, !dbg !1492
  call void @llvm.lifetime.start.p0i8(i64 4096, i8* %3) #18, !dbg !1492
  call void @llvm.dbg.declare(metadata [1024 x i32]* %real, metadata !1493, metadata !DIExpression()), !dbg !1497
  %4 = bitcast [1024 x i32]* %real to i8*, !dbg !1497
  call void @llvm.memset.p0i8.i64(i8* align 4 %4, i8 0, i64 4096, i1 false), !dbg !1497
  %5 = bitcast [1024 x i32]* %img to i8*, !dbg !1498
  call void @llvm.lifetime.start.p0i8(i64 4096, i8* %5) #18, !dbg !1498
  call void @llvm.dbg.declare(metadata [1024 x i32]* %img, metadata !1499, metadata !DIExpression()), !dbg !1500
  %6 = bitcast [1024 x i32]* %img to i8*, !dbg !1500
  call void @llvm.memset.p0i8.i64(i8* align 4 %6, i8 0, i64 4096, i1 false), !dbg !1500
  %7 = bitcast [512 x i32]* %real_twid to i8*, !dbg !1501
  call void @llvm.lifetime.start.p0i8(i64 2048, i8* %7) #18, !dbg !1501
  call void @llvm.dbg.declare(metadata [512 x i32]* %real_twid, metadata !1502, metadata !DIExpression()), !dbg !1506
  %8 = bitcast [512 x i32]* %real_twid to i8*, !dbg !1506
  call void @llvm.memset.p0i8.i64(i8* align 4 %8, i8 0, i64 2048, i1 false), !dbg !1506
  %9 = bitcast [512 x i32]* %img_twid to i8*, !dbg !1507
  call void @llvm.lifetime.start.p0i8(i64 2048, i8* %9) #18, !dbg !1507
  call void @llvm.dbg.declare(metadata [512 x i32]* %img_twid, metadata !1508, metadata !DIExpression()), !dbg !1509
  %10 = bitcast [512 x i32]* %img_twid to i8*, !dbg !1509
  call void @llvm.memset.p0i8.i64(i8* align 4 %10, i8 0, i64 2048, i1 false), !dbg !1509
  br label %VITIS_LOOP_188_1, !dbg !1507

VITIS_LOOP_188_1:                                 ; preds = %entry
  call void @llvm.dbg.value(metadata i32 0, metadata !1510, metadata !DIExpression()), !dbg !1512
  br label %for.cond, !dbg !1513

for.cond:                                         ; preds = %for.inc, %VITIS_LOOP_188_1
  %i.0 = phi i32 [ 0, %VITIS_LOOP_188_1 ], [ %inc, %for.inc ]
  call void @llvm.dbg.value(metadata i32 %i.0, metadata !1510, metadata !DIExpression()), !dbg !1512
  %cmp = icmp slt i32 %i.0, %size, !dbg !1514
  br i1 %cmp, label %for.body, label %for.cond.cleanup, !dbg !1516

for.cond.cleanup:                                 ; preds = %for.cond
  br label %for.end

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !1517
  %11 = load %struct.Cap, %struct.Cap* %arrayidx, align 4, !dbg !1517
  store %struct.Cap %11, %struct.Cap* %agg.tmp, align 4, !dbg !1517
  %call = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xreal, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp), !dbg !1519
  call void @llvm.dbg.value(metadata i32 %call, metadata !1520, metadata !DIExpression()), !dbg !1521
  %idxprom = sext i32 %i.0 to i64, !dbg !1522
  %arrayidx2 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom, !dbg !1522
  store i32 %call, i32* %arrayidx2, align 4, !dbg !1523
  br label %for.inc, !dbg !1524

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !dbg !1525
  call void @llvm.dbg.value(metadata i32 %inc, metadata !1510, metadata !DIExpression()), !dbg !1512
  br label %for.cond, !dbg !1526, !llvm.loop !1527

for.end:                                          ; preds = %for.cond.cleanup
  br label %VITIS_LOOP_192_2, !dbg !1528

VITIS_LOOP_192_2:                                 ; preds = %for.end
  call void @llvm.dbg.value(metadata i32 0, metadata !1530, metadata !DIExpression()), !dbg !1532
  br label %for.cond4, !dbg !1533

for.cond4:                                        ; preds = %for.inc13, %VITIS_LOOP_192_2
  %i3.0 = phi i32 [ 0, %VITIS_LOOP_192_2 ], [ %inc14, %for.inc13 ]
  call void @llvm.dbg.value(metadata i32 %i3.0, metadata !1530, metadata !DIExpression()), !dbg !1532
  %cmp5 = icmp slt i32 %i3.0, %size, !dbg !1534
  br i1 %cmp5, label %for.body7, label %for.cond.cleanup6, !dbg !1536

for.cond.cleanup6:                                ; preds = %for.cond4
  br label %for.end15

for.body7:                                        ; preds = %for.cond4
  %arrayidx9 = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !1537
  %12 = load %struct.Cap, %struct.Cap* %arrayidx9, align 4, !dbg !1537
  store %struct.Cap %12, %struct.Cap* %agg.tmp8, align 4, !dbg !1537
  %call10 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %ximg, i32 %i3.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !1539
  call void @llvm.dbg.value(metadata i32 %call10, metadata !1540, metadata !DIExpression()), !dbg !1541
  %idxprom11 = sext i32 %i3.0 to i64, !dbg !1542
  %arrayidx12 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom11, !dbg !1542
  store i32 %call10, i32* %arrayidx12, align 4, !dbg !1543
  br label %for.inc13, !dbg !1544

for.inc13:                                        ; preds = %for.body7
  %inc14 = add nsw i32 %i3.0, 1, !dbg !1545
  call void @llvm.dbg.value(metadata i32 %inc14, metadata !1530, metadata !DIExpression()), !dbg !1532
  br label %for.cond4, !dbg !1546, !llvm.loop !1547

for.end15:                                        ; preds = %for.cond.cleanup6
  br label %VITIS_LOOP_196_3, !dbg !1548

VITIS_LOOP_196_3:                                 ; preds = %for.end15
  call void @llvm.dbg.value(metadata i32 0, metadata !1550, metadata !DIExpression()), !dbg !1552
  br label %for.cond17, !dbg !1553

for.cond17:                                       ; preds = %for.inc26, %VITIS_LOOP_196_3
  %i16.0 = phi i32 [ 0, %VITIS_LOOP_196_3 ], [ %inc27, %for.inc26 ]
  call void @llvm.dbg.value(metadata i32 %i16.0, metadata !1550, metadata !DIExpression()), !dbg !1552
  %div = sdiv i32 %size, 2, !dbg !1554
  %cmp18 = icmp slt i32 %i16.0, %div, !dbg !1556
  br i1 %cmp18, label %for.body20, label %for.cond.cleanup19, !dbg !1557

for.cond.cleanup19:                               ; preds = %for.cond17
  br label %for.end28

for.body20:                                       ; preds = %for.cond17
  %arrayidx22 = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !1558
  %13 = load %struct.Cap, %struct.Cap* %arrayidx22, align 4, !dbg !1558
  store %struct.Cap %13, %struct.Cap* %agg.tmp21, align 4, !dbg !1558
  %call23 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xreal_twid, i32 %i16.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp21), !dbg !1560
  call void @llvm.dbg.value(metadata i32 %call23, metadata !1561, metadata !DIExpression()), !dbg !1562
  %idxprom24 = sext i32 %i16.0 to i64, !dbg !1563
  %arrayidx25 = getelementptr inbounds [512 x i32], [512 x i32]* %real_twid, i64 0, i64 %idxprom24, !dbg !1563
  store i32 %call23, i32* %arrayidx25, align 4, !dbg !1564
  br label %for.inc26, !dbg !1565

for.inc26:                                        ; preds = %for.body20
  %inc27 = add nsw i32 %i16.0, 1, !dbg !1566
  call void @llvm.dbg.value(metadata i32 %inc27, metadata !1550, metadata !DIExpression()), !dbg !1552
  br label %for.cond17, !dbg !1567, !llvm.loop !1568

for.end28:                                        ; preds = %for.cond.cleanup19
  br label %VITIS_LOOP_200_4, !dbg !1569

VITIS_LOOP_200_4:                                 ; preds = %for.end28
  call void @llvm.dbg.value(metadata i32 0, metadata !1571, metadata !DIExpression()), !dbg !1573
  br label %for.cond30, !dbg !1574

for.cond30:                                       ; preds = %for.inc40, %VITIS_LOOP_200_4
  %i29.0 = phi i32 [ 0, %VITIS_LOOP_200_4 ], [ %inc41, %for.inc40 ]
  call void @llvm.dbg.value(metadata i32 %i29.0, metadata !1571, metadata !DIExpression()), !dbg !1573
  %div31 = sdiv i32 %size, 2, !dbg !1575
  %cmp32 = icmp slt i32 %i29.0, %div31, !dbg !1577
  br i1 %cmp32, label %for.body34, label %for.cond.cleanup33, !dbg !1578

for.cond.cleanup33:                               ; preds = %for.cond30
  br label %for.end42

for.body34:                                       ; preds = %for.cond30
  %arrayidx36 = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !1579
  %14 = load %struct.Cap, %struct.Cap* %arrayidx36, align 4, !dbg !1579
  store %struct.Cap %14, %struct.Cap* %agg.tmp35, align 4, !dbg !1579
  %call37 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %ximg_twid, i32 %i29.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp35), !dbg !1581
  call void @llvm.dbg.value(metadata i32 %call37, metadata !1582, metadata !DIExpression()), !dbg !1583
  %idxprom38 = sext i32 %i29.0 to i64, !dbg !1584
  %arrayidx39 = getelementptr inbounds [512 x i32], [512 x i32]* %img_twid, i64 0, i64 %idxprom38, !dbg !1584
  store i32 %call37, i32* %arrayidx39, align 4, !dbg !1585
  br label %for.inc40, !dbg !1586

for.inc40:                                        ; preds = %for.body34
  %inc41 = add nsw i32 %i29.0, 1, !dbg !1587
  call void @llvm.dbg.value(metadata i32 %inc41, metadata !1571, metadata !DIExpression()), !dbg !1573
  br label %for.cond30, !dbg !1588, !llvm.loop !1589

for.end42:                                        ; preds = %for.cond.cleanup33
  br label %outer, !dbg !1590

outer:                                            ; preds = %for.end42
  %shr = ashr i32 %size, 1, !dbg !1592
  call void @llvm.dbg.value(metadata i32 %shr, metadata !1594, metadata !DIExpression()), !dbg !1595
  br label %for.cond43, !dbg !1596

for.cond43:                                       ; preds = %for.inc104, %outer
  %span.0 = phi i32 [ %shr, %outer ], [ %shr105, %for.inc104 ]
  %log.0 = phi i32 [ 0, %outer ], [ %inc106, %for.inc104 ]
  call void @llvm.dbg.value(metadata i32 %log.0, metadata !1490, metadata !DIExpression()), !dbg !1491
  call void @llvm.dbg.value(metadata i32 %span.0, metadata !1594, metadata !DIExpression()), !dbg !1595
  %tobool = icmp ne i32 %span.0, 0, !dbg !1597
  br i1 %tobool, label %for.body44, label %for.end107, !dbg !1599

for.body44:                                       ; preds = %for.cond43
  br label %inner, !dbg !1600

inner:                                            ; preds = %for.body44
  call void @llvm.dbg.value(metadata i32 %span.0, metadata !1601, metadata !DIExpression()), !dbg !1602
  br label %for.cond45, !dbg !1603

for.cond45:                                       ; preds = %for.inc101, %inner
  %odd.0 = phi i32 [ %span.0, %inner ], [ %inc102, %for.inc101 ]
  call void @llvm.dbg.value(metadata i32 %odd.0, metadata !1601, metadata !DIExpression()), !dbg !1602
  %cmp46 = icmp slt i32 %odd.0, %size, !dbg !1606
  br i1 %cmp46, label %for.body47, label %for.end103, !dbg !1608

for.body47:                                       ; preds = %for.cond45
  %or = or i32 %odd.0, %span.0, !dbg !1609
  call void @llvm.dbg.value(metadata i32 %or, metadata !1601, metadata !DIExpression()), !dbg !1602
  %xor = xor i32 %or, %span.0, !dbg !1611
  call void @llvm.dbg.value(metadata i32 %xor, metadata !1612, metadata !DIExpression()), !dbg !1613
  %idxprom48 = sext i32 %xor to i64, !dbg !1614
  %arrayidx49 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom48, !dbg !1614
  %15 = load i32, i32* %arrayidx49, align 4, !dbg !1614
  %idxprom50 = sext i32 %or to i64, !dbg !1615
  %arrayidx51 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom50, !dbg !1615
  %16 = load i32, i32* %arrayidx51, align 4, !dbg !1615
  %add = add nsw i32 %15, %16, !dbg !1616
  call void @llvm.dbg.value(metadata i32 %add, metadata !1617, metadata !DIExpression()), !dbg !1618
  %idxprom52 = sext i32 %xor to i64, !dbg !1619
  %arrayidx53 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom52, !dbg !1619
  %17 = load i32, i32* %arrayidx53, align 4, !dbg !1619
  %idxprom54 = sext i32 %or to i64, !dbg !1620
  %arrayidx55 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom54, !dbg !1620
  %18 = load i32, i32* %arrayidx55, align 4, !dbg !1620
  %sub = sub nsw i32 %17, %18, !dbg !1621
  %idxprom56 = sext i32 %or to i64, !dbg !1622
  %arrayidx57 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom56, !dbg !1622
  store i32 %sub, i32* %arrayidx57, align 4, !dbg !1623
  %idxprom58 = sext i32 %xor to i64, !dbg !1624
  %arrayidx59 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom58, !dbg !1624
  store i32 %add, i32* %arrayidx59, align 4, !dbg !1625
  %idxprom60 = sext i32 %xor to i64, !dbg !1626
  %arrayidx61 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom60, !dbg !1626
  %19 = load i32, i32* %arrayidx61, align 4, !dbg !1626
  %idxprom62 = sext i32 %or to i64, !dbg !1627
  %arrayidx63 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom62, !dbg !1627
  %20 = load i32, i32* %arrayidx63, align 4, !dbg !1627
  %add64 = add nsw i32 %19, %20, !dbg !1628
  call void @llvm.dbg.value(metadata i32 %add64, metadata !1617, metadata !DIExpression()), !dbg !1618
  %idxprom65 = sext i32 %xor to i64, !dbg !1629
  %arrayidx66 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom65, !dbg !1629
  %21 = load i32, i32* %arrayidx66, align 4, !dbg !1629
  %idxprom67 = sext i32 %or to i64, !dbg !1630
  %arrayidx68 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom67, !dbg !1630
  %22 = load i32, i32* %arrayidx68, align 4, !dbg !1630
  %sub69 = sub nsw i32 %21, %22, !dbg !1631
  %idxprom70 = sext i32 %or to i64, !dbg !1632
  %arrayidx71 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom70, !dbg !1632
  store i32 %sub69, i32* %arrayidx71, align 4, !dbg !1633
  %idxprom72 = sext i32 %xor to i64, !dbg !1634
  %arrayidx73 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom72, !dbg !1634
  store i32 %add64, i32* %arrayidx73, align 4, !dbg !1635
  %shl = shl i32 %xor, %log.0, !dbg !1636
  %sub74 = sub nsw i32 %size, 1, !dbg !1637
  %and = and i32 %shl, %sub74, !dbg !1638
  call void @llvm.dbg.value(metadata i32 %and, metadata !1639, metadata !DIExpression()), !dbg !1640
  %tobool75 = icmp ne i32 %and, 0, !dbg !1641
  br i1 %tobool75, label %if.then, label %if.end, !dbg !1643

if.then:                                          ; preds = %for.body47
  %idxprom76 = sext i32 %and to i64, !dbg !1644
  %arrayidx77 = getelementptr inbounds [512 x i32], [512 x i32]* %real_twid, i64 0, i64 %idxprom76, !dbg !1644
  %23 = load i32, i32* %arrayidx77, align 4, !dbg !1644
  %idxprom78 = sext i32 %or to i64, !dbg !1646
  %arrayidx79 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom78, !dbg !1646
  %24 = load i32, i32* %arrayidx79, align 4, !dbg !1646
  %mul = mul nsw i32 %23, %24, !dbg !1647
  %idxprom80 = sext i32 %and to i64, !dbg !1648
  %arrayidx81 = getelementptr inbounds [512 x i32], [512 x i32]* %img_twid, i64 0, i64 %idxprom80, !dbg !1648
  %25 = load i32, i32* %arrayidx81, align 4, !dbg !1648
  %idxprom82 = sext i32 %or to i64, !dbg !1649
  %arrayidx83 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom82, !dbg !1649
  %26 = load i32, i32* %arrayidx83, align 4, !dbg !1649
  %mul84 = mul nsw i32 %25, %26, !dbg !1650
  %sub85 = sub nsw i32 %mul, %mul84, !dbg !1651
  call void @llvm.dbg.value(metadata i32 %sub85, metadata !1617, metadata !DIExpression()), !dbg !1618
  %idxprom86 = sext i32 %and to i64, !dbg !1652
  %arrayidx87 = getelementptr inbounds [512 x i32], [512 x i32]* %real_twid, i64 0, i64 %idxprom86, !dbg !1652
  %27 = load i32, i32* %arrayidx87, align 4, !dbg !1652
  %idxprom88 = sext i32 %or to i64, !dbg !1653
  %arrayidx89 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom88, !dbg !1653
  %28 = load i32, i32* %arrayidx89, align 4, !dbg !1653
  %mul90 = mul nsw i32 %27, %28, !dbg !1654
  %idxprom91 = sext i32 %and to i64, !dbg !1655
  %arrayidx92 = getelementptr inbounds [512 x i32], [512 x i32]* %img_twid, i64 0, i64 %idxprom91, !dbg !1655
  %29 = load i32, i32* %arrayidx92, align 4, !dbg !1655
  %idxprom93 = sext i32 %or to i64, !dbg !1656
  %arrayidx94 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom93, !dbg !1656
  %30 = load i32, i32* %arrayidx94, align 4, !dbg !1656
  %mul95 = mul nsw i32 %29, %30, !dbg !1657
  %add96 = add nsw i32 %mul90, %mul95, !dbg !1658
  %idxprom97 = sext i32 %or to i64, !dbg !1659
  %arrayidx98 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom97, !dbg !1659
  store i32 %add96, i32* %arrayidx98, align 4, !dbg !1660
  %idxprom99 = sext i32 %or to i64, !dbg !1661
  %arrayidx100 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom99, !dbg !1661
  store i32 %sub85, i32* %arrayidx100, align 4, !dbg !1662
  br label %if.end, !dbg !1663

if.end:                                           ; preds = %if.then, %for.body47
  br label %for.inc101, !dbg !1664

for.inc101:                                       ; preds = %if.end
  %inc102 = add nsw i32 %or, 1, !dbg !1665
  call void @llvm.dbg.value(metadata i32 %inc102, metadata !1601, metadata !DIExpression()), !dbg !1602
  br label %for.cond45, !dbg !1666, !llvm.loop !1667

for.end103:                                       ; preds = %for.cond45
  br label %for.inc104, !dbg !1670

for.inc104:                                       ; preds = %for.end103
  %shr105 = ashr i32 %span.0, 1, !dbg !1671
  call void @llvm.dbg.value(metadata i32 %shr105, metadata !1594, metadata !DIExpression()), !dbg !1595
  %inc106 = add nsw i32 %log.0, 1, !dbg !1672
  call void @llvm.dbg.value(metadata i32 %inc106, metadata !1490, metadata !DIExpression()), !dbg !1491
  br label %for.cond43, !dbg !1673, !llvm.loop !1674

for.end107:                                       ; preds = %for.cond43
  br label %VITIS_LOOP_230_5, !dbg !1675

VITIS_LOOP_230_5:                                 ; preds = %for.end107
  call void @llvm.dbg.value(metadata i32 0, metadata !1677, metadata !DIExpression()), !dbg !1679
  br label %for.cond109, !dbg !1680

for.cond109:                                      ; preds = %for.inc117, %VITIS_LOOP_230_5
  %i108.0 = phi i32 [ 0, %VITIS_LOOP_230_5 ], [ %inc118, %for.inc117 ]
  call void @llvm.dbg.value(metadata i32 %i108.0, metadata !1677, metadata !DIExpression()), !dbg !1679
  %cmp110 = icmp slt i32 %i108.0, %size, !dbg !1681
  br i1 %cmp110, label %for.body112, label %for.cond.cleanup111, !dbg !1683

for.cond.cleanup111:                              ; preds = %for.cond109
  br label %for.end119

for.body112:                                      ; preds = %for.cond109
  %idxprom113 = sext i32 %i108.0 to i64, !dbg !1684
  %arrayidx114 = getelementptr inbounds [1024 x i32], [1024 x i32]* %real, i64 0, i64 %idxprom113, !dbg !1684
  %31 = load i32, i32* %arrayidx114, align 4, !dbg !1684
  call void @llvm.dbg.value(metadata i32 %31, metadata !1686, metadata !DIExpression()), !dbg !1687
  %arrayidx116 = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i64 0, i64 4, !dbg !1688
  %32 = load %struct.Cap, %struct.Cap* %arrayidx116, align 4, !dbg !1688
  store %struct.Cap %32, %struct.Cap* %agg.tmp115, align 4, !dbg !1688
  call void @_Z11cheri_storePiiiPj3Cap(i32* %yreal, i32 %i108.0, i32 %31, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp115), !dbg !1689
  br label %for.inc117, !dbg !1690

for.inc117:                                       ; preds = %for.body112
  %inc118 = add nsw i32 %i108.0, 1, !dbg !1691
  call void @llvm.dbg.value(metadata i32 %inc118, metadata !1677, metadata !DIExpression()), !dbg !1679
  br label %for.cond109, !dbg !1692, !llvm.loop !1693

for.end119:                                       ; preds = %for.cond.cleanup111
  br label %VITIS_LOOP_234_6, !dbg !1694

VITIS_LOOP_234_6:                                 ; preds = %for.end119
  call void @llvm.dbg.value(metadata i32 0, metadata !1696, metadata !DIExpression()), !dbg !1698
  br label %for.cond121, !dbg !1699

for.cond121:                                      ; preds = %for.inc129, %VITIS_LOOP_234_6
  %i120.0 = phi i32 [ 0, %VITIS_LOOP_234_6 ], [ %inc130, %for.inc129 ]
  call void @llvm.dbg.value(metadata i32 %i120.0, metadata !1696, metadata !DIExpression()), !dbg !1698
  %cmp122 = icmp slt i32 %i120.0, %size, !dbg !1700
  br i1 %cmp122, label %for.body124, label %for.cond.cleanup123, !dbg !1702

for.cond.cleanup123:                              ; preds = %for.cond121
  br label %for.end131

for.body124:                                      ; preds = %for.cond121
  %idxprom125 = sext i32 %i120.0 to i64, !dbg !1703
  %arrayidx126 = getelementptr inbounds [1024 x i32], [1024 x i32]* %img, i64 0, i64 %idxprom125, !dbg !1703
  %33 = load i32, i32* %arrayidx126, align 4, !dbg !1703
  call void @llvm.dbg.value(metadata i32 %33, metadata !1705, metadata !DIExpression()), !dbg !1706
  %arrayidx128 = getelementptr inbounds [6 x %struct.Cap], [6 x %struct.Cap]* %caps, i64 0, i64 5, !dbg !1707
  %34 = load %struct.Cap, %struct.Cap* %arrayidx128, align 4, !dbg !1707
  store %struct.Cap %34, %struct.Cap* %agg.tmp127, align 4, !dbg !1707
  call void @_Z11cheri_storePiiiPj3Cap(i32* %yimg, i32 %i120.0, i32 %33, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp127), !dbg !1708
  br label %for.inc129, !dbg !1709

for.inc129:                                       ; preds = %for.body124
  %inc130 = add nsw i32 %i120.0, 1, !dbg !1710
  call void @llvm.dbg.value(metadata i32 %inc130, metadata !1696, metadata !DIExpression()), !dbg !1698
  br label %for.cond121, !dbg !1711, !llvm.loop !1712

for.end131:                                       ; preds = %for.cond.cleanup123
  %35 = bitcast [512 x i32]* %img_twid to i8*, !dbg !1715
  call void @llvm.lifetime.end.p0i8(i64 2048, i8* %35) #18, !dbg !1715
  %36 = bitcast [512 x i32]* %real_twid to i8*, !dbg !1715
  call void @llvm.lifetime.end.p0i8(i64 2048, i8* %36) #18, !dbg !1715
  %37 = bitcast [1024 x i32]* %img to i8*, !dbg !1715
  call void @llvm.lifetime.end.p0i8(i64 4096, i8* %37) #18, !dbg !1715
  %38 = bitcast [1024 x i32]* %real to i8*, !dbg !1715
  call void @llvm.lifetime.end.p0i8(i64 4096, i8* %38) #18, !dbg !1715
  %39 = bitcast [24 x i32]* %buffer to i8*, !dbg !1715
  call void @llvm.lifetime.end.p0i8(i64 96, i8* %39) #18, !dbg !1715
  %40 = bitcast [6 x %struct.Cap]* %caps to i8*, !dbg !1715
  call void @llvm.lifetime.end.p0i8(i64 72, i8* %40) #18, !dbg !1715
  %41 = bitcast i32* %flag_buf to i8*, !dbg !1715
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %41) #18, !dbg !1715
  ret void, !dbg !1715
}
...
attributes #19 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="32768" "xlx.source"="user" }
attributes #20 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="16384" "xlx.source"="user" }
attributes #21 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="768" "xlx.source"="user" }
...
attributes #24 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="576" "xlx.source"="user" }
...
!1 = !DIFile(filename: "/workspace/examples/fft_strided/fft_prj/solution/.autopilot/db/fft.pp.0.cpp", directory: "/workspace/examples/fft_strided")
!2 = !{}
!3 = !{!4, !11, !12, !13, !46, !49, !75, !103, !130, !157, !10, !184, !211, !238, !268, !292, !298, !326, !327}
!4 = !DIDerivedType(tag: DW_TAG_typedef, name: "u32", file: !5, line: 8, baseType: !6)
!5 = !DIFile(filename: "fft.cpp", directory: "/workspace/examples/fft_strided")
!6 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint32_t", file: !7, line: 26, baseType: !8)
!7 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/stdint-uintn.h", directory: "/workspace/examples/fft_strided")
!8 = !DIDerivedType(tag: DW_TAG_typedef, name: "__uint32_t", file: !9, line: 42, baseType: !10)
!9 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/types.h", directory: "/workspace/examples/fft_strided")
!10 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!11 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!12 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!13 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<64, true>", file: !14, line: 108, size: 64, flags: DIFlagTypePassByValue, elements: !15, templateParams: !44, identifier: "_ZTS11ap_int_baseILi64ELb1EE")
!14 = !DIFile(filename: "/local/ecad/xilinx/new/Vitis_HLS/2023.1/common/technology/autopilot/etc/ap_int_base.h", directory: "/workspace/examples/fft_strided")
!15 = !{!16, !33, !35, !37}
!16 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !13, baseType: !17)
!17 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<64, true>", file: !18, line: 511, size: 64, flags: DIFlagTypePassByValue, elements: !19, templateParams: !29, identifier: "_ZTS8ssdm_intILi64ELb1EE")
!18 = !DIFile(filename: "/local/ecad/xilinx/new/Vitis_HLS/2023.1/common/technology/autopilot/etc/ap_common.h", directory: "/workspace/examples/fft_strided")
!19 = !{!20, !22, !26}
!20 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !17, file: !18, line: 513, baseType: !21, size: 64)
!21 = !DIBasicType(name: "long int", size: 64, encoding: DW_ATE_signed)
!22 = !DISubprogram(name: "ssdm_int", scope: !17, file: !18, line: 514, type: !23, isLocal: false, isDefinition: false, scopeLine: 514, flags: DIFlagPrototyped, isOptimized: false)
!23 = !DISubroutineType(types: !24)
!24 = !{null, !25}
!25 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !17, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!26 = !DISubprogram(name: "ssdm_int", scope: !17, file: !18, line: 515, type: !27, isLocal: false, isDefinition: false, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false)
!27 = !DISubroutineType(types: !28)
!28 = !{null, !25, !21}
!29 = !{!30, !31}
!30 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 64)
!31 = !DITemplateValueParameter(name: "_AP_S", type: !32, value: i8 1)
!32 = !DIBasicType(name: "bool", size: 8, encoding: DW_ATE_boolean)
!33 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !13, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 64)
!34 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !11)
!35 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !13, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 true)
!36 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !32)
!37 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi64ELb1EEaSERKS0_", scope: !13, file: !14, line: 467, type: !38, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!44 = !{!45, !31}
!45 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 64)
!46 = !DIDerivedType(tag: DW_TAG_typedef, name: "ap_ulong", file: !47, line: 188, baseType: !48)
!47 = !DIFile(filename: "/local/ecad/xilinx/new/Vitis_HLS/2023.1/common/technology/autopilot/etc/ap_decl.h", directory: "/workspace/examples/fft_strided")
!48 = !DIBasicType(name: "long long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!49 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<32, true>", file: !14, line: 108, size: 32, flags: DIFlagTypePassByValue, elements: !50, templateParams: !73, identifier: "_ZTS11ap_int_baseILi32ELb1EE")
!50 = !{!51, !64, !65, !66}
!51 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !49, baseType: !52)
!52 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<32, true>", file: !18, line: 511, size: 32, flags: DIFlagTypePassByValue, elements: !53, templateParams: !62, identifier: "_ZTS8ssdm_intILi32ELb1EE")
!53 = !{!54, !55, !59}
!54 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !52, file: !18, line: 513, baseType: !11, size: 32)
!55 = !DISubprogram(name: "ssdm_int", scope: !52, file: !18, line: 514, type: !56, isLocal: false, isDefinition: false, scopeLine: 514, flags: DIFlagPrototyped, isOptimized: false)
!56 = !DISubroutineType(types: !57)
!57 = !{null, !58}
!58 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !52, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!59 = !DISubprogram(name: "ssdm_int", scope: !52, file: !18, line: 515, type: !60, isLocal: false, isDefinition: false, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false)
!60 = !DISubroutineType(types: !61)
!61 = !{null, !58, !11}
!62 = !{!63, !31}
!63 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 32)
!64 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !49, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 32)
!65 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !49, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 true)
!66 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi32ELb1EEaSERKS0_", scope: !49, file: !14, line: 467, type: !67, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!73 = !{!74, !31}
!74 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 32)
!75 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<9, false>", file: !14, line: 108, size: 16, flags: DIFlagTypePassByValue, elements: !76, templateParams: !101, identifier: "_ZTS11ap_int_baseILi9ELb0EE")
!76 = !{!77, !92, !93, !94}
!77 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !75, baseType: !78)
!78 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<9, false>", file: !18, line: 519, size: 16, flags: DIFlagTypePassByValue, elements: !79, templateParams: !89, identifier: "_ZTS8ssdm_intILi9ELb0EE")
!79 = !{!80, !82, !86}
!80 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !78, file: !18, line: 521, baseType: !81, size: 9, align: 16)
!81 = !DIBasicType(name: "uint9", size: 9, encoding: DW_ATE_unsigned)
!82 = !DISubprogram(name: "ssdm_int", scope: !78, file: !18, line: 522, type: !83, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!83 = !DISubroutineType(types: !84)
!84 = !{null, !85}
!85 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !78, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!86 = !DISubprogram(name: "ssdm_int", scope: !78, file: !18, line: 523, type: !87, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!87 = !DISubroutineType(types: !88)
!88 = !{null, !85, !81}
!89 = !{!90, !91}
!90 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 9)
!91 = !DITemplateValueParameter(name: "_AP_S", type: !32, value: i8 0)
!92 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !75, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 9)
!93 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !75, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 false)
!94 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi9ELb0EEaSERKS0_", scope: !75, file: !14, line: 467, type: !95, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!101 = !{!102, !91}
!102 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 9)
!103 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<11, false>", file: !14, line: 108, size: 16, flags: DIFlagTypePassByValue, elements: !104, templateParams: !128, identifier: "_ZTS11ap_int_baseILi11ELb0EE")
!104 = !{!105, !119, !120, !121}
!105 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !103, baseType: !106)
!106 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<11, false>", file: !18, line: 519, size: 16, flags: DIFlagTypePassByValue, elements: !107, templateParams: !117, identifier: "_ZTS8ssdm_intILi11ELb0EE")
!107 = !{!108, !110, !114}
!108 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !106, file: !18, line: 521, baseType: !109, size: 11, align: 16)
!109 = !DIBasicType(name: "uint11", size: 11, encoding: DW_ATE_unsigned)
!110 = !DISubprogram(name: "ssdm_int", scope: !106, file: !18, line: 522, type: !111, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!111 = !DISubroutineType(types: !112)
!112 = !{null, !113}
!113 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !106, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!114 = !DISubprogram(name: "ssdm_int", scope: !106, file: !18, line: 523, type: !115, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!115 = !DISubroutineType(types: !116)
!116 = !{null, !113, !109}
!117 = !{!118, !91}
!118 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 11)
!119 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !103, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 11)
!120 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !103, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 false)
!121 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi11ELb0EEaSERKS0_", scope: !103, file: !14, line: 467, type: !122, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!128 = !{!129, !91}
!129 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 11)
!130 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<34, true>", file: !14, line: 108, size: 64, flags: DIFlagTypePassByValue, elements: !131, templateParams: !155, identifier: "_ZTS11ap_int_baseILi34ELb1EE")
!131 = !{!132, !146, !147, !148}
!132 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !130, baseType: !133)
!133 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<34, true>", file: !18, line: 511, size: 64, flags: DIFlagTypePassByValue, elements: !134, templateParams: !144, identifier: "_ZTS8ssdm_intILi34ELb1EE")
!134 = !{!135, !137, !141}
!135 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !133, file: !18, line: 513, baseType: !136, size: 34, align: 64)
!136 = !DIBasicType(name: "int34", size: 34, encoding: DW_ATE_signed)
!137 = !DISubprogram(name: "ssdm_int", scope: !133, file: !18, line: 514, type: !138, isLocal: false, isDefinition: false, scopeLine: 514, flags: DIFlagPrototyped, isOptimized: false)
!138 = !DISubroutineType(types: !139)
!139 = !{null, !140}
!140 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !133, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!141 = !DISubprogram(name: "ssdm_int", scope: !133, file: !18, line: 515, type: !142, isLocal: false, isDefinition: false, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false)
!142 = !DISubroutineType(types: !143)
!143 = !{null, !140, !136}
!144 = !{!145, !31}
!145 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 34)
!146 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !130, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 34)
!147 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !130, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 true)
!148 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi34ELb1EEaSERKS0_", scope: !130, file: !14, line: 467, type: !149, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!155 = !{!156, !31}
!156 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 34)
!157 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<1, false>", file: !14, line: 108, size: 8, flags: DIFlagTypePassByValue, elements: !158, templateParams: !182, identifier: "_ZTS11ap_int_baseILi1ELb0EE")
!158 = !{!159, !173, !174, !175}
!159 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !157, baseType: !160)
!160 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<1, false>", file: !18, line: 519, size: 8, flags: DIFlagTypePassByValue, elements: !161, templateParams: !171, identifier: "_ZTS8ssdm_intILi1ELb0EE")
!161 = !{!162, !164, !168}
!162 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !160, file: !18, line: 521, baseType: !163, size: 1, align: 8)
!163 = !DIBasicType(name: "uint1", size: 1, encoding: DW_ATE_unsigned)
!164 = !DISubprogram(name: "ssdm_int", scope: !160, file: !18, line: 522, type: !165, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!165 = !DISubroutineType(types: !166)
!166 = !{null, !167}
!167 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !160, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!168 = !DISubprogram(name: "ssdm_int", scope: !160, file: !18, line: 523, type: !169, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!169 = !DISubroutineType(types: !170)
!170 = !{null, !167, !163}
!171 = !{!172, !91}
!172 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 1)
!173 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !157, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 1)
!174 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !157, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 false)
!175 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi1ELb0EEaSERKS0_", scope: !157, file: !14, line: 467, type: !176, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!182 = !{!183, !91}
!183 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 1)
!184 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<65, true>", file: !14, line: 108, size: 128, flags: DIFlagTypePassByValue, elements: !185, templateParams: !209, identifier: "_ZTS11ap_int_baseILi65ELb1EE")
!185 = !{!186, !200, !201, !202}
!186 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !184, baseType: !187)
!187 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<65, true>", file: !18, line: 511, size: 128, flags: DIFlagTypePassByValue, elements: !188, templateParams: !198, identifier: "_ZTS8ssdm_intILi65ELb1EE")
!188 = !{!189, !191, !195}
!189 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !187, file: !18, line: 513, baseType: !190, size: 65, align: 128)
!190 = !DIBasicType(name: "int65", size: 65, encoding: DW_ATE_signed)
!191 = !DISubprogram(name: "ssdm_int", scope: !187, file: !18, line: 514, type: !192, isLocal: false, isDefinition: false, scopeLine: 514, flags: DIFlagPrototyped, isOptimized: false)
!192 = !DISubroutineType(types: !193)
!193 = !{null, !194}
!194 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !187, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!195 = !DISubprogram(name: "ssdm_int", scope: !187, file: !18, line: 515, type: !196, isLocal: false, isDefinition: false, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false)
!196 = !DISubroutineType(types: !197)
!197 = !{null, !194, !190}
!198 = !{!199, !31}
!199 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 65)
!200 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !184, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 65)
!201 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !184, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 true)
!202 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi65ELb1EEaSERKS0_", scope: !184, file: !14, line: 467, type: !203, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!209 = !{!210, !31}
!210 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 65)
!211 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<33, true>", file: !14, line: 108, size: 64, flags: DIFlagTypePassByValue, elements: !212, templateParams: !236, identifier: "_ZTS11ap_int_baseILi33ELb1EE")
!212 = !{!213, !227, !228, !229}
!213 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !211, baseType: !214)
!214 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<33, true>", file: !18, line: 511, size: 64, flags: DIFlagTypePassByValue, elements: !215, templateParams: !225, identifier: "_ZTS8ssdm_intILi33ELb1EE")
!215 = !{!216, !218, !222}
!216 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !214, file: !18, line: 513, baseType: !217, size: 33, align: 64)
!217 = !DIBasicType(name: "int33", size: 33, encoding: DW_ATE_signed)
!218 = !DISubprogram(name: "ssdm_int", scope: !214, file: !18, line: 514, type: !219, isLocal: false, isDefinition: false, scopeLine: 514, flags: DIFlagPrototyped, isOptimized: false)
!219 = !DISubroutineType(types: !220)
!220 = !{null, !221}
!221 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !214, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!222 = !DISubprogram(name: "ssdm_int", scope: !214, file: !18, line: 515, type: !223, isLocal: false, isDefinition: false, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false)
!223 = !DISubroutineType(types: !224)
!224 = !{null, !221, !217}
!225 = !{!226, !31}
!226 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 33)
!227 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !211, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 33)
!228 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !211, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 true)
!229 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi33ELb1EEaSERKS0_", scope: !211, file: !14, line: 467, type: !230, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!236 = !{!237, !31}
!237 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 33)
!238 = !DIDerivedType(tag: DW_TAG_typedef, name: "RetType", scope: !239, file: !14, line: 128, baseType: !264)
!239 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<64, false>", file: !14, line: 108, size: 64, flags: DIFlagTypePassByValue, elements: !240, templateParams: !263, identifier: "_ZTS11ap_int_baseILi64ELb0EE")
!240 = !{!241, !254, !255, !256}
!241 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !239, baseType: !242)
!242 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<64, false>", file: !18, line: 519, size: 64, flags: DIFlagTypePassByValue, elements: !243, templateParams: !253, identifier: "_ZTS8ssdm_intILi64ELb0EE")
!243 = !{!244, !246, !250}
!244 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !242, file: !18, line: 521, baseType: !245, size: 64)
!245 = !DIBasicType(name: "long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!246 = !DISubprogram(name: "ssdm_int", scope: !242, file: !18, line: 522, type: !247, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!247 = !DISubroutineType(types: !248)
!248 = !{null, !249}
!249 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !242, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!250 = !DISubprogram(name: "ssdm_int", scope: !242, file: !18, line: 523, type: !251, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!251 = !DISubroutineType(types: !252)
!252 = !{null, !249, !245}
!253 = !{!30, !91}
!254 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !239, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 64)
!255 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !239, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 false)
!256 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi64ELb0EEaSERKS0_", scope: !239, file: !14, line: 467, type: !257, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!263 = !{!45, !91}
!264 = !DIDerivedType(tag: DW_TAG_typedef, name: "Type", scope: !265, file: !14, line: 51, baseType: !46)
!265 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "retval<8, false>", file: !14, line: 50, size: 8, flags: DIFlagTypePassByValue, elements: !2, templateParams: !266, identifier: "_ZTS6retvalILi8ELb0EE")
!266 = !{!267, !91}
!267 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 8)
!268 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<32, false>", file: !14, line: 108, size: 32, flags: DIFlagTypePassByValue, elements: !269, templateParams: !291, identifier: "_ZTS11ap_int_baseILi32ELb0EE")
!269 = !{!270, !282, !283, !284}
!270 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !268, baseType: !271)
!271 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<32, false>", file: !18, line: 519, size: 32, flags: DIFlagTypePassByValue, elements: !272, templateParams: !281, identifier: "_ZTS8ssdm_intILi32ELb0EE")
!272 = !{!273, !274, !278}
!273 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !271, file: !18, line: 521, baseType: !10, size: 32)
!274 = !DISubprogram(name: "ssdm_int", scope: !271, file: !18, line: 522, type: !275, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!275 = !DISubroutineType(types: !276)
!276 = !{null, !277}
!277 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !271, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!278 = !DISubprogram(name: "ssdm_int", scope: !271, file: !18, line: 523, type: !279, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!279 = !DISubroutineType(types: !280)
!280 = !{null, !277, !10}
!281 = !{!63, !91}
!282 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !268, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 32)
!283 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !268, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 false)
!284 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi32ELb0EEaSERKS0_", scope: !268, file: !14, line: 467, type: !285, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!291 = !{!74, !91}
!292 = !DIDerivedType(tag: DW_TAG_typedef, name: "RetType", scope: !49, file: !14, line: 128, baseType: !293)
!293 = !DIDerivedType(tag: DW_TAG_typedef, name: "Type", scope: !294, file: !14, line: 46, baseType: !296)
!294 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "retval<8, true>", file: !14, line: 45, size: 8, flags: DIFlagTypePassByValue, elements: !2, templateParams: !295, identifier: "_ZTS6retvalILi8ELb1EE")
!295 = !{!267, !31}
...
!298 = !DIDerivedType(tag: DW_TAG_typedef, name: "RetType", scope: !299, file: !14, line: 128, baseType: !264)
!299 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<6, false>", file: !14, line: 108, size: 8, flags: DIFlagTypePassByValue, elements: !300, templateParams: !324, identifier: "_ZTS11ap_int_baseILi6ELb0EE")
!300 = !{!301, !315, !316, !317}
!301 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !299, baseType: !302)
!302 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<6, false>", file: !18, line: 519, size: 8, flags: DIFlagTypePassByValue, elements: !303, templateParams: !313, identifier: "_ZTS8ssdm_intILi6ELb0EE")
!303 = !{!304, !306, !310}
!304 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !302, file: !18, line: 521, baseType: !305, size: 6, align: 8)
!305 = !DIBasicType(name: "uint6", size: 6, encoding: DW_ATE_unsigned)
!306 = !DISubprogram(name: "ssdm_int", scope: !302, file: !18, line: 522, type: !307, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!307 = !DISubroutineType(types: !308)
!308 = !{null, !309}
!309 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !302, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!310 = !DISubprogram(name: "ssdm_int", scope: !302, file: !18, line: 523, type: !311, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!311 = !DISubroutineType(types: !312)
!312 = !{null, !309, !305}
!313 = !{!314, !91}
!314 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 6)
!315 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !299, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 6)
!316 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !299, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 false)
!317 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi6ELb0EEaSERKS0_", scope: !299, file: !14, line: 467, type: !318, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!324 = !{!325, !91}
!325 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 6)
!326 = !DIDerivedType(tag: DW_TAG_typedef, name: "RetType", scope: !130, file: !14, line: 128, baseType: !293)
!327 = !DIDerivedType(tag: DW_TAG_typedef, name: "RetType", scope: !184, file: !14, line: 128, baseType: !328)
!328 = !DIDerivedType(tag: DW_TAG_typedef, name: "Type", scope: !329, file: !14, line: 46, baseType: !296)
!329 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "retval<9, true>", file: !14, line: 45, size: 8, flags: DIFlagTypePassByValue, elements: !2, templateParams: !330, identifier: "_ZTS6retvalILi9ELb1EE")
!330 = !{!90, !31}
!331 = !{!"clang version 7.0.0 "}
!332 = !{i32 2, !"Dwarf Version", i32 4}
!333 = !{i32 2, !"Debug Info Version", i32 3}
!334 = !{i32 1, !"wchar_size", i32 4}
!335 = distinct !DISubprogram(name: "decode", linkageName: "_Z6decode7ap_uintILi32EES0_S0_S0_", scope: !5, file: !5, line: 25, type: !336, isLocal: false, isDefinition: true, scopeLine: 26, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
...
!340 = !{!341, !342, !343, !344}
!341 = !DIDerivedType(tag: DW_TAG_member, name: "base", scope: !339, file: !5, line: 12, baseType: !11, size: 32)
!342 = !DIDerivedType(tag: DW_TAG_member, name: "top", scope: !339, file: !5, line: 13, baseType: !11, size: 32, offset: 32)
...
!346 = !DIFile(filename: "/local/ecad/xilinx/new/Vitis_HLS/2023.1/common/technology/autopilot/ap_int.h", directory: "/workspace/examples/fft_strided")
...
!360 = !{null, !352, !361}
!361 = !DIDerivedType(tag: DW_TAG_typedef, name: "half", file: !18, line: 613, baseType: !362)
...
!372 = !DILocation(line: 27, column: 9, scope: !335)
!373 = !DILocalVariable(name: "buffer_0", arg: 1, scope: !335, file: !5, line: 25, type: !345)
!374 = !DILocation(line: 25, column: 24, scope: !335)
!375 = !DILocalVariable(name: "buffer_1", arg: 2, scope: !335, file: !5, line: 25, type: !345)
!376 = !DILocation(line: 25, column: 46, scope: !335)
!377 = !DILocalVariable(name: "buffer_2", arg: 3, scope: !335, file: !5, line: 25, type: !345)
!378 = !DILocation(line: 25, column: 68, scope: !335)
!379 = !DILocalVariable(name: "buffer_3", arg: 4, scope: !335, file: !5, line: 26, type: !345)
!380 = !DILocation(line: 26, column: 24, scope: !335)
!381 = !DILocation(line: 29, column: 2, scope: !335)
!382 = !DILocalVariable(name: "cap", scope: !335, file: !5, line: 29, type: !383)
...
!402 = !{!45}
!403 = !DILocation(line: 29, column: 14, scope: !335)
!404 = !DILocation(line: 29, column: 20, scope: !335)
!405 = !DILocation(line: 29, column: 21, scope: !335)
!406 = !DILocation(line: 29, column: 31, scope: !335)
!407 = !DILocation(line: 29, column: 29, scope: !335)
!408 = !DILocation(line: 30, column: 3, scope: !335)
!409 = !DILocalVariable(name: "addr", scope: !335, file: !5, line: 30, type: !383)
!410 = !DILocation(line: 30, column: 15, scope: !335)
!411 = !DILocation(line: 30, column: 22, scope: !335)
!412 = !DILocation(line: 30, column: 23, scope: !335)
!413 = !DILocation(line: 30, column: 33, scope: !335)
!414 = !DILocation(line: 30, column: 31, scope: !335)
!415 = !DILocation(line: 32, column: 3, scope: !335)
!416 = !DILocation(line: 32, column: 7, scope: !335)
!417 = !DILocation(line: 33, column: 15, scope: !335)
!418 = !DILocation(line: 33, column: 19, scope: !335)
!419 = !DILocalVariable(name: "read", scope: !335, file: !5, line: 33, type: !32)
!420 = !DILocation(line: 33, column: 8, scope: !335)
!421 = !DILocation(line: 34, column: 16, scope: !335)
!422 = !DILocation(line: 34, column: 20, scope: !335)
!423 = !DILocalVariable(name: "write", scope: !335, file: !5, line: 34, type: !32)
!424 = !DILocation(line: 34, column: 8, scope: !335)
!425 = !DILocation(line: 37, column: 13, scope: !335)
!426 = !DILocation(line: 37, column: 17, scope: !335)
!427 = !DILocation(line: 37, column: 31, scope: !335)
!428 = !DILocation(line: 37, column: 12, scope: !335)
!429 = !DILocalVariable(name: "f", scope: !335, file: !5, line: 37, type: !32)
!430 = !DILocation(line: 37, column: 8, scope: !335)
!431 = !DILocation(line: 40, column: 8, scope: !335)
!432 = !DILocation(line: 40, column: 12, scope: !335)
!433 = !DILocation(line: 40, column: 26, scope: !335)
!434 = !DILocation(line: 40, column: 7, scope: !335)
!435 = !DILocalVariable(name: "I_E", scope: !335, file: !5, line: 39, type: !32)
!436 = !DILocation(line: 39, column: 8, scope: !335)
!437 = !DILocation(line: 41, column: 3, scope: !335)
!438 = !DILocalVariable(name: "T_11_3", scope: !335, file: !5, line: 41, type: !439)
...
!458 = !{!102}
!459 = !DILocation(line: 41, column: 14, scope: !335)
!460 = !DILocation(line: 42, column: 7, scope: !335)
!461 = !DILocation(line: 42, column: 11, scope: !335)
!462 = !DILocation(line: 43, column: 3, scope: !335)
!463 = !DILocalVariable(name: "T_E", scope: !335, file: !5, line: 43, type: !464)
...
!467 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<3, false>", file: !14, line: 108, size: 8, flags: DIFlagTypePassByValue, elements: !468, templateParams: !492, identifier: "_ZTS11ap_int_baseILi3ELb0EE")
!468 = !{!469, !483, !484, !485}
!469 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !467, baseType: !470)
!470 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<3, false>", file: !18, line: 519, size: 8, flags: DIFlagTypePassByValue, elements: !471, templateParams: !481, identifier: "_ZTS8ssdm_intILi3ELb0EE")
!471 = !{!472, !474, !478}
!472 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !470, file: !18, line: 521, baseType: !473, size: 3, align: 8)
!473 = !DIBasicType(name: "uint3", size: 3, encoding: DW_ATE_unsigned)
!474 = !DISubprogram(name: "ssdm_int", scope: !470, file: !18, line: 522, type: !475, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!475 = !DISubroutineType(types: !476)
!476 = !{null, !477}
!477 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !470, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!478 = !DISubprogram(name: "ssdm_int", scope: !470, file: !18, line: 523, type: !479, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!479 = !DISubroutineType(types: !480)
!480 = !{null, !477, !473}
!481 = !{!482, !91}
!482 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 3)
!483 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !467, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 3)
!484 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !467, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 false)
!485 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi3ELb0EEaSERKS0_", scope: !467, file: !14, line: 467, type: !486, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!492 = !{!493, !91}
!493 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 3)
...
!510 = !{!493}
!511 = !DILocation(line: 43, column: 14, scope: !335)
!512 = !DILocation(line: 44, column: 7, scope: !335)
!513 = !DILocation(line: 44, column: 11, scope: !335)
!514 = !DILocation(line: 45, column: 3, scope: !335)
!515 = !DILocalVariable(name: "B_13_3", scope: !335, file: !5, line: 45, type: !516)
...
!535 = !{!129}
!536 = !DILocation(line: 45, column: 15, scope: !335)
!537 = !DILocation(line: 45, column: 24, scope: !335)
!538 = !DILocation(line: 45, column: 28, scope: !335)
!539 = !DILocation(line: 47, column: 3, scope: !335)
!540 = !DILocalVariable(name: "B_E", scope: !335, file: !5, line: 47, type: !464)
!541 = !DILocation(line: 47, column: 14, scope: !335)
!542 = !DILocation(line: 47, column: 20, scope: !335)
!543 = !DILocation(line: 47, column: 24, scope: !335)
!544 = !DILocation(line: 48, column: 3, scope: !335)
!545 = !DILocalVariable(name: "E", scope: !335, file: !5, line: 48, type: !546)
...
!565 = !{!325}
!566 = !DILocation(line: 48, column: 14, scope: !335)
!567 = !DILocation(line: 48, column: 18, scope: !335)
!568 = !DILocation(line: 49, column: 3, scope: !335)
!569 = !DILocalVariable(name: "T_13_0", scope: !335, file: !5, line: 49, type: !570)
...
!573 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<14, false>", file: !14, line: 108, size: 16, flags: DIFlagTypePassByValue, elements: !574, templateParams: !598, identifier: "_ZTS11ap_int_baseILi14ELb0EE")
!574 = !{!575, !589, !590, !591}
!575 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !573, baseType: !576)
!576 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<14, false>", file: !18, line: 519, size: 16, flags: DIFlagTypePassByValue, elements: !577, templateParams: !587, identifier: "_ZTS8ssdm_intILi14ELb0EE")
!577 = !{!578, !580, !584}
!578 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !576, file: !18, line: 521, baseType: !579, size: 14, align: 16)
!579 = !DIBasicType(name: "uint14", size: 14, encoding: DW_ATE_unsigned)
!580 = !DISubprogram(name: "ssdm_int", scope: !576, file: !18, line: 522, type: !581, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!581 = !DISubroutineType(types: !582)
!582 = !{null, !583}
!583 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !576, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!584 = !DISubprogram(name: "ssdm_int", scope: !576, file: !18, line: 523, type: !585, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!585 = !DISubroutineType(types: !586)
!586 = !{null, !583, !579}
!587 = !{!588, !91}
!588 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 14)
!589 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !573, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 14)
!590 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !573, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 false)
!591 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi14ELb0EEaSERKS0_", scope: !573, file: !14, line: 467, type: !592, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!598 = !{!599, !91}
!599 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 14)
...
!616 = !{!599}
!617 = !DILocation(line: 49, column: 15, scope: !335)
!618 = !DILocation(line: 49, column: 24, scope: !335)
!619 = !DILocation(line: 50, column: 3, scope: !335)
!620 = !DILocalVariable(name: "B_13_0", scope: !335, file: !5, line: 50, type: !570)
!621 = !DILocation(line: 50, column: 15, scope: !335)
!622 = !DILocation(line: 50, column: 24, scope: !335)
!623 = !DILocalVariable(name: "L_carry_out", scope: !335, file: !5, line: 51, type: !32)
!624 = !DILocation(line: 51, column: 8, scope: !335)
!625 = !DILocation(line: 53, column: 7, scope: !335)
!626 = !DILocation(line: 54, column: 9, scope: !627)
!627 = distinct !DILexicalBlock(scope: !628, file: !5, line: 53, column: 13)
!628 = distinct !DILexicalBlock(scope: !335, file: !5, line: 53, column: 7)
!629 = !DILocation(line: 54, column: 7, scope: !627)
!630 = !DILocation(line: 54, column: 5, scope: !627)
!631 = !DILocation(line: 55, column: 14, scope: !627)
!632 = !DILocation(line: 55, column: 15, scope: !627)
!633 = !DILocation(line: 55, column: 23, scope: !627)
!634 = !DILocation(line: 55, column: 21, scope: !627)
!635 = !DILocation(line: 55, column: 12, scope: !627)
!636 = !DILocation(line: 55, column: 5, scope: !627)
!637 = !DILocation(line: 56, column: 14, scope: !627)
!638 = !DILocation(line: 56, column: 15, scope: !627)
!639 = !DILocation(line: 56, column: 23, scope: !627)
!640 = !DILocation(line: 56, column: 21, scope: !627)
!641 = !DILocation(line: 56, column: 12, scope: !627)
!642 = !DILocation(line: 56, column: 5, scope: !627)
!643 = !DILocation(line: 57, column: 5, scope: !627)
!644 = !DILocalVariable(name: "T_11_0", scope: !627, file: !5, line: 57, type: !645)
...
!648 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<12, false>", file: !14, line: 108, size: 16, flags: DIFlagTypePassByValue, elements: !649, templateParams: !673, identifier: "_ZTS11ap_int_baseILi12ELb0EE")
!649 = !{!650, !664, !665, !666}
!650 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !648, baseType: !651)
!651 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<12, false>", file: !18, line: 519, size: 16, flags: DIFlagTypePassByValue, elements: !652, templateParams: !662, identifier: "_ZTS8ssdm_intILi12ELb0EE")
!652 = !{!653, !655, !659}
!653 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !651, file: !18, line: 521, baseType: !654, size: 12, align: 16)
!654 = !DIBasicType(name: "uint12", size: 12, encoding: DW_ATE_unsigned)
!655 = !DISubprogram(name: "ssdm_int", scope: !651, file: !18, line: 522, type: !656, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!656 = !DISubroutineType(types: !657)
!657 = !{null, !658}
!658 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !651, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!659 = !DISubprogram(name: "ssdm_int", scope: !651, file: !18, line: 523, type: !660, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!660 = !DISubroutineType(types: !661)
!661 = !{null, !658, !654}
!662 = !{!663, !91}
!663 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 12)
!664 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !648, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 12)
!665 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !648, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 false)
!666 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi12ELb0EEaSERKS0_", scope: !648, file: !14, line: 467, type: !667, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!673 = !{!674, !91}
!674 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 12)
...
!691 = !{!674}
!692 = !DILocation(line: 57, column: 17, scope: !627)
!693 = !DILocation(line: 57, column: 26, scope: !627)
!694 = !DILocation(line: 57, column: 33, scope: !627)
!695 = !DILocation(line: 58, column: 5, scope: !627)
!696 = !DILocalVariable(name: "B_11_0", scope: !627, file: !5, line: 58, type: !645)
!697 = !DILocation(line: 58, column: 17, scope: !627)
!698 = !DILocation(line: 58, column: 26, scope: !627)
!699 = !DILocation(line: 58, column: 33, scope: !627)
!700 = !DILocation(line: 59, column: 20, scope: !627)
!701 = !DILocation(line: 59, column: 29, scope: !627)
!702 = !DILocation(line: 59, column: 27, scope: !627)
!703 = !DILocation(line: 60, column: 3, scope: !628)
!704 = !DILocation(line: 60, column: 3, scope: !627)
!705 = !DILocation(line: 61, column: 9, scope: !706)
!706 = distinct !DILexicalBlock(scope: !628, file: !5, line: 60, column: 10)
!707 = !DILocation(line: 61, column: 10, scope: !706)
!708 = !DILocation(line: 61, column: 15, scope: !706)
!709 = !DILocation(line: 61, column: 13, scope: !706)
!710 = !DILocation(line: 61, column: 7, scope: !706)
!711 = !DILocation(line: 61, column: 5, scope: !706)
!712 = !DILocation(line: 62, column: 14, scope: !706)
!713 = !DILocation(line: 62, column: 15, scope: !706)
!714 = !DILocation(line: 62, column: 22, scope: !706)
!715 = !DILocation(line: 62, column: 12, scope: !706)
!716 = !DILocation(line: 62, column: 5, scope: !706)
!717 = !DILocation(line: 63, column: 14, scope: !706)
!718 = !DILocation(line: 63, column: 15, scope: !706)
!719 = !DILocation(line: 63, column: 22, scope: !706)
!720 = !DILocation(line: 63, column: 12, scope: !706)
!721 = !DILocation(line: 63, column: 5, scope: !706)
!722 = !DILocation(line: 64, column: 5, scope: !706)
!723 = !DILocalVariable(name: "T_11_3_only", scope: !706, file: !5, line: 64, type: !645)
!724 = !DILocation(line: 64, column: 17, scope: !706)
!725 = !DILocation(line: 64, column: 31, scope: !706)
!726 = !DILocation(line: 64, column: 38, scope: !706)
!727 = !DILocation(line: 65, column: 5, scope: !706)
!728 = !DILocalVariable(name: "B_11_3_only", scope: !706, file: !5, line: 65, type: !645)
!729 = !DILocation(line: 65, column: 17, scope: !706)
!730 = !DILocation(line: 65, column: 31, scope: !706)
!731 = !DILocation(line: 65, column: 38, scope: !706)
!732 = !DILocation(line: 66, column: 20, scope: !706)
!733 = !DILocation(line: 66, column: 34, scope: !706)
!734 = !DILocation(line: 66, column: 32, scope: !706)
!735 = !DILocation(line: 67, column: 3, scope: !628)
!736 = !DILocation(line: 68, column: 3, scope: !335)
!737 = !DILocalVariable(name: "B_13_12", scope: !335, file: !5, line: 68, type: !738)
...
!741 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<2, false>", file: !14, line: 108, size: 8, flags: DIFlagTypePassByValue, elements: !742, templateParams: !766, identifier: "_ZTS11ap_int_baseILi2ELb0EE")
!742 = !{!743, !757, !758, !759}
!743 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !741, baseType: !744)
!744 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<2, false>", file: !18, line: 519, size: 8, flags: DIFlagTypePassByValue, elements: !745, templateParams: !755, identifier: "_ZTS8ssdm_intILi2ELb0EE")
!745 = !{!746, !748, !752}
!746 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !744, file: !18, line: 521, baseType: !747, size: 2, align: 8)
!747 = !DIBasicType(name: "uint2", size: 2, encoding: DW_ATE_unsigned)
!748 = !DISubprogram(name: "ssdm_int", scope: !744, file: !18, line: 522, type: !749, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!749 = !DISubroutineType(types: !750)
!750 = !{null, !751}
!751 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !744, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!752 = !DISubprogram(name: "ssdm_int", scope: !744, file: !18, line: 523, type: !753, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!753 = !DISubroutineType(types: !754)
!754 = !{null, !751, !747}
!755 = !{!756, !91}
!756 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 2)
!757 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !741, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 2)
!758 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !741, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 false)
!759 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi2ELb0EEaSERKS0_", scope: !741, file: !14, line: 467, type: !760, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!766 = !{!767, !91}
!767 = !DITemplateValueParameter(name: "_AP_W", type: !11, value: i32 2)
...
!784 = !{!767}
!785 = !DILocation(line: 68, column: 14, scope: !335)
!786 = !DILocation(line: 68, column: 24, scope: !335)
!787 = !DILocation(line: 68, column: 31, scope: !335)
!788 = !DILocation(line: 69, column: 3, scope: !335)
!789 = !DILocalVariable(name: "T_13_12", scope: !335, file: !5, line: 69, type: !738)
!790 = !DILocation(line: 69, column: 14, scope: !335)
!791 = !DILocation(line: 69, column: 24, scope: !335)
!792 = !DILocation(line: 69, column: 35, scope: !335)
!793 = !DILocation(line: 69, column: 32, scope: !335)
!794 = !DILocation(line: 69, column: 59, scope: !335)
!795 = !DILocation(line: 69, column: 56, scope: !335)
!796 = !DILocation(line: 70, column: 3, scope: !335)
!797 = !DILocation(line: 70, column: 11, scope: !335)
!798 = !DILocation(line: 72, column: 3, scope: !335)
!799 = !DILocation(line: 72, column: 10, scope: !335)
!800 = !DILocation(line: 73, column: 12, scope: !335)
!801 = !DILocation(line: 73, column: 13, scope: !335)
!802 = !DILocation(line: 73, column: 22, scope: !335)
!803 = !DILocation(line: 73, column: 29, scope: !335)
!804 = !DILocation(line: 73, column: 20, scope: !335)
!805 = !DILocation(line: 73, column: 10, scope: !335)
!806 = !DILocation(line: 73, column: 3, scope: !335)
!807 = !DILocation(line: 75, column: 3, scope: !335)
!808 = !DILocalVariable(name: "A3", scope: !335, file: !5, line: 75, type: !464)
!809 = !DILocation(line: 75, column: 14, scope: !335)
!810 = !DILocation(line: 75, column: 19, scope: !335)
!811 = !DILocation(line: 75, column: 20, scope: !335)
!812 = !DILocation(line: 75, column: 21, scope: !335)
!813 = !DILocation(line: 75, column: 29, scope: !335)
!814 = !DILocation(line: 75, column: 30, scope: !335)
!815 = !DILocation(line: 75, column: 32, scope: !335)
!816 = !DILocation(line: 75, column: 26, scope: !335)
!817 = !DILocation(line: 75, column: 39, scope: !335)
!818 = !DILocation(line: 76, column: 3, scope: !335)
!819 = !DILocalVariable(name: "T3", scope: !335, file: !5, line: 76, type: !464)
!820 = !DILocation(line: 76, column: 14, scope: !335)
!821 = !DILocation(line: 76, column: 19, scope: !335)
!822 = !DILocation(line: 76, column: 26, scope: !335)
!823 = !DILocation(line: 77, column: 3, scope: !335)
!824 = !DILocalVariable(name: "B3", scope: !335, file: !5, line: 77, type: !464)
!825 = !DILocation(line: 77, column: 14, scope: !335)
!826 = !DILocation(line: 77, column: 19, scope: !335)
!827 = !DILocation(line: 77, column: 26, scope: !335)
!828 = !DILocation(line: 78, column: 3, scope: !335)
!829 = !DILocalVariable(name: "R", scope: !335, file: !5, line: 78, type: !464)
!830 = !DILocation(line: 78, column: 14, scope: !335)
!831 = !DILocation(line: 78, column: 18, scope: !335)
!832 = !DILocation(line: 78, column: 21, scope: !335)
!833 = !DILocation(line: 80, column: 3, scope: !335)
!834 = !DILocalVariable(name: "c_t", scope: !335, file: !5, line: 80, type: !835)
...
!838 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<2, true>", file: !14, line: 108, size: 8, flags: DIFlagTypePassByValue, elements: !839, templateParams: !862, identifier: "_ZTS11ap_int_baseILi2ELb1EE")
!839 = !{!840, !853, !854, !855}
!840 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !838, baseType: !841)
!841 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<2, true>", file: !18, line: 511, size: 8, flags: DIFlagTypePassByValue, elements: !842, templateParams: !852, identifier: "_ZTS8ssdm_intILi2ELb1EE")
!842 = !{!843, !845, !849}
!843 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !841, file: !18, line: 513, baseType: !844, size: 2, align: 8)
!844 = !DIBasicType(name: "int2", size: 2, encoding: DW_ATE_signed)
!845 = !DISubprogram(name: "ssdm_int", scope: !841, file: !18, line: 514, type: !846, isLocal: false, isDefinition: false, scopeLine: 514, flags: DIFlagPrototyped, isOptimized: false)
!846 = !DISubroutineType(types: !847)
!847 = !{null, !848}
!848 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !841, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!849 = !DISubprogram(name: "ssdm_int", scope: !841, file: !18, line: 515, type: !850, isLocal: false, isDefinition: false, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false)
!850 = !DISubroutineType(types: !851)
!851 = !{null, !848, !844}
!852 = !{!756, !31}
!853 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !838, file: !14, line: 130, baseType: !34, flags: DIFlagStaticMember, extraData: i32 2)
!854 = !DIDerivedType(tag: DW_TAG_member, name: "sign_flag", scope: !838, file: !14, line: 131, baseType: !36, flags: DIFlagStaticMember, extraData: i1 true)
!855 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi2ELb1EEaSERKS0_", scope: !838, file: !14, line: 467, type: !856, isLocal: false, isDefinition: false, scopeLine: 467, flags: DIFlagPrototyped, isOptimized: false)
...
!879 = !DILocation(line: 80, column: 13, scope: !335)
!880 = !DILocation(line: 80, column: 19, scope: !335)
!881 = !DILocation(line: 81, column: 3, scope: !335)
!882 = !DILocalVariable(name: "c_b", scope: !335, file: !5, line: 81, type: !835)
!883 = !DILocation(line: 81, column: 13, scope: !335)
!884 = !DILocation(line: 81, column: 19, scope: !335)
!885 = !DILocation(line: 83, column: 8, scope: !886)
!886 = distinct !DILexicalBlock(scope: !335, file: !5, line: 83, column: 7)
!887 = !DILocation(line: 83, column: 13, scope: !886)
!888 = !DILocation(line: 83, column: 11, scope: !886)
!889 = !DILocation(line: 83, column: 16, scope: !886)
!890 = !DILocation(line: 83, column: 21, scope: !886)
!891 = !DILocation(line: 83, column: 26, scope: !886)
!892 = !DILocation(line: 83, column: 24, scope: !886)
!893 = !DILocation(line: 83, column: 7, scope: !335)
!894 = !DILocation(line: 84, column: 11, scope: !895)
!895 = distinct !DILexicalBlock(scope: !886, file: !5, line: 83, column: 30)
!896 = !DILocation(line: 84, column: 9, scope: !895)
!897 = !DILocation(line: 84, column: 5, scope: !895)
!898 = !DILocation(line: 85, column: 3, scope: !895)
!899 = !DILocation(line: 85, column: 16, scope: !900)
!900 = distinct !DILexicalBlock(scope: !886, file: !5, line: 85, column: 14)
!901 = !DILocation(line: 85, column: 21, scope: !900)
!902 = !DILocation(line: 85, column: 19, scope: !900)
!903 = !DILocation(line: 85, column: 24, scope: !900)
!904 = !DILocation(line: 85, column: 28, scope: !900)
!905 = !DILocation(line: 85, column: 33, scope: !900)
!906 = !DILocation(line: 85, column: 31, scope: !900)
!907 = !DILocation(line: 85, column: 14, scope: !886)
!908 = !DILocation(line: 86, column: 11, scope: !909)
!909 = distinct !DILexicalBlock(scope: !900, file: !5, line: 85, column: 37)
!910 = !DILocation(line: 86, column: 9, scope: !909)
!911 = !DILocation(line: 86, column: 5, scope: !909)
!912 = !DILocation(line: 87, column: 3, scope: !909)
!913 = !DILocation(line: 88, column: 8, scope: !914)
!914 = distinct !DILexicalBlock(scope: !335, file: !5, line: 88, column: 7)
!915 = !DILocation(line: 88, column: 13, scope: !914)
!916 = !DILocation(line: 88, column: 11, scope: !914)
!917 = !DILocation(line: 88, column: 16, scope: !914)
!918 = !DILocation(line: 88, column: 21, scope: !914)
!919 = !DILocation(line: 88, column: 26, scope: !914)
!920 = !DILocation(line: 88, column: 24, scope: !914)
!921 = !DILocation(line: 88, column: 7, scope: !335)
!922 = !DILocation(line: 89, column: 11, scope: !923)
!923 = distinct !DILexicalBlock(scope: !914, file: !5, line: 88, column: 30)
!924 = !DILocation(line: 89, column: 9, scope: !923)
!925 = !DILocation(line: 89, column: 5, scope: !923)
!926 = !DILocation(line: 90, column: 3, scope: !923)
!927 = !DILocation(line: 90, column: 16, scope: !928)
!928 = distinct !DILexicalBlock(scope: !914, file: !5, line: 90, column: 14)
!929 = !DILocation(line: 90, column: 21, scope: !928)
!930 = !DILocation(line: 90, column: 19, scope: !928)
!931 = !DILocation(line: 90, column: 24, scope: !928)
!932 = !DILocation(line: 90, column: 28, scope: !928)
!933 = !DILocation(line: 90, column: 33, scope: !928)
!934 = !DILocation(line: 90, column: 31, scope: !928)
!935 = !DILocation(line: 90, column: 14, scope: !914)
!936 = !DILocation(line: 91, column: 11, scope: !937)
!937 = distinct !DILexicalBlock(scope: !928, file: !5, line: 90, column: 37)
!938 = !DILocation(line: 91, column: 9, scope: !937)
!939 = !DILocation(line: 91, column: 5, scope: !937)
!940 = !DILocation(line: 92, column: 3, scope: !937)
!941 = !DILocation(line: 93, column: 15, scope: !335)
!942 = !DILocation(line: 93, column: 23, scope: !335)
!943 = !DILocation(line: 93, column: 24, scope: !335)
!944 = !DILocation(line: 93, column: 26, scope: !335)
!945 = !DILocation(line: 93, column: 20, scope: !335)
!946 = !DILocalVariable(name: "a_top", scope: !335, file: !5, line: 93, type: !4)
!947 = !DILocation(line: 93, column: 7, scope: !335)
!948 = !DILocation(line: 94, column: 13, scope: !335)
!949 = !DILocation(line: 94, column: 23, scope: !335)
!950 = !DILocation(line: 94, column: 21, scope: !335)
!951 = !DILocation(line: 94, column: 14, scope: !335)
!952 = !DILocation(line: 94, column: 31, scope: !335)
!953 = !DILocation(line: 94, column: 32, scope: !335)
!954 = !DILocation(line: 94, column: 34, scope: !335)
!955 = !DILocation(line: 94, column: 28, scope: !335)
!956 = !DILocation(line: 94, column: 50, scope: !335)
!957 = !DILocation(line: 94, column: 57, scope: !335)
!958 = !DILocation(line: 94, column: 49, scope: !335)
!959 = !DILocation(line: 94, column: 70, scope: !335)
!960 = !DILocation(line: 94, column: 67, scope: !335)
!961 = !DILocation(line: 94, column: 41, scope: !335)
!962 = !DILocalVariable(name: "top", scope: !335, file: !5, line: 94, type: !4)
!963 = !DILocation(line: 94, column: 7, scope: !335)
!964 = !DILocation(line: 95, column: 14, scope: !335)
!965 = !DILocation(line: 95, column: 24, scope: !335)
!966 = !DILocation(line: 95, column: 22, scope: !335)
!967 = !DILocation(line: 95, column: 15, scope: !335)
!968 = !DILocation(line: 95, column: 32, scope: !335)
!969 = !DILocation(line: 95, column: 33, scope: !335)
!970 = !DILocation(line: 95, column: 35, scope: !335)
!971 = !DILocation(line: 95, column: 29, scope: !335)
!972 = !DILocation(line: 95, column: 51, scope: !335)
!973 = !DILocation(line: 95, column: 58, scope: !335)
!974 = !DILocation(line: 95, column: 50, scope: !335)
!975 = !DILocation(line: 95, column: 71, scope: !335)
!976 = !DILocation(line: 95, column: 68, scope: !335)
!977 = !DILocation(line: 95, column: 42, scope: !335)
!978 = !DILocalVariable(name: "base", scope: !335, file: !5, line: 95, type: !4)
!979 = !DILocation(line: 95, column: 7, scope: !335)
!980 = !DILocalVariable(name: "c", scope: !335, file: !5, line: 97, type: !338)
!981 = !DILocation(line: 97, column: 7, scope: !335)
!982 = !DILocation(line: 99, column: 19, scope: !335)
!983 = !DILocation(line: 99, column: 17, scope: !335)
!984 = !DILocation(line: 99, column: 12, scope: !335)
!985 = !DILocation(line: 99, column: 5, scope: !335)
!986 = !DILocation(line: 99, column: 10, scope: !335)
!987 = !DILocation(line: 100, column: 17, scope: !335)
!988 = !DILocation(line: 100, column: 15, scope: !335)
!989 = !DILocation(line: 100, column: 11, scope: !335)
!990 = !DILocation(line: 100, column: 5, scope: !335)
!991 = !DILocation(line: 100, column: 9, scope: !335)
!992 = !DILocation(line: 101, column: 5, scope: !335)
!993 = !DILocation(line: 101, column: 10, scope: !335)
!994 = !DILocation(line: 102, column: 5, scope: !335)
!995 = !DILocation(line: 102, column: 11, scope: !335)
!996 = !DILocation(line: 104, column: 1, scope: !335)
!997 = !{!998}
!998 = !{!"fpga.inline", !"user", null}
!999 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi65ELb1EEC2EDq65_i", scope: !187, file: !18, line: 515, type: !196, isLocal: false, isDefinition: true, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !195, variables: !2)
!1000 = !{!1001}
...
!1006 = !DILocalVariable(name: "o", arg: 2, scope: !999, file: !18, line: 515, type: !190)
...
!1010 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi32ELb0EEC2Ej", scope: !271, file: !18, line: 523, type: !279, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !278, variables: !2)
!1011 = !{!1012}
...
!1017 = !DILocalVariable(name: "o", arg: 2, scope: !1010, file: !18, line: 523, type: !10)
...
!1021 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi34ELb1EEC2EDq34_i", scope: !133, file: !18, line: 515, type: !142, isLocal: false, isDefinition: true, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !141, variables: !2)
!1022 = !{!1023}
...
!1028 = !DILocalVariable(name: "o", arg: 2, scope: !1021, file: !18, line: 515, type: !136)
...
!1032 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi32ELb1EEC2Ei", scope: !52, file: !18, line: 515, type: !60, isLocal: false, isDefinition: true, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !59, variables: !2)
!1033 = !{!1034}
...
!1039 = !DILocalVariable(name: "o", arg: 2, scope: !1032, file: !18, line: 515, type: !11)
...
!1043 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi1ELb0EEC2EDq1_j", scope: !160, file: !18, line: 523, type: !169, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !168, variables: !2)
!1044 = !{!1045}
...
!1050 = !DILocalVariable(name: "o", arg: 2, scope: !1043, file: !18, line: 523, type: !163)
...
!1054 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi33ELb0EEC2EDq33_j", scope: !1055, file: !18, line: 523, type: !1064, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !1063, variables: !2)
!1055 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<33, false>", file: !18, line: 519, size: 64, flags: DIFlagTypePassByValue, elements: !1056, templateParams: !1066, identifier: "_ZTS8ssdm_intILi33ELb0EE")
!1056 = !{!1057, !1059, !1063}
!1057 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !1055, file: !18, line: 521, baseType: !1058, size: 33, align: 64)
!1058 = !DIBasicType(name: "uint33", size: 33, encoding: DW_ATE_unsigned)
!1059 = !DISubprogram(name: "ssdm_int", scope: !1055, file: !18, line: 522, type: !1060, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!1060 = !DISubroutineType(types: !1061)
!1061 = !{null, !1062}
!1062 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1055, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1063 = !DISubprogram(name: "ssdm_int", scope: !1055, file: !18, line: 523, type: !1064, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
...
!1073 = !DILocalVariable(name: "o", arg: 2, scope: !1054, file: !18, line: 523, type: !1058)
...
!1077 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi2ELb1EEC2EDq2_i", scope: !841, file: !18, line: 515, type: !850, isLocal: false, isDefinition: true, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !849, variables: !2)
!1078 = !{!1079}
...
!1084 = !DILocalVariable(name: "o", arg: 2, scope: !1077, file: !18, line: 515, type: !844)
...
!1088 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi3ELb0EEC2EDq3_j", scope: !470, file: !18, line: 523, type: !479, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !478, variables: !2)
!1089 = !{!1090}
...
!1095 = !DILocalVariable(name: "o", arg: 2, scope: !1088, file: !18, line: 523, type: !473)
...
!1099 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi33ELb1EEC2EDq33_i", scope: !214, file: !18, line: 515, type: !223, isLocal: false, isDefinition: true, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !222, variables: !2)
!1100 = !{!1101}
...
!1106 = !DILocalVariable(name: "o", arg: 2, scope: !1099, file: !18, line: 515, type: !217)
...
!1110 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi3ELb0EEC2Ev", scope: !470, file: !18, line: 522, type: !475, isLocal: false, isDefinition: true, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !474, variables: !2)
!1111 = !{!1112}
...
!1117 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi14ELb0EEC2Ev", scope: !576, file: !18, line: 522, type: !581, isLocal: false, isDefinition: true, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !580, variables: !2)
!1118 = !{!1119}
...
!1125 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi64ELb0EEC2Em", scope: !242, file: !18, line: 523, type: !251, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !250, variables: !2)
!1126 = !{!1127}
...
!1132 = !DILocalVariable(name: "o", arg: 2, scope: !1125, file: !18, line: 523, type: !245)
...
!1136 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi16ELb0EEC2Et", scope: !1137, file: !18, line: 523, type: !1146, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !1145, variables: !2)
!1137 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<16, false>", file: !18, line: 519, size: 16, flags: DIFlagTypePassByValue, elements: !1138, templateParams: !1148, identifier: "_ZTS8ssdm_intILi16ELb0EE")
!1138 = !{!1139, !1141, !1145}
!1139 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !1137, file: !18, line: 521, baseType: !1140, size: 16)
!1140 = !DIBasicType(name: "unsigned short", size: 16, encoding: DW_ATE_unsigned)
!1141 = !DISubprogram(name: "ssdm_int", scope: !1137, file: !18, line: 522, type: !1142, isLocal: false, isDefinition: false, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false)
!1142 = !DISubroutineType(types: !1143)
!1143 = !{null, !1144}
!1144 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1137, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1145 = !DISubprogram(name: "ssdm_int", scope: !1137, file: !18, line: 523, type: !1146, isLocal: false, isDefinition: false, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false)
!1146 = !DISubroutineType(types: !1147)
!1147 = !{null, !1144, !1140}
!1148 = !{!1149, !91}
!1149 = !DITemplateValueParameter(name: "_AP_N", type: !11, value: i32 16)
!1150 = !{!1151}
...
!1156 = !DILocalVariable(name: "o", arg: 2, scope: !1136, file: !18, line: 523, type: !1140)
...
!1160 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi2ELb0EEC2EDq2_j", scope: !744, file: !18, line: 523, type: !753, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !752, variables: !2)
!1161 = !{!1162}
...
!1167 = !DILocalVariable(name: "o", arg: 2, scope: !1160, file: !18, line: 523, type: !747)
...
!1171 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi2ELb0EEC2Ev", scope: !744, file: !18, line: 522, type: !749, isLocal: false, isDefinition: true, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !748, variables: !2)
!1172 = !{!1173}
...
!1178 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi14ELb0EEC2EDq14_j", scope: !576, file: !18, line: 523, type: !585, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !584, variables: !2)
!1179 = !{!1180}
...
!1184 = !DILocalVariable(name: "o", arg: 2, scope: !1178, file: !18, line: 523, type: !579)
...
!1188 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi11ELb0EEC2EDq11_j", scope: !106, file: !18, line: 523, type: !115, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !114, variables: !2)
!1189 = !{!1190}
...
!1195 = !DILocalVariable(name: "o", arg: 2, scope: !1188, file: !18, line: 523, type: !109)
...
!1199 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi9ELb0EEC2EDq9_j", scope: !78, file: !18, line: 523, type: !87, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !86, variables: !2)
!1200 = !{!1201}
...
!1206 = !DILocalVariable(name: "o", arg: 2, scope: !1199, file: !18, line: 523, type: !81)
...
!1210 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi6ELb0EEC2Ev", scope: !302, file: !18, line: 522, type: !307, isLocal: false, isDefinition: true, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !306, variables: !2)
!1211 = !{!1212}
...
!1218 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi6ELb0EEC2EDq6_j", scope: !302, file: !18, line: 523, type: !311, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !310, variables: !2)
!1219 = !{!1220}
...
!1224 = !DILocalVariable(name: "o", arg: 2, scope: !1218, file: !18, line: 523, type: !305)
...
!1228 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi12ELb0EEC2Ev", scope: !651, file: !18, line: 522, type: !656, isLocal: false, isDefinition: true, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !655, variables: !2)
!1229 = !{!1230}
...
!1236 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi12ELb0EEC2EDq12_j", scope: !651, file: !18, line: 523, type: !660, isLocal: false, isDefinition: true, scopeLine: 523, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !659, variables: !2)
!1237 = !{!1238}
...
!1242 = !DILocalVariable(name: "o", arg: 2, scope: !1236, file: !18, line: 523, type: !654)
...
!1246 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi11ELb0EEC2Ev", scope: !106, file: !18, line: 522, type: !111, isLocal: false, isDefinition: true, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !110, variables: !2)
!1247 = !{!1248}
...
!1253 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi64ELb0EEC2Ev", scope: !242, file: !18, line: 522, type: !247, isLocal: false, isDefinition: true, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !246, variables: !2)
!1254 = !{!1255}
...
!1260 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi9ELb0EEC2Ev", scope: !78, file: !18, line: 522, type: !83, isLocal: false, isDefinition: true, scopeLine: 522, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !82, variables: !2)
!1261 = !{!1262}
...
!1267 = distinct !DISubprogram(name: "ssdm_int", linkageName: "_ZN8ssdm_intILi64ELb1EEC2El", scope: !17, file: !18, line: 515, type: !27, isLocal: false, isDefinition: true, scopeLine: 515, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !26, variables: !2)
!1268 = !{!1269}
...
!1272 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !17, size: 64)
!1273 = !DILocation(line: 0, scope: !1267)
!1274 = !DILocalVariable(name: "o", arg: 2, scope: !1267, file: !18, line: 515, type: !21)
...
!1278 = distinct !DISubprogram(name: "load_cap", linkageName: "_Z8load_capiPjS_P3Cap", scope: !5, file: !5, line: 106, type: !1279, isLocal: false, isDefinition: true, scopeLine: 106, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!1279 = !DISubroutineType(types: !1280)
!1280 = !{null, !11, !1281, !1281, !1282}
...
!1285 = !DILocation(line: 107, column: 9, scope: !1278)
!1286 = !DILocalVariable(name: "num", arg: 1, scope: !1278, file: !5, line: 106, type: !11)
!1287 = !DILocation(line: 106, column: 19, scope: !1278)
!1288 = !DILocalVariable(name: "buffer", arg: 2, scope: !1278, file: !5, line: 106, type: !1281)
!1289 = !DILocation(line: 106, column: 29, scope: !1278)
!1290 = !DILocalVariable(name: "cap", arg: 3, scope: !1278, file: !5, line: 106, type: !1281)
!1291 = !DILocation(line: 106, column: 42, scope: !1278)
!1292 = !DILocalVariable(name: "caps", arg: 4, scope: !1278, file: !5, line: 106, type: !1282)
!1293 = !DILocation(line: 106, column: 52, scope: !1278)
!1294 = !DILocation(line: 106, column: 58, scope: !1278)
!1295 = !DILocalVariable(name: "i", scope: !1296, file: !5, line: 109, type: !11)
!1296 = distinct !DILexicalBlock(scope: !1278, file: !5, line: 109, column: 20)
!1297 = !DILocation(line: 109, column: 29, scope: !1296)
!1298 = !DILocation(line: 109, column: 25, scope: !1296)
!1299 = !DILocation(line: 109, column: 44, scope: !1300)
!1300 = distinct !DILexicalBlock(scope: !1296, file: !5, line: 109, column: 20)
!1301 = !DILocation(line: 109, column: 38, scope: !1300)
!1302 = !DILocation(line: 109, column: 20, scope: !1296)
!1303 = !DILocation(line: 111, column: 14, scope: !1304)
!1304 = distinct !DILexicalBlock(scope: !1300, file: !5, line: 110, column: 1)
!1305 = !DILocation(line: 111, column: 2, scope: !1304)
!1306 = !DILocation(line: 111, column: 12, scope: !1304)
!1307 = !DILocation(line: 111, column: 19, scope: !1304)
!1308 = !DILocation(line: 109, column: 50, scope: !1300)
!1309 = !DILocation(line: 109, column: 20, scope: !1300)
!1310 = distinct !{!1310, !1302, !1311, !1312, !1314}
!1311 = !DILocation(line: 111, column: 19, scope: !1296)
!1312 = !{!"llvm.loop.pipeline.enable", i32 -1, i1 false, i8 -1, !"user", !1313}
!1313 = !DILocation(line: 110, column: 9, scope: !1296)
!1314 = !{!"llvm.loop.name", !"VITIS_LOOP_109_1"}
!1315 = !DILocalVariable(name: "i", scope: !1278, file: !5, line: 113, type: !11)
!1316 = !DILocation(line: 113, column: 7, scope: !1278)
!1317 = !DILocation(line: 113, column: 3, scope: !1278)
!1318 = !DILocalVariable(name: "j", scope: !1319, file: !5, line: 114, type: !11)
!1319 = distinct !DILexicalBlock(scope: !1278, file: !5, line: 114, column: 21)
!1320 = !DILocation(line: 114, column: 30, scope: !1319)
!1321 = !DILocation(line: 114, column: 26, scope: !1319)
!1322 = !DILocation(line: 114, column: 39, scope: !1323)
!1323 = distinct !DILexicalBlock(scope: !1319, file: !5, line: 114, column: 21)
!1324 = !DILocation(line: 114, column: 21, scope: !1319)
!1325 = !DILocation(line: 115, column: 15, scope: !1326)
!1326 = distinct !DILexicalBlock(scope: !1323, file: !5, line: 114, column: 51)
!1327 = !DILocation(line: 115, column: 22, scope: !1326)
!1328 = !DILocation(line: 115, column: 42, scope: !1326)
!1329 = !DILocation(line: 115, column: 33, scope: !1326)
!1330 = !DILocation(line: 115, column: 57, scope: !1326)
!1331 = !DILocation(line: 115, column: 48, scope: !1326)
!1332 = !DILocation(line: 115, column: 72, scope: !1326)
!1333 = !DILocation(line: 115, column: 63, scope: !1326)
!1334 = !DILocation(line: 115, column: 5, scope: !1326)
!1335 = !DILocation(line: 115, column: 13, scope: !1326)
!1336 = !DILocation(line: 116, column: 7, scope: !1326)
!1337 = !DILocation(line: 117, column: 3, scope: !1326)
!1338 = !DILocation(line: 114, column: 47, scope: !1323)
!1339 = !DILocation(line: 114, column: 21, scope: !1323)
!1340 = distinct !{!1340, !1324, !1341, !1342}
!1341 = !DILocation(line: 117, column: 3, scope: !1319)
!1342 = !{!"llvm.loop.name", !"VITIS_LOOP_114_2"}
!1343 = !DILocation(line: 118, column: 1, scope: !1278)
!1344 = distinct !DISubprogram(name: "checkAccess", linkageName: "_Z11checkAccessPj3Capt7ap_uintILi3EEb", scope: !5, file: !5, line: 131, type: !1345, isLocal: false, isDefinition: true, scopeLine: 132, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!1345 = !DISubroutineType(types: !1346)
!1346 = !{null, !1281, !338, !1347, !464, !32}
!1347 = !DIDerivedType(tag: DW_TAG_typedef, name: "u16", file: !5, line: 7, baseType: !1348)
...
!1352 = !DILocation(line: 133, column: 9, scope: !1344)
!1353 = !DILocalVariable(name: "flag_buf", arg: 1, scope: !1344, file: !5, line: 131, type: !1281)
!1354 = !DILocation(line: 131, column: 23, scope: !1344)
!1355 = !DILocalVariable(name: "cap", arg: 2, scope: !1344, file: !5, line: 131, type: !338)
!1356 = !DILocation(line: 131, column: 37, scope: !1344)
!1357 = !DILocalVariable(name: "offset", arg: 3, scope: !1344, file: !5, line: 131, type: !1347)
!1358 = !DILocation(line: 131, column: 46, scope: !1344)
!1359 = !DILocalVariable(name: "nBytes", arg: 4, scope: !1344, file: !5, line: 131, type: !464)
!1360 = !DILocation(line: 131, column: 65, scope: !1344)
!1361 = !DILocalVariable(name: "isWrite", arg: 5, scope: !1344, file: !5, line: 132, type: !32)
!1362 = !DILocation(line: 132, column: 23, scope: !1344)
!1363 = !DILocation(line: 135, column: 14, scope: !1344)
!1364 = !DILocation(line: 135, column: 27, scope: !1344)
!1365 = !DILocation(line: 135, column: 25, scope: !1344)
!1366 = !DILocation(line: 135, column: 19, scope: !1344)
!1367 = !DILocation(line: 135, column: 36, scope: !1344)
!1368 = !DILocation(line: 135, column: 40, scope: !1344)
!1369 = !DILocation(line: 135, column: 45, scope: !1344)
!1370 = !DILocation(line: 135, column: 43, scope: !1344)
!1371 = !DILocation(line: 135, column: 54, scope: !1344)
!1372 = !DILocation(line: 135, column: 52, scope: !1344)
!1373 = !DILocation(line: 135, column: 69, scope: !1344)
!1374 = !DILocation(line: 135, column: 62, scope: !1344)
!1375 = !DILocation(line: 135, column: 74, scope: !1344)
!1376 = !DILocation(line: 136, column: 19, scope: !1344)
!1377 = !DILocation(line: 136, column: 27, scope: !1344)
!1378 = !DILocation(line: 136, column: 35, scope: !1344)
!1379 = !DILocation(line: 136, column: 47, scope: !1344)
!1380 = !DILocation(line: 136, column: 55, scope: !1344)
!1381 = !DILocation(line: 135, column: 7, scope: !1344)
!1382 = !DILocation(line: 134, column: 12, scope: !1344)
!1383 = !DILocation(line: 134, column: 2, scope: !1344)
!1384 = !DILocation(line: 137, column: 1, scope: !1344)
!1385 = distinct !DISubprogram(name: "cheri_load", linkageName: "_Z10cheri_loadPiiPj3Cap", scope: !5, file: !5, line: 139, type: !1386, isLocal: false, isDefinition: true, scopeLine: 139, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!1386 = !DISubroutineType(types: !1387)
!1387 = !{!11, !1388, !11, !1281, !338}
!1388 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !11, size: 64)
!1389 = !{!1390}
!1390 = !{!"fpga.inline", !"user", !1391}
!1391 = !DILocation(line: 140, column: 9, scope: !1385)
!1392 = !DILocalVariable(name: "buf", arg: 1, scope: !1385, file: !5, line: 139, type: !1388)
!1393 = !DILocation(line: 139, column: 21, scope: !1385)
!1394 = !DILocalVariable(name: "i", arg: 2, scope: !1385, file: !5, line: 139, type: !11)
!1395 = !DILocation(line: 139, column: 30, scope: !1385)
!1396 = !DILocalVariable(name: "flag_buf", arg: 3, scope: !1385, file: !5, line: 139, type: !1281)
!1397 = !DILocation(line: 139, column: 38, scope: !1385)
!1398 = !DILocalVariable(name: "cap", arg: 4, scope: !1385, file: !5, line: 139, type: !338)
!1399 = !DILocation(line: 139, column: 52, scope: !1385)
!1400 = !DILocation(line: 141, column: 24, scope: !1385)
!1401 = !DILocation(line: 141, column: 29, scope: !1385)
!1402 = !DILocation(line: 141, column: 32, scope: !1385)
!1403 = !DILocation(line: 141, column: 2, scope: !1385)
!1404 = !DILocation(line: 142, column: 11, scope: !1385)
!1405 = !DILocalVariable(name: "b", scope: !1385, file: !5, line: 142, type: !11)
!1406 = !DILocation(line: 142, column: 7, scope: !1385)
!1407 = !DILocation(line: 143, column: 11, scope: !1385)
!1408 = !DILocation(line: 143, column: 10, scope: !1385)
!1409 = !DILocation(line: 143, column: 3, scope: !1385)
!1410 = distinct !DISubprogram(name: "cheri_store", linkageName: "_Z11cheri_storePiiiPj3Cap", scope: !5, file: !5, line: 146, type: !1411, isLocal: false, isDefinition: true, scopeLine: 146, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!1411 = !DISubroutineType(types: !1412)
!1412 = !{null, !1388, !11, !11, !1281, !338}
!1413 = !{!1414}
!1414 = !{!"fpga.inline", !"user", !1415}
!1415 = !DILocation(line: 147, column: 9, scope: !1410)
!1416 = !DILocalVariable(name: "buf", arg: 1, scope: !1410, file: !5, line: 146, type: !1388)
!1417 = !DILocation(line: 146, column: 23, scope: !1410)
!1418 = !DILocalVariable(name: "i", arg: 2, scope: !1410, file: !5, line: 146, type: !11)
!1419 = !DILocation(line: 146, column: 32, scope: !1410)
!1420 = !DILocalVariable(name: "val", arg: 3, scope: !1410, file: !5, line: 146, type: !11)
!1421 = !DILocation(line: 146, column: 39, scope: !1410)
!1422 = !DILocalVariable(name: "flag_buf", arg: 4, scope: !1410, file: !5, line: 146, type: !1281)
!1423 = !DILocation(line: 146, column: 49, scope: !1410)
!1424 = !DILocalVariable(name: "cap", arg: 5, scope: !1410, file: !5, line: 146, type: !338)
!1425 = !DILocation(line: 146, column: 63, scope: !1410)
!1426 = !DILocation(line: 148, column: 24, scope: !1410)
!1427 = !DILocation(line: 148, column: 29, scope: !1410)
!1428 = !DILocation(line: 148, column: 32, scope: !1410)
!1429 = !DILocation(line: 148, column: 2, scope: !1410)
!1430 = !DILocation(line: 150, column: 13, scope: !1410)
!1431 = !DILocation(line: 150, column: 12, scope: !1410)
!1432 = !DILocation(line: 150, column: 32, scope: !1410)
!1433 = !DILocation(line: 150, column: 3, scope: !1410)
!1434 = !DILocation(line: 150, column: 10, scope: !1410)
!1435 = !DILocation(line: 151, column: 3, scope: !1410)
!1436 = distinct !DISubprogram(name: "hls_top", linkageName: "_Z7hls_topiPiS_S_S_S_S_PjS0_", scope: !5, file: !5, line: 154, type: !1437, isLocal: false, isDefinition: true, scopeLine: 156, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!1437 = !DISubroutineType(types: !1438)
!1438 = !{null, !11, !1388, !1388, !1388, !1388, !1388, !1388, !1281, !1281}
!1439 = !{!1440}
!1440 = !{!"fpga.top", !"user", !1441}
!1441 = !DILocation(line: 154, column: 16, scope: !1436)
!1442 = !DILocalVariable(name: "size", arg: 1, scope: !1436, file: !5, line: 154, type: !11)
!1443 = !DILocation(line: 154, column: 60, scope: !1436)
!1444 = !DILocalVariable(name: "xreal", arg: 2, scope: !1436, file: !5, line: 154, type: !1388)
!1445 = !DILocation(line: 154, column: 70, scope: !1436)
!1446 = !DILocalVariable(name: "ximg", arg: 3, scope: !1436, file: !5, line: 154, type: !1388)
!1447 = !DILocation(line: 154, column: 87, scope: !1436)
!1448 = !DILocalVariable(name: "xreal_twid", arg: 4, scope: !1436, file: !5, line: 155, type: !1388)
!1449 = !DILocation(line: 155, column: 18, scope: !1436)
!1450 = !DILocalVariable(name: "ximg_twid", arg: 5, scope: !1436, file: !5, line: 155, type: !1388)
!1451 = !DILocation(line: 155, column: 44, scope: !1436)
!1452 = !DILocalVariable(name: "yreal", arg: 6, scope: !1436, file: !5, line: 156, type: !1388)
!1453 = !DILocation(line: 156, column: 18, scope: !1436)
!1454 = !DILocalVariable(name: "yimg", arg: 7, scope: !1436, file: !5, line: 156, type: !1388)
!1455 = !DILocation(line: 156, column: 35, scope: !1436)
!1456 = !DILocalVariable(name: "flag", arg: 8, scope: !1436, file: !5, line: 156, type: !1281)
!1457 = !DILocation(line: 156, column: 52, scope: !1436)
!1458 = !DILocalVariable(name: "cap", arg: 9, scope: !1436, file: !5, line: 156, type: !1281)
!1459 = !DILocation(line: 156, column: 62, scope: !1436)
!1460 = !DILocation(line: 157, column: 9, scope: !1436)
!1461 = !DILocation(line: 158, column: 9, scope: !1436)
!1462 = !DILocation(line: 159, column: 9, scope: !1436)
!1463 = !DILocation(line: 160, column: 9, scope: !1436)
!1464 = !DILocation(line: 161, column: 9, scope: !1436)
!1465 = !DILocation(line: 162, column: 9, scope: !1436)
!1466 = !DILocation(line: 163, column: 9, scope: !1436)
!1467 = !DILocation(line: 164, column: 9, scope: !1436)
!1468 = !DILocation(line: 165, column: 9, scope: !1436)
!1469 = !DILocation(line: 166, column: 9, scope: !1436)
!1470 = !DILocation(line: 168, column: 2, scope: !1436)
!1471 = !DILocalVariable(name: "flag_buf", scope: !1436, file: !5, line: 168, type: !4)
!1472 = !DILocation(line: 168, column: 6, scope: !1436)
!1473 = !DILocation(line: 169, column: 3, scope: !1436)
!1474 = !DILocalVariable(name: "caps", scope: !1436, file: !5, line: 169, type: !1475)
!1475 = !DICompositeType(tag: DW_TAG_array_type, baseType: !338, size: 576, elements: !1476)
!1476 = !{!1477}
!1477 = !DISubrange(count: 6)
!1478 = !DILocation(line: 169, column: 7, scope: !1436)
!1479 = !DILocation(line: 170, column: 3, scope: !1436)
!1480 = !DILocalVariable(name: "buffer", scope: !1436, file: !5, line: 170, type: !1481)
!1481 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 768, elements: !1482)
!1482 = !{!1483}
!1483 = !DISubrange(count: 24)
!1484 = !DILocation(line: 170, column: 7, scope: !1436)
!1485 = !DILocation(line: 171, column: 9, scope: !1436)
!1486 = !DILocation(line: 172, column: 9, scope: !1436)
!1487 = !DILocation(line: 174, column: 14, scope: !1436)
!1488 = !DILocation(line: 174, column: 27, scope: !1436)
!1489 = !DILocation(line: 174, column: 2, scope: !1436)
!1490 = !DILocalVariable(name: "log", scope: !1436, file: !5, line: 175, type: !11)
!1491 = !DILocation(line: 175, column: 24, scope: !1436)
!1492 = !DILocation(line: 179, column: 3, scope: !1436)
!1493 = !DILocalVariable(name: "real", scope: !1436, file: !5, line: 179, type: !1494)
!1494 = !DICompositeType(tag: DW_TAG_array_type, baseType: !11, size: 32768, elements: !1495)
!1495 = !{!1496}
!1496 = !DISubrange(count: 1024)
!1497 = !DILocation(line: 179, column: 7, scope: !1436)
!1498 = !DILocation(line: 180, column: 3, scope: !1436)
!1499 = !DILocalVariable(name: "img", scope: !1436, file: !5, line: 180, type: !1494)
!1500 = !DILocation(line: 180, column: 7, scope: !1436)
!1501 = !DILocation(line: 181, column: 3, scope: !1436)
!1502 = !DILocalVariable(name: "real_twid", scope: !1436, file: !5, line: 181, type: !1503)
!1503 = !DICompositeType(tag: DW_TAG_array_type, baseType: !11, size: 16384, elements: !1504)
!1504 = !{!1505}
!1505 = !DISubrange(count: 512)
!1506 = !DILocation(line: 181, column: 7, scope: !1436)
!1507 = !DILocation(line: 182, column: 3, scope: !1436)
!1508 = !DILocalVariable(name: "img_twid", scope: !1436, file: !5, line: 182, type: !1503)
!1509 = !DILocation(line: 182, column: 7, scope: !1436)
!1510 = !DILocalVariable(name: "i", scope: !1511, file: !5, line: 188, type: !11)
!1511 = distinct !DILexicalBlock(scope: !1436, file: !5, line: 188, column: 21)
!1512 = !DILocation(line: 188, column: 30, scope: !1511)
!1513 = !DILocation(line: 188, column: 26, scope: !1511)
!1514 = !DILocation(line: 188, column: 39, scope: !1515)
!1515 = distinct !DILexicalBlock(scope: !1511, file: !5, line: 188, column: 21)
!1516 = !DILocation(line: 188, column: 21, scope: !1511)
!1517 = !DILocation(line: 189, column: 54, scope: !1518)
!1518 = distinct !DILexicalBlock(scope: !1515, file: !5, line: 188, column: 52)
!1519 = !DILocation(line: 189, column: 22, scope: !1518)
!1520 = !DILocalVariable(name: "xreal_elem", scope: !1518, file: !5, line: 189, type: !11)
!1521 = !DILocation(line: 189, column: 9, scope: !1518)
!1522 = !DILocation(line: 190, column: 5, scope: !1518)
!1523 = !DILocation(line: 190, column: 13, scope: !1518)
!1524 = !DILocation(line: 191, column: 3, scope: !1518)
!1525 = !DILocation(line: 188, column: 48, scope: !1515)
!1526 = !DILocation(line: 188, column: 21, scope: !1515)
!1527 = distinct !{!1527, !1516, !1528, !1529}
!1528 = !DILocation(line: 191, column: 3, scope: !1511)
!1529 = !{!"llvm.loop.name", !"VITIS_LOOP_188_1"}
!1530 = !DILocalVariable(name: "i", scope: !1531, file: !5, line: 192, type: !11)
!1531 = distinct !DILexicalBlock(scope: !1436, file: !5, line: 192, column: 21)
!1532 = !DILocation(line: 192, column: 30, scope: !1531)
!1533 = !DILocation(line: 192, column: 26, scope: !1531)
!1534 = !DILocation(line: 192, column: 39, scope: !1535)
!1535 = distinct !DILexicalBlock(scope: !1531, file: !5, line: 192, column: 21)
!1536 = !DILocation(line: 192, column: 21, scope: !1531)
!1537 = !DILocation(line: 193, column: 52, scope: !1538)
!1538 = distinct !DILexicalBlock(scope: !1535, file: !5, line: 192, column: 52)
!1539 = !DILocation(line: 193, column: 21, scope: !1538)
!1540 = !DILocalVariable(name: "ximg_elem", scope: !1538, file: !5, line: 193, type: !11)
!1541 = !DILocation(line: 193, column: 9, scope: !1538)
!1542 = !DILocation(line: 194, column: 5, scope: !1538)
!1543 = !DILocation(line: 194, column: 12, scope: !1538)
!1544 = !DILocation(line: 195, column: 3, scope: !1538)
!1545 = !DILocation(line: 192, column: 48, scope: !1535)
!1546 = !DILocation(line: 192, column: 21, scope: !1535)
!1547 = distinct !{!1547, !1536, !1548, !1549}
!1548 = !DILocation(line: 195, column: 3, scope: !1531)
!1549 = !{!"llvm.loop.name", !"VITIS_LOOP_192_2"}
!1550 = !DILocalVariable(name: "i", scope: !1551, file: !5, line: 196, type: !11)
!1551 = distinct !DILexicalBlock(scope: !1436, file: !5, line: 196, column: 21)
!1552 = !DILocation(line: 196, column: 30, scope: !1551)
!1553 = !DILocation(line: 196, column: 26, scope: !1551)
!1554 = !DILocation(line: 196, column: 46, scope: !1555)
!1555 = distinct !DILexicalBlock(scope: !1551, file: !5, line: 196, column: 21)
!1556 = !DILocation(line: 196, column: 39, scope: !1555)
!1557 = !DILocation(line: 196, column: 21, scope: !1551)
!1558 = !DILocation(line: 197, column: 64, scope: !1559)
!1559 = distinct !DILexicalBlock(scope: !1555, file: !5, line: 196, column: 56)
!1560 = !DILocation(line: 197, column: 27, scope: !1559)
!1561 = !DILocalVariable(name: "xreal_twid_elem", scope: !1559, file: !5, line: 197, type: !11)
!1562 = !DILocation(line: 197, column: 9, scope: !1559)
!1563 = !DILocation(line: 198, column: 5, scope: !1559)
!1564 = !DILocation(line: 198, column: 18, scope: !1559)
!1565 = !DILocation(line: 199, column: 3, scope: !1559)
!1566 = !DILocation(line: 196, column: 52, scope: !1555)
!1567 = !DILocation(line: 196, column: 21, scope: !1555)
!1568 = distinct !{!1568, !1557, !1569, !1570}
!1569 = !DILocation(line: 199, column: 3, scope: !1551)
!1570 = !{!"llvm.loop.name", !"VITIS_LOOP_196_3"}
!1571 = !DILocalVariable(name: "i", scope: !1572, file: !5, line: 200, type: !11)
!1572 = distinct !DILexicalBlock(scope: !1436, file: !5, line: 200, column: 21)
!1573 = !DILocation(line: 200, column: 30, scope: !1572)
!1574 = !DILocation(line: 200, column: 26, scope: !1572)
!1575 = !DILocation(line: 200, column: 46, scope: !1576)
!1576 = distinct !DILexicalBlock(scope: !1572, file: !5, line: 200, column: 21)
!1577 = !DILocation(line: 200, column: 39, scope: !1576)
!1578 = !DILocation(line: 200, column: 21, scope: !1572)
!1579 = !DILocation(line: 201, column: 62, scope: !1580)
!1580 = distinct !DILexicalBlock(scope: !1576, file: !5, line: 200, column: 56)
!1581 = !DILocation(line: 201, column: 26, scope: !1580)
!1582 = !DILocalVariable(name: "ximg_twid_elem", scope: !1580, file: !5, line: 201, type: !11)
!1583 = !DILocation(line: 201, column: 9, scope: !1580)
!1584 = !DILocation(line: 202, column: 5, scope: !1580)
!1585 = !DILocation(line: 202, column: 17, scope: !1580)
!1586 = !DILocation(line: 203, column: 3, scope: !1580)
!1587 = !DILocation(line: 200, column: 52, scope: !1576)
!1588 = !DILocation(line: 200, column: 21, scope: !1576)
!1589 = distinct !{!1589, !1578, !1590, !1591}
!1590 = !DILocation(line: 203, column: 3, scope: !1572)
!1591 = !{!"llvm.loop.name", !"VITIS_LOOP_200_4"}
!1592 = !DILocation(line: 206, column: 20, scope: !1593)
!1593 = distinct !DILexicalBlock(scope: !1436, file: !5, line: 206, column: 3)
!1594 = !DILocalVariable(name: "span", scope: !1436, file: !5, line: 175, type: !11)
!1595 = !DILocation(line: 175, column: 18, scope: !1436)
!1596 = !DILocation(line: 206, column: 8, scope: !1593)
!1597 = !DILocation(line: 206, column: 26, scope: !1598)
!1598 = distinct !DILexicalBlock(scope: !1593, file: !5, line: 206, column: 3)
!1599 = !DILocation(line: 206, column: 3, scope: !1593)
!1600 = !DILocation(line: 206, column: 51, scope: !1598)
!1601 = !DILocalVariable(name: "odd", scope: !1436, file: !5, line: 175, type: !11)
!1602 = !DILocation(line: 175, column: 13, scope: !1436)
!1603 = !DILocation(line: 208, column: 10, scope: !1604)
!1604 = distinct !DILexicalBlock(scope: !1605, file: !5, line: 208, column: 5)
!1605 = distinct !DILexicalBlock(scope: !1598, file: !5, line: 206, column: 51)
!1606 = !DILocation(line: 208, column: 26, scope: !1607)
!1607 = distinct !DILexicalBlock(scope: !1604, file: !5, line: 208, column: 5)
!1608 = !DILocation(line: 208, column: 5, scope: !1604)
!1609 = !DILocation(line: 209, column: 11, scope: !1610)
!1610 = distinct !DILexicalBlock(scope: !1607, file: !5, line: 208, column: 41)
!1611 = !DILocation(line: 210, column: 18, scope: !1610)
!1612 = !DILocalVariable(name: "even", scope: !1436, file: !5, line: 175, type: !11)
!1613 = !DILocation(line: 175, column: 7, scope: !1436)
!1614 = !DILocation(line: 212, column: 14, scope: !1610)
!1615 = !DILocation(line: 212, column: 27, scope: !1610)
!1616 = !DILocation(line: 212, column: 25, scope: !1610)
!1617 = !DILocalVariable(name: "temp", scope: !1436, file: !5, line: 176, type: !11)
!1618 = !DILocation(line: 176, column: 7, scope: !1436)
!1619 = !DILocation(line: 213, column: 19, scope: !1610)
!1620 = !DILocation(line: 213, column: 32, scope: !1610)
!1621 = !DILocation(line: 213, column: 30, scope: !1610)
!1622 = !DILocation(line: 213, column: 7, scope: !1610)
!1623 = !DILocation(line: 213, column: 17, scope: !1610)
!1624 = !DILocation(line: 214, column: 7, scope: !1610)
!1625 = !DILocation(line: 214, column: 18, scope: !1610)
!1626 = !DILocation(line: 216, column: 14, scope: !1610)
!1627 = !DILocation(line: 216, column: 26, scope: !1610)
!1628 = !DILocation(line: 216, column: 24, scope: !1610)
!1629 = !DILocation(line: 217, column: 18, scope: !1610)
!1630 = !DILocation(line: 217, column: 30, scope: !1610)
!1631 = !DILocation(line: 217, column: 28, scope: !1610)
!1632 = !DILocation(line: 217, column: 7, scope: !1610)
!1633 = !DILocation(line: 217, column: 16, scope: !1610)
!1634 = !DILocation(line: 218, column: 7, scope: !1610)
!1635 = !DILocation(line: 218, column: 17, scope: !1610)
!1636 = !DILocation(line: 220, column: 25, scope: !1610)
!1637 = !DILocation(line: 220, column: 41, scope: !1610)
!1638 = !DILocation(line: 220, column: 33, scope: !1610)
!1639 = !DILocalVariable(name: "rootindex", scope: !1436, file: !5, line: 175, type: !11)
!1640 = !DILocation(line: 175, column: 29, scope: !1436)
!1641 = !DILocation(line: 221, column: 11, scope: !1642)
!1642 = distinct !DILexicalBlock(scope: !1610, file: !5, line: 221, column: 11)
!1643 = !DILocation(line: 221, column: 11, scope: !1610)
!1644 = !DILocation(line: 223, column: 13, scope: !1645)
!1645 = distinct !DILexicalBlock(scope: !1642, file: !5, line: 221, column: 22)
!1646 = !DILocation(line: 223, column: 36, scope: !1645)
!1647 = !DILocation(line: 223, column: 34, scope: !1645)
!1648 = !DILocation(line: 223, column: 48, scope: !1645)
!1649 = !DILocation(line: 223, column: 70, scope: !1645)
!1650 = !DILocation(line: 223, column: 68, scope: !1645)
!1651 = !DILocation(line: 223, column: 46, scope: !1645)
!1652 = !DILocation(line: 225, column: 13, scope: !1645)
!1653 = !DILocation(line: 225, column: 36, scope: !1645)
!1654 = !DILocation(line: 225, column: 34, scope: !1645)
!1655 = !DILocation(line: 225, column: 47, scope: !1645)
!1656 = !DILocation(line: 225, column: 69, scope: !1645)
!1657 = !DILocation(line: 225, column: 67, scope: !1645)
!1658 = !DILocation(line: 225, column: 45, scope: !1645)
!1659 = !DILocation(line: 224, column: 9, scope: !1645)
!1660 = !DILocation(line: 224, column: 18, scope: !1645)
!1661 = !DILocation(line: 226, column: 9, scope: !1645)
!1662 = !DILocation(line: 226, column: 19, scope: !1645)
!1663 = !DILocation(line: 227, column: 7, scope: !1645)
!1664 = !DILocation(line: 228, column: 5, scope: !1610)
!1665 = !DILocation(line: 208, column: 37, scope: !1607)
!1666 = !DILocation(line: 208, column: 5, scope: !1607)
!1667 = distinct !{!1667, !1608, !1668, !1669}
!1668 = !DILocation(line: 228, column: 5, scope: !1604)
!1669 = !{!"llvm.loop.name", !"inner"}
!1670 = !DILocation(line: 229, column: 3, scope: !1605)
!1671 = !DILocation(line: 206, column: 37, scope: !1598)
!1672 = !DILocation(line: 206, column: 47, scope: !1598)
!1673 = !DILocation(line: 206, column: 3, scope: !1598)
!1674 = distinct !{!1674, !1599, !1675, !1676}
!1675 = !DILocation(line: 229, column: 3, scope: !1593)
!1676 = !{!"llvm.loop.name", !"outer"}
!1677 = !DILocalVariable(name: "i", scope: !1678, file: !5, line: 230, type: !11)
!1678 = distinct !DILexicalBlock(scope: !1436, file: !5, line: 230, column: 21)
!1679 = !DILocation(line: 230, column: 30, scope: !1678)
!1680 = !DILocation(line: 230, column: 26, scope: !1678)
!1681 = !DILocation(line: 230, column: 39, scope: !1682)
!1682 = distinct !DILexicalBlock(scope: !1678, file: !5, line: 230, column: 21)
!1683 = !DILocation(line: 230, column: 21, scope: !1678)
!1684 = !DILocation(line: 231, column: 21, scope: !1685)
!1685 = distinct !DILexicalBlock(scope: !1682, file: !5, line: 230, column: 52)
!1686 = !DILocalVariable(name: "real_elem", scope: !1685, file: !5, line: 231, type: !11)
!1687 = !DILocation(line: 231, column: 9, scope: !1685)
!1688 = !DILocation(line: 232, column: 49, scope: !1685)
!1689 = !DILocation(line: 232, column: 5, scope: !1685)
!1690 = !DILocation(line: 233, column: 3, scope: !1685)
!1691 = !DILocation(line: 230, column: 48, scope: !1682)
!1692 = !DILocation(line: 230, column: 21, scope: !1682)
!1693 = distinct !{!1693, !1683, !1694, !1695}
!1694 = !DILocation(line: 233, column: 3, scope: !1678)
!1695 = !{!"llvm.loop.name", !"VITIS_LOOP_230_5"}
!1696 = !DILocalVariable(name: "i", scope: !1697, file: !5, line: 234, type: !11)
!1697 = distinct !DILexicalBlock(scope: !1436, file: !5, line: 234, column: 21)
!1698 = !DILocation(line: 234, column: 30, scope: !1697)
!1699 = !DILocation(line: 234, column: 26, scope: !1697)
!1700 = !DILocation(line: 234, column: 39, scope: !1701)
!1701 = distinct !DILexicalBlock(scope: !1697, file: !5, line: 234, column: 21)
!1702 = !DILocation(line: 234, column: 21, scope: !1697)
!1703 = !DILocation(line: 235, column: 20, scope: !1704)
!1704 = distinct !DILexicalBlock(scope: !1701, file: !5, line: 234, column: 52)
!1705 = !DILocalVariable(name: "img_elem", scope: !1704, file: !5, line: 235, type: !11)
!1706 = !DILocation(line: 235, column: 9, scope: !1704)
!1707 = !DILocation(line: 236, column: 47, scope: !1704)
!1708 = !DILocation(line: 236, column: 5, scope: !1704)
!1709 = !DILocation(line: 237, column: 3, scope: !1704)
!1710 = !DILocation(line: 234, column: 48, scope: !1701)
!1711 = !DILocation(line: 234, column: 21, scope: !1701)
!1712 = distinct !{!1712, !1702, !1713, !1714}
!1713 = !DILocation(line: 237, column: 3, scope: !1697)
!1714 = !{!"llvm.loop.name", !"VITIS_LOOP_234_6"}
!1715 = !DILocation(line: 238, column: 1, scope: !1436)
