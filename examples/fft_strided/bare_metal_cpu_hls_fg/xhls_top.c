...
void XHls_top_Set_xreal(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XREAL_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XREAL_DATA + 4, (u32)(Data >> 32));
}
...
u64 XHls_top_Get_xreal(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XREAL_DATA);
...
void XHls_top_Set_ximg(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XIMG_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XIMG_DATA + 4, (u32)(Data >> 32));
}
...
u64 XHls_top_Get_ximg(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XIMG_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
...
void XHls_top_Set_xreal_twid(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XREAL_TWID_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
...
u64 XHls_top_Get_xreal_twid(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XREAL_TWID_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XREAL_TWID_DATA + 4)
          << 32;
  return Data;
...
void XHls_top_Set_ximg_twid(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XIMG_TWID_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
...
u64 XHls_top_Get_ximg_twid(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_XIMG_TWID_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                                XHLS_TOP_CONTROL_ADDR_XIMG_TWID_DATA + 4)
          << 32;
  return Data;
...
void XHls_top_Set_yreal(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_YREAL_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_YREAL_DATA + 4, (u32)(Data >> 32));
}
...
u64 XHls_top_Get_yreal(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_YREAL_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
...
void XHls_top_Set_yimg(XHls_top *InstancePtr, u64 Data) {
  ...
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_YIMG_DATA, (u32)(Data));
  XHls_top_WriteReg(InstancePtr->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_YIMG_DATA + 4, (u32)(Data >> 32));
}
...
u64 XHls_top_Get_yimg(XHls_top *InstancePtr) {
  ...
  Data = XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
                          XHLS_TOP_CONTROL_ADDR_YIMG_DATA);
  Data += (u64)XHls_top_ReadReg(InstancePtr->Control_BaseAddress,
