...
for.end163:                                       ; preds = %for.cond156
  ...
  %decay.29 = getelementptr inbounds [256 x i32], [256 x i32]* %alignedA, i32 0, i32 0, !dbg !101539
  %cap.arrayidx29 = getelementptr inbounds [12 x %struct.Cap], [12 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101539
  %store.29 = load %struct.Cap, %struct.Cap* %cap.arrayidx29, align 4, !dbg !101539
  store %struct.Cap %store.29, %struct.Cap* %agg.tmp2, align 4, !dbg !101539
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 256, i32* %xalignedA, i32* %decay.29, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101539

  %decay.30 = getelementptr inbounds [256 x i32], [256 x i32]* %alignedB, i32 0, i32 0, !dbg !101539
  %cap.arrayidx30 = getelementptr inbounds [12 x %struct.Cap], [12 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101539
  %store.30 = load %struct.Cap, %struct.Cap* %cap.arrayidx30, align 4, !dbg !101539
  store %struct.Cap %store.30, %struct.Cap* %agg.tmp3, align 4, !dbg !101539
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 256, i32* %xalignedB, i32* %decay.30, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539

  %decay.31 = getelementptr inbounds [16641 x i32], [16641 x i32]* %M, i32 0, i32 0, !dbg !101539
  %cap.arrayidx31 = getelementptr inbounds [12 x %struct.Cap], [12 x %struct.Cap]* %caps, i64 0, i64 4, !dbg !101539
  ...
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 16641, i32* %xM, i32* %decay.31, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101539

  %decay.32 = getelementptr inbounds [16641 x i32], [16641 x i32]* %ptr, i32 0, i32 0, !dbg !101539
  %cap.arrayidx32 = getelementptr inbounds [12 x %struct.Cap], [12 x %struct.Cap]* %caps, i64 0, i64 5, !dbg !101539
  %store.32 = load %struct.Cap, %struct.Cap* %cap.arrayidx32, align 4, !dbg !101539
  store %struct.Cap %store.32, %struct.Cap* %agg.tmp5, align 4, !dbg !101539
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 16641, i32* %xptr, i32* %decay.32, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101539
...
attributes #9000 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="1536" "xlx.source"="user" }
attributes #9001 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="0" "xlx.source"="user" }
attributes #9002 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="1152" "xlx.source"="user" }
