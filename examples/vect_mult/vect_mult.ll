...
define void @_Z9vect_multiPiS_S_(i32 %size, i32* "fpga.decayed.dim.hint"="100" %a, i32* "fpga.decayed.dim.hint"="100" %b, i32* "fpga.decayed.dim.hint"="100" %c) #0 !fpga.function.pragma !4 {
entry:
...
attributes #0 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "fpga.demangled.name"="vect_mult" "fpga.top.func"="vect_mult" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #1 = { nofree nosync nounwind readnone speculatable willreturn }
attributes #2 = { inaccessiblememonly nofree nosync nounwind willreturn }
attributes #3 = { argmemonly nofree nosync nounwind willreturn }
attributes #4 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="3200" "xlx.source"="user" }
...
!7 = distinct !DISubprogram(name: "vect_mult", linkageName: "_Z9vect_multiPiS_S_", scope: !8, file: !8, line: 3, type: !9, scopeLine: 3, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !13, retainedNodes: !15)
!8 = !DIFile(filename: "vect_mult.cpp", directory: "/workspace/examples/vect_mult")
...
!14 = !DIFile(filename: "/workspace/examples/vect_mult/vect_mult_prj/solution1/.autopilot/db/vect_mult.pp.0.cpp", directory: "/workspace/examples/vect_mult")
!15 = !{}
!16 = distinct !{!16, !17}
