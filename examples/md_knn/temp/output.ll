...
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="256" %xforce_x, i32* "fpga.decayed.dim.hint"="256" %xforce_y, i32* "fpga.decayed.dim.hint"="256" %xforce_z, i32* "fpga.decayed.dim.hint"="256" %xposition_x, i32* "fpga.decayed.dim.hint"="256" %xposition_y, i32* "fpga.decayed.dim.hint"="256" %xposition_z, i32* "fpga.decayed.dim.hint"="4096" %xNL, i32* %flag, i32* "fpga.decayed.dim.hint"="28" %cap) #0 !dbg !101468 !fpga.function.pragma !101471 {
entry:
...
for.body88:                                       ; preds = %for.cond86
  ...
  %18 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xforce_x, i32 %i.5, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101527
...
for.body98:                                       ; preds = %for.cond96
  ...
  store %struct.Cap %load.5, %struct.Cap* %agg.tmp1, align 4, !dbg !101550
  %19 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xforce_y, i32 %i.6, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101527
...
for.body108:                                      ; preds = %for.cond106
  ...
  store %struct.Cap %load.6, %struct.Cap* %agg.tmp2, align 4, !dbg !101550
  %20 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xforce_z, i32 %i.7, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101527
