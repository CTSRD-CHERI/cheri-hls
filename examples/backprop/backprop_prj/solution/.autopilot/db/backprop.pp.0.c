...
# 269 "/home/jc2489/tools/Xilinx/2023.1/Vitis_HLS/2023.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 1 "backprop.c" 2
# 15 "backprop.c"
__attribute__((sdx_kernel("hls_top", 0))) void hls_top(int sets, int xweights1[13 * 64],
             int xweights2[64 * 64],
             int xweights3[64 * 3],
             int xbiases1[64], int xbiases2[64],
             int xbiases3[3],
             int xtraining_data[163 * 13],
             int xtraining_targets[163 * 3]) {
#line 14 "/workspace/examples/backprop/vhls.tcl"
#pragma HLSDIRECTIVE TOP name=hls_top
# 21 "backprop.c"
...
int main() {
  ...
  int biases2[64];
  int biases3[3];
  int training_data[163 * 13];
  int training_targets[163 * 3];
  hls_top(163, weights1, weights2, weights3, biases1, biases2,
