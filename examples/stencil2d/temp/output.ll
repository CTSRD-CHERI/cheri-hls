...
; Function Attrs: nounwind
define void @hls_top(i32 %size, i32* "fpga.decayed.dim.hint"="8192" %xorig, i32* "fpga.decayed.dim.hint"="8192" %xsol, i32* "fpga.decayed.dim.hint"="9" %xfilter, i32* %flag, i32* "fpga.decayed.dim.hint"="12" %cap) #3 !dbg !101603 !fpga.function.pragma !101606 {
entry:
...
for.body9:                                        ; preds = %for.cond7
  ...
  %1 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xfilter, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101527
...
for.end30:                                        ; preds = %for.cond
  ...
  %decay.2 = getelementptr inbounds [8192 x i32], [8192 x i32]* %sol, i32 0, i32 0, !dbg !101539
  %cap.arrayidx2 = getelementptr inbounds [3 x %struct.Cap], [3 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101539
  ...
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 %mul31, i32* %xsol, i32* %decay.2, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101539
