...
; Function Attrs: nounwind
define void @hls_top(i32 %n, i32 %l, i32* "fpga.decayed.dim.hint"="4940" %xnzval, i32* "fpga.decayed.dim.hint"="4940" %xcols, i32* "fpga.decayed.dim.hint"="494" %xvec, i32* "fpga.decayed.dim.hint"="494" %xout, i32* %flag, i32* "fpga.decayed.dim.hint"="16" %cap) #3 !dbg !101603 !fpga.function.pragma !101606 {
entry:
...
for.end50:                                        ; preds = %for.cond24
  ...
  %decay.3 = getelementptr inbounds [494 x i32], [494 x i32]* %out, i32 0, i32 0, !dbg !101539
  %cap.arrayidx3 = getelementptr inbounds [4 x %struct.Cap], [4 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101539
  ...
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 %n, i32* %xout, i32* %decay.3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539
