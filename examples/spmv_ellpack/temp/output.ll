...
; Function Attrs: nounwind
define void @hls_top(i32 %n, i32 %l, i32* "fpga.decayed.dim.hint"="4940" %xnzval, i32* "fpga.decayed.dim.hint"="4940" %xcols, i32* "fpga.decayed.dim.hint"="494" %xvec, i32* "fpga.decayed.dim.hint"="494" %xout, i32* %flag, i32* "fpga.decayed.dim.hint"="16" %cap) #3 !dbg !101522 !fpga.function.pragma !101525 {
entry:
  ...
  call void @_Z10create_capiP3Caph(i32 4940, %struct.Cap* %cap.arraydecay1, i8 4), !dbg !101542
  call void @_Z10create_capiP3Caph(i32 4940, %struct.Cap* %cap.arraydecay1, i8 5), !dbg !101542
  call void @_Z10create_capiP3Caph(i32 494, %struct.Cap* %cap.arraydecay1, i8 6), !dbg !101542
  call void @_Z10create_capiP3Caph(i32 494, %struct.Cap* %cap.arraydecay1, i8 7), !dbg !101542
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xnzval, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %4, metadata !101521, metadata !DIExpression()), !dbg !101529
  %arraypointer1 = getelementptr inbounds [4940 x i32], [4940 x i32]* %nzval, i32 0, i32 0, !dbg !101530
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer1, i32 %i.0, i32 %4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101539
...
for.body6:                                        ; preds = %for.cond3
  ...
  %5 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xcols, i32 %i.1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %5, metadata !101521, metadata !DIExpression()), !dbg !101529
  %arraypointer3 = getelementptr inbounds [4940 x i32], [4940 x i32]* %cols, i32 0, i32 0, !dbg !101530
  ...
  store %struct.Cap %store.3, %struct.Cap* %agg.tmp5, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer3, i32 %i.1, i32 %5, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101539
...
for.body16:                                       ; preds = %for.cond14
  ...
  %6 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xvec, i32 %i.2, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %6, metadata !101521, metadata !DIExpression()), !dbg !101529
  %arraypointer5 = getelementptr inbounds [494 x i32], [494 x i32]* %vec, i32 0, i32 0, !dbg !101530
  ...
  store %struct.Cap %store.5, %struct.Cap* %agg.tmp6, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer5, i32 %i.2, i32 %6, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101539
...
for.body26:                                       ; preds = %for.cond24
  %arraypointer6 = getelementptr inbounds [494 x i32], [494 x i32]* %out, i32 0, i32 0, !dbg !101530
  ...
  %7 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer6, i32 %i.3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101527
...
for.body31:                                       ; preds = %for.cond29
  ...
  %arraypointer7 = getelementptr inbounds [4940 x i32], [4940 x i32]* %nzval, i32 0, i32 0, !dbg !101530
  ...
  %8 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer7, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101527
  ...
  %arraypointer8 = getelementptr inbounds [4940 x i32], [4940 x i32]* %cols, i32 0, i32 0, !dbg !101530
  ...
  %9 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer8, i32 %add36, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101527
  call void @llvm.dbg.value(metadata i32 %9, metadata !101521, metadata !DIExpression()), !dbg !101529
  %arraypointer9 = getelementptr inbounds [494 x i32], [494 x i32]* %vec, i32 0, i32 0, !dbg !101530
  ...
  %10 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer9, i32 %9, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101527
...
for.end45:                                        ; preds = %for.cond29
  %arraypointer10 = getelementptr inbounds [494 x i32], [494 x i32]* %out, i32 0, i32 0, !dbg !101530
  %cap.arrayidx10 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 7, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %sum.0, metadata !101528, metadata !DIExpression()), !dbg !101539
  %store.10 = load %struct.Cap, %struct.Cap* %cap.arrayidx10, align 4, !dbg !101539
  store %struct.Cap %store.10, %struct.Cap* %agg.tmp7, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer10, i32 %i.3, i32 %sum.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101539
...
for.end50:                                        ; preds = %for.cond24
  ...
  %decay.11 = getelementptr inbounds [494 x i32], [494 x i32]* %out, i32 0, i32 0, !dbg !101539
  %cap.arrayidx11 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101539
  %store.11 = load %struct.Cap, %struct.Cap* %cap.arrayidx11, align 4, !dbg !101539
  store %struct.Cap %store.11, %struct.Cap* %agg.tmp3, align 4, !dbg !101539
  call void @_Z18cheri_stream_writejPiS_Pj3Cap(i32 %n, i32* %xout, i32* %decay.11, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539
