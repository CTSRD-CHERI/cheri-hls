...
define void @hls_top(i32 %n, i32 %l, i32* "fpga.decayed.dim.hint"="4940" %xnzval, i32* "fpga.decayed.dim.hint"="4940" %xcols, i32* "fpga.decayed.dim.hint"="494" %xvec, i32* "fpga.decayed.dim.hint"="494" %xout, i32* %flag, i32* "fpga.decayed.dim.hint"="32" %cap) #0 !dbg !101665 !fpga.function.pragma !101668 {
entry:
  ...
  call void @_Z10create_capiP3Capi(i32 4940, %struct.Cap* %cap.arraydecay1, i32 4), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 4940, %struct.Cap* %cap.arraydecay1, i32 5), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 494, %struct.Cap* %cap.arraydecay1, i32 6), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 494, %struct.Cap* %cap.arraydecay1, i32 7), !dbg !101542
...
for.body:                                         ; preds = %for.cond
  %cap.arrayidx0 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101550
  ...
  %4 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xnzval, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %4, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer1 = getelementptr inbounds [4940 x i32], [4940 x i32]* %nzval, i32 0, i32 0, !dbg !101555
  %cap.arrayidx1 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 4, !dbg !101550
  ...
  store %struct.Cap %store.1, %struct.Cap* %agg.tmp4, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer1, i32 %i.0, i32 %4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101564
...
for.body6:                                        ; preds = %for.cond3
  %cap.arrayidx2 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101550
  ...
  %5 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xcols, i32 %i.1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %5, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer3 = getelementptr inbounds [4940 x i32], [4940 x i32]* %cols, i32 0, i32 0, !dbg !101555
  %cap.arrayidx3 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 5, !dbg !101550
  ...
  store %struct.Cap %store.3, %struct.Cap* %agg.tmp5, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer3, i32 %i.1, i32 %5, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101564
...
for.body16:                                       ; preds = %for.cond14
  ...
  %6 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xvec, i32 %i.2, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %6, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer5 = getelementptr inbounds [494 x i32], [494 x i32]* %vec, i32 0, i32 0, !dbg !101555
  %cap.arrayidx5 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 6, !dbg !101550
  ...
  store %struct.Cap %store.5, %struct.Cap* %agg.tmp6, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer5, i32 %i.2, i32 %6, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101564
...
for.body26:                                       ; preds = %for.cond24
  %arraypointer6 = getelementptr inbounds [494 x i32], [494 x i32]* %out, i32 0, i32 0, !dbg !101555
  %cap.arrayidx6 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 7, !dbg !101550
  %load.6 = load %struct.Cap, %struct.Cap* %cap.arrayidx6, align 4, !dbg !101550
  store %struct.Cap %load.6, %struct.Cap* %agg.tmp7, align 4, !dbg !101550
  %7 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer6, i32 %i.3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101552
...
for.body31:                                       ; preds = %for.cond29
  ...
  %arraypointer7 = getelementptr inbounds [4940 x i32], [4940 x i32]* %nzval, i32 0, i32 0, !dbg !101555
  %cap.arrayidx7 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 4, !dbg !101550
  %load.7 = load %struct.Cap, %struct.Cap* %cap.arrayidx7, align 4, !dbg !101550
  store %struct.Cap %load.7, %struct.Cap* %agg.tmp4, align 4, !dbg !101550
  %8 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer7, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101552
  ...
  %arraypointer8 = getelementptr inbounds [4940 x i32], [4940 x i32]* %cols, i32 0, i32 0, !dbg !101555
  %cap.arrayidx8 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 5, !dbg !101550
  %load.8 = load %struct.Cap, %struct.Cap* %cap.arrayidx8, align 4, !dbg !101550
  store %struct.Cap %load.8, %struct.Cap* %agg.tmp5, align 4, !dbg !101550
  %9 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer8, i32 %add36, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %9, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer9 = getelementptr inbounds [494 x i32], [494 x i32]* %vec, i32 0, i32 0, !dbg !101555
  %cap.arrayidx9 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 6, !dbg !101550
  %load.9 = load %struct.Cap, %struct.Cap* %cap.arrayidx9, align 4, !dbg !101550
  store %struct.Cap %load.9, %struct.Cap* %agg.tmp6, align 4, !dbg !101550
  %10 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer9, i32 %9, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
...
for.end45:                                        ; preds = %for.cond29
  %arraypointer10 = getelementptr inbounds [494 x i32], [494 x i32]* %out, i32 0, i32 0, !dbg !101555
  %cap.arrayidx10 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 7, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %sum.0, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.10 = load %struct.Cap, %struct.Cap* %cap.arrayidx10, align 4, !dbg !101563
  store %struct.Cap %store.10, %struct.Cap* %agg.tmp7, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer10, i32 %i.3, i32 %sum.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101564
...
for.body53:                                       ; preds = %for.cond51
  %arraypointer11 = getelementptr inbounds [494 x i32], [494 x i32]* %out, i32 0, i32 0, !dbg !101555
  %cap.arrayidx11 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 7, !dbg !101550
  ...
  %11 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer11, i32 %i.4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %11, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx12 = getelementptr inbounds [8 x %struct.Cap], [8 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101550
  ...
  store %struct.Cap %store.12, %struct.Cap* %agg.tmp3, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xout, i32 %i.4, i32 %11, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101564
