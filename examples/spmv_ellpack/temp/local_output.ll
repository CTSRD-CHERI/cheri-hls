...
define void @hls_top(i32 %n, i32 %l, i32* "fpga.decayed.dim.hint"="4940" %xnzval, i32* "fpga.decayed.dim.hint"="4940" %xcols, i32* "fpga.decayed.dim.hint"="494" %xvec, i32* "fpga.decayed.dim.hint"="494" %xout, i32* %flag, i32* "fpga.decayed.dim.hint"="16" %cap) #0 !dbg !101468 !fpga.function.pragma !101471 {
entry:
...
for.body53:                                       ; preds = %for.cond51
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xout, i32 %i.4, i32 %11, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539
