open_project -reset viterbi_prj
set_top hls_top 
add_files { viterbi.c }
...
set ::LLVM_CUSTOM_CMD {/local/ecad/xilinx/new/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/bin/llvm-dis /workspace/examples/viterbi/temp/test.bc}
#a.g.ld.6.user.ll
