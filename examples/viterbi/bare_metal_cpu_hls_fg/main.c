...
tok_t a[NUM][N_OBS];
prob_t b[NUM][N_STATES];
prob_t c[NUM][N_STATES * N_STATES];
prob_t d[NUM][N_STATES * N_TOKENS];
state_t e[NUM][N_OBS];
u32 cap[20];
...
u32 hls_top_init(int test_case, u32 *phy) {
  ...
  XHls_top_Set_n_tokens(top, N_TOKENS);
  ...
  // Configuring data buffers
  XHls_top_WriteReg(top->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XOBS_DATA + 4, (u32)(0));
  XHls_top_WriteReg(top->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XINIT_DATA + 4, (u32)(0));
  XHls_top_WriteReg(top->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XTRANSITION_DATA + 4, (u32)(0));
  XHls_top_WriteReg(top->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XEMISSION_DATA + 4, (u32)(0));
  XHls_top_WriteReg(top->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XPATH_DATA + 4, (u32)(0));
#endif

  XHls_top_WriteReg(top->Control_BaseAddress, XHLS_TOP_CONTROL_ADDR_XOBS_DATA,
                    (u32)(buffer_a));
  XHls_top_WriteReg(top->Control_BaseAddress, XHLS_TOP_CONTROL_ADDR_XINIT_DATA,
                    (u32)(buffer_b));
  XHls_top_WriteReg(top->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XTRANSITION_DATA, (u32)(buffer_c));
  XHls_top_WriteReg(top->Control_BaseAddress,
                    XHLS_TOP_CONTROL_ADDR_XEMISSION_DATA, (u32)(buffer_d));
  XHls_top_WriteReg(top->Control_BaseAddress, XHLS_TOP_CONTROL_ADDR_XPATH_DATA,
                    (u32)(buffer_e));
