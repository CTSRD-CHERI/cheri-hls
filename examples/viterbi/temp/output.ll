...
; Function Attrs: nounwind
define void @hls_top(i32 %n_tokens, i32* "fpga.decayed.dim.hint"="140" %xobs, i32* "fpga.decayed.dim.hint"="64" %xinit, i32* "fpga.decayed.dim.hint"="4096" %xtransition, i32* "fpga.decayed.dim.hint"="4096" %xemission, i32* "fpga.decayed.dim.hint"="140" %xpath, i32* %flag, i32* "fpga.decayed.dim.hint"="20" %cap) #3 !dbg !101603 !fpga.function.pragma !101606 {
entry:
...
for.end166:                                       ; preds = %for.cond127
  ...
  %decay.4 = getelementptr inbounds [140 x i32], [140 x i32]* %path, i32 0, i32 0, !dbg !101539
  %cap.arrayidx4 = getelementptr inbounds [5 x %struct.Cap], [5 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101539
  ...
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 140, i32* %xpath, i32* %decay.4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101539
