...
; Function Attrs: nounwind
define i32 @block_index(i32 %x, i32 %y, i32 %z, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="14" %caps) #0 !dbg !101522 {
entry:
...
; Function Attrs: nounwind
define i32 @point_index(i32 %block_idx, i32 %point_idx, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="14" %caps) #0 !dbg !101522 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
