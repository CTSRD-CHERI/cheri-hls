...
define i32 @block_index(i32 %x, i32 %y, i32 %z, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="14" %caps) #0 !dbg !101493 {
entry:
...
; Function Attrs: nounwind
define i32 @point_index(i32 %block_idx, i32 %point_idx, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="14" %caps) #0 !dbg !101493 {
entry:
  %agg.tmp0 = alloca %struct.Cap, align 4
  %agg.tmp1 = alloca %struct.Cap, align 4
  %agg.tmp2 = alloca %struct.Cap, align 4
...
entry:
  ...
  %init.1 = bitcast [14 x %struct.Cap]* %caps to i8*, !dbg !101494
  call void @llvm.lifetime.start.p0i8(i64 168, i8* %init.1) #9003, !dbg !101494
  call void @llvm.dbg.declare(metadata [14 x %struct.Cap]* %caps, metadata !101495, metadata !DIExpression()), !dbg !101499
  %init.2 = bitcast [56 x i32]* %buffer to i8*, !dbg !101500
  call void @llvm.lifetime.start.p0i8(i64 224, i8* %init.2) #9003, !dbg !101500
  call void @llvm.dbg.declare(metadata [56 x i32]* %buffer, metadata !101501, metadata !DIExpression()), !dbg !101505
  call void @llvm.sideeffect() #9000 [ "xlx_array_partition"([56 x i32]* %buffer, i32 2, i32 0, i32 1, i1 false) ], !dbg !101506
  call void @llvm.sideeffect() #9002 [ "xlx_array_partition"([14 x %struct.Cap]* %caps, i32 2, i32 0, i32 1, i1 false) ], !dbg !101507
  %cap.arraydecay = getelementptr inbounds [56 x i32], [56 x i32]* %buffer, i32 0, i32 0, !dbg !101508
  %cap.arraydecay1 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i32 0, i32 0, !dbg !101509
  call void @_Z8load_capiPjS_P3Cap(i32 14, i32* %cap.arraydecay, i32* %cap, %struct.Cap* %cap.arraydecay1), !dbg !101510
  call void @_Z10create_capiP3Capi(i32 64, %struct.Cap* %cap.arraydecay1, i32 7), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 640, %struct.Cap* %cap.arraydecay1, i32 8), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 640, %struct.Cap* %cap.arraydecay1, i32 9), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 640, %struct.Cap* %cap.arraydecay1, i32 10), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 640, %struct.Cap* %cap.arraydecay1, i32 11), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 640, %struct.Cap* %cap.arraydecay1, i32 12), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 640, %struct.Cap* %cap.arraydecay1, i32 13), !dbg !101542
...
for.body8:                                        ; preds = %for.cond5
  %call = call i32 @block_index(i32 %i.0, i32 %j.0, i32 %k.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !118
  call void @llvm.dbg.value(metadata i32 %call, metadata !120, metadata !DIExpression()), !dbg !121
  %cap.arrayidx0 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101550
  ...
  %7 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xn_points, i32 %call, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %7, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer1 = getelementptr inbounds [64 x i32], [64 x i32]* %n_points, i32 0, i32 0, !dbg !101555
  %cap.arrayidx1 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 7, !dbg !101550
  ...
  store %struct.Cap %store.1, %struct.Cap* %agg.tmp7, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer1, i32 %call, i32 %7, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101564
...
for.body23:                                       ; preds = %for.cond18
  %cap.arrayidx2 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101550
  ...
  %8 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %force_x, i32 %i17.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %8, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer3 = getelementptr inbounds [640 x i32], [640 x i32]* %force_x_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx3 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 8, !dbg !101550
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer3, i32 %i17.0, i32 %8, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101564
  %cap.arrayidx4 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101550
  ...
  %9 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %force_y, i32 %i17.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %9, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer5 = getelementptr inbounds [640 x i32], [640 x i32]* %force_y_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx5 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 9, !dbg !101550
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer5, i32 %i17.0, i32 %9, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101564
  %cap.arrayidx6 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101550
  %load.6 = load %struct.Cap, %struct.Cap* %cap.arrayidx6, align 4, !dbg !101550
  store %struct.Cap %load.6, %struct.Cap* %agg.tmp3, align 4, !dbg !101550
  %10 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %force_z, i32 %i17.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %10, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer7 = getelementptr inbounds [640 x i32], [640 x i32]* %force_z_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx7 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 10, !dbg !101550
  ...
  store %struct.Cap %store.7, %struct.Cap* %agg.tmp10, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer7, i32 %i17.0, i32 %10, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101564
  %cap.arrayidx8 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 4, !dbg !101550
  ...
  %11 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %position_x, i32 %i17.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %11, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer9 = getelementptr inbounds [640 x i32], [640 x i32]* %pos_x_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx9 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 11, !dbg !101550
  ...
  store %struct.Cap %store.9, %struct.Cap* %agg.tmp11, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer9, i32 %i17.0, i32 %11, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp11), !dbg !101564
  %cap.arrayidx10 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 5, !dbg !101550
  %load.10 = load %struct.Cap, %struct.Cap* %cap.arrayidx10, align 4, !dbg !101550
  store %struct.Cap %load.10, %struct.Cap* %agg.tmp5, align 4, !dbg !101550
  %12 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %position_y, i32 %i17.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %12, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer11 = getelementptr inbounds [640 x i32], [640 x i32]* %pos_y_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx11 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 12, !dbg !101550
  ...
  store %struct.Cap %store.11, %struct.Cap* %agg.tmp12, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer11, i32 %i17.0, i32 %12, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp12), !dbg !101564
  %cap.arrayidx12 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 6, !dbg !101550
  %load.12 = load %struct.Cap, %struct.Cap* %cap.arrayidx12, align 4, !dbg !101550
  store %struct.Cap %load.12, %struct.Cap* %agg.tmp6, align 4, !dbg !101550
  %13 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %position_z, i32 %i17.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %13, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer13 = getelementptr inbounds [640 x i32], [640 x i32]* %pos_z_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx13 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 13, !dbg !101550
  ...
  store %struct.Cap %store.13, %struct.Cap* %agg.tmp13, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer13, i32 %i17.0, i32 %13, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp13), !dbg !101564
...
for.body59:                                       ; preds = %for.cond57
  %call60 = call i32 @block_index(i32 %b0_x.0, i32 %b0_y.0, i32 %b0_z.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !203
...
for.body105:                                      ; preds = %cond.end102
  %call106 = call i32 @block_index(i32 %b1_x.0, i32 %b1_y.0, i32 %b1_z.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !257
  call void @llvm.dbg.value(metadata i32 %call106, metadata !259, metadata !DIExpression()), !dbg !260
  %arraypointer14 = getelementptr inbounds [64 x i32], [64 x i32]* %n_points, i32 0, i32 0, !dbg !101555
  %cap.arrayidx14 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 7, !dbg !101550
  %load.14 = load %struct.Cap, %struct.Cap* %cap.arrayidx14, align 4, !dbg !101550
  store %struct.Cap %load.14, %struct.Cap* %agg.tmp7, align 4, !dbg !101550
  %14 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer14, i32 %call106, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101552
...
for.cond109:                                      ; preds = %for.inc170, %loop_p
  ...
  %arraypointer15 = getelementptr inbounds [64 x i32], [64 x i32]* %n_points, i32 0, i32 0, !dbg !101555
  %cap.arrayidx15 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 7, !dbg !101550
  %load.15 = load %struct.Cap, %struct.Cap* %cap.arrayidx15, align 4, !dbg !101550
  store %struct.Cap %load.15, %struct.Cap* %agg.tmp7, align 4, !dbg !101550
  %15 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer15, i32 %call60, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101552
...
for.body113:                                      ; preds = %for.cond109
  %call114 = call i32 @point_index(i32 %call60, i32 %p_idx.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !273
  call void @llvm.dbg.value(metadata i32 %call114, metadata !275, metadata !DIExpression()), !dbg !276
  %arraypointer16 = getelementptr inbounds [640 x i32], [640 x i32]* %pos_x_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx16 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 11, !dbg !101550
  %load.16 = load %struct.Cap, %struct.Cap* %cap.arrayidx16, align 4, !dbg !101550
  store %struct.Cap %load.16, %struct.Cap* %agg.tmp11, align 4, !dbg !101550
  %16 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer16, i32 %call114, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp11), !dbg !101552
  ...
  %arraypointer17 = getelementptr inbounds [640 x i32], [640 x i32]* %pos_y_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx17 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 12, !dbg !101550
  %load.17 = load %struct.Cap, %struct.Cap* %cap.arrayidx17, align 4, !dbg !101550
  store %struct.Cap %load.17, %struct.Cap* %agg.tmp12, align 4, !dbg !101550
  %17 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer17, i32 %call114, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp12), !dbg !101552
  ...
  %arraypointer18 = getelementptr inbounds [640 x i32], [640 x i32]* %pos_z_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx18 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 13, !dbg !101550
  %load.18 = load %struct.Cap, %struct.Cap* %cap.arrayidx18, align 4, !dbg !101550
  store %struct.Cap %load.18, %struct.Cap* %agg.tmp13, align 4, !dbg !101550
  %18 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer18, i32 %call114, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp13), !dbg !101552
  ...
  %arraypointer19 = getelementptr inbounds [640 x i32], [640 x i32]* %force_x_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx19 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 8, !dbg !101550
  %load.19 = load %struct.Cap, %struct.Cap* %cap.arrayidx19, align 4, !dbg !101550
  store %struct.Cap %load.19, %struct.Cap* %agg.tmp8, align 4, !dbg !101550
  %19 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer19, i32 %call114, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101552
  ...
  %arraypointer20 = getelementptr inbounds [640 x i32], [640 x i32]* %force_y_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx20 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 9, !dbg !101550
  ...
  %20 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer20, i32 %call114, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101552
  ...
  %arraypointer21 = getelementptr inbounds [640 x i32], [640 x i32]* %force_z_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx21 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 10, !dbg !101550
  %load.21 = load %struct.Cap, %struct.Cap* %cap.arrayidx21, align 4, !dbg !101550
  store %struct.Cap %load.21, %struct.Cap* %agg.tmp10, align 4, !dbg !101550
  %21 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer21, i32 %call114, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101552
...
for.body129:                                      ; preds = %for.cond127
  %call130 = call i32 @point_index(i32 %call106, i32 %q_idx.0, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !303
  call void @llvm.dbg.value(metadata i32 %call130, metadata !305, metadata !DIExpression()), !dbg !306
  %arraypointer22 = getelementptr inbounds [640 x i32], [640 x i32]* %pos_x_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx22 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 11, !dbg !101550
  %load.22 = load %struct.Cap, %struct.Cap* %cap.arrayidx22, align 4, !dbg !101550
  store %struct.Cap %load.22, %struct.Cap* %agg.tmp11, align 4, !dbg !101550
  %22 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer22, i32 %call130, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp11), !dbg !101552
  ...
  %arraypointer23 = getelementptr inbounds [640 x i32], [640 x i32]* %pos_y_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx23 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 12, !dbg !101550
  %load.23 = load %struct.Cap, %struct.Cap* %cap.arrayidx23, align 4, !dbg !101550
  store %struct.Cap %load.23, %struct.Cap* %agg.tmp12, align 4, !dbg !101550
  %23 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer23, i32 %call130, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp12), !dbg !101552
  ...
  %arraypointer24 = getelementptr inbounds [640 x i32], [640 x i32]* %pos_z_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx24 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 13, !dbg !101550
  %load.24 = load %struct.Cap, %struct.Cap* %cap.arrayidx24, align 4, !dbg !101550
  store %struct.Cap %load.24, %struct.Cap* %agg.tmp13, align 4, !dbg !101550
  %24 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer24, i32 %call130, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp13), !dbg !101552
...
for.end163:                                       ; preds = %for.cond127
  %arraypointer25 = getelementptr inbounds [640 x i32], [640 x i32]* %force_x_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx25 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 8, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %sum_x.0, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.25 = load %struct.Cap, %struct.Cap* %cap.arrayidx25, align 4, !dbg !101563
  store %struct.Cap %store.25, %struct.Cap* %agg.tmp8, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer25, i32 %call114, i32 %sum_x.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101564
  %arraypointer26 = getelementptr inbounds [640 x i32], [640 x i32]* %force_y_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx26 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 9, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %sum_y.0, metadata !101528, metadata !DIExpression()), !dbg !101562
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer26, i32 %call114, i32 %sum_y.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101564
  %arraypointer27 = getelementptr inbounds [640 x i32], [640 x i32]* %force_z_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx27 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 10, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %sum_z.0, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.27 = load %struct.Cap, %struct.Cap* %cap.arrayidx27, align 4, !dbg !101563
  store %struct.Cap %store.27, %struct.Cap* %agg.tmp10, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer27, i32 %call114, i32 %sum_z.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101564
...
for.body198:                                      ; preds = %for.cond192
  %arraypointer28 = getelementptr inbounds [640 x i32], [640 x i32]* %force_x_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx28 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 8, !dbg !101550
  %load.28 = load %struct.Cap, %struct.Cap* %cap.arrayidx28, align 4, !dbg !101550
  store %struct.Cap %load.28, %struct.Cap* %agg.tmp8, align 4, !dbg !101550
  %25 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer28, i32 %i191.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %25, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx29 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %25, metadata !101528, metadata !DIExpression()), !dbg !101562
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %force_x, i32 %i191.0, i32 %25, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101564
  %arraypointer30 = getelementptr inbounds [640 x i32], [640 x i32]* %force_y_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx30 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 9, !dbg !101550
  %load.30 = load %struct.Cap, %struct.Cap* %cap.arrayidx30, align 4, !dbg !101550
  store %struct.Cap %load.30, %struct.Cap* %agg.tmp9, align 4, !dbg !101550
  %26 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer30, i32 %i191.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %26, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx31 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %26, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.31 = load %struct.Cap, %struct.Cap* %cap.arrayidx31, align 4, !dbg !101563
  store %struct.Cap %store.31, %struct.Cap* %agg.tmp2, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %force_y, i32 %i191.0, i32 %26, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101564
  %arraypointer32 = getelementptr inbounds [640 x i32], [640 x i32]* %force_z_local, i32 0, i32 0, !dbg !101555
  %cap.arrayidx32 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 10, !dbg !101550
  %load.32 = load %struct.Cap, %struct.Cap* %cap.arrayidx32, align 4, !dbg !101550
  store %struct.Cap %load.32, %struct.Cap* %agg.tmp10, align 4, !dbg !101550
  %27 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer32, i32 %i191.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp10), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %27, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx33 = getelementptr inbounds [14 x %struct.Cap], [14 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %27, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.33 = load %struct.Cap, %struct.Cap* %cap.arrayidx33, align 4, !dbg !101563
  store %struct.Cap %store.33, %struct.Cap* %agg.tmp3, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %force_z, i32 %i191.0, i32 %27, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101564
...
for.end213:                                       ; preds = %for.cond.cleanup197
  ...
  %end.2 = bitcast [56 x i32]* %buffer to i8*, !dbg !101542
  call void @llvm.lifetime.end.p0i8(i64 224, i8* %end.2) #9003, !dbg !101542
  %end.3 = bitcast [14 x %struct.Cap]* %caps to i8*, !dbg !101542
  call void @llvm.lifetime.end.p0i8(i64 168, i8* %end.3) #9003, !dbg !101542
