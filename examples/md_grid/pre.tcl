open_project -reset md_grid_prj
set_top hls_top 
add_files { md_grid.c }
add_files -tb { md_grid.c }
...
set ::LLVM_CUSTOM_CMD {/local/ecad/xilinx/new/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/bin/llvm-dis /workspace/examples/md_grid/temp/test.bc}
#a.g.ld.6.user.ll
