...
define void @_Z4multiPiS_S_(i32 %size, i32* "fpga.decayed.dim.hint"="10" %a, i32* "fpga.decayed.dim.hint"="10" %b, i32* "fpga.decayed.dim.hint"="10" %c, i32* %flag_buf, %struct.Cap* "fpga.decayed.dim.hint"="3" %caps) #0 !dbg !101493 {
entry:
...
for.body:                                         ; preds = %for.cond
  %arrayidx0 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 0, !dbg !101550
  ...
  %arrayidx1 = getelementptr inbounds %struct.Cap, %struct.Cap* %caps, i64 1, !dbg !101550
...
; Function Attrs: nounwind
define void @_Z7hls_topiPiS_S_(i32 %size, i32* "fpga.decayed.dim.hint"="10" %a, i32* "fpga.decayed.dim.hint"="10" %b, i32* "fpga.decayed.dim.hint"="10" %c, i32* %flag, i32* "fpga.decayed.dim.hint"="12" %cap) #3 !dbg !101493 !fpga.function.pragma !101496 {
entry:
  ...
  call void @_Z4multiPiS_S_(i32 %size, i32* %a, i32* %b, i32* %c, i32* %flag_buf, %struct.Cap* %cap.arraydecay1), !dbg !61
