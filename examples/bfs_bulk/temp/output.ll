...
define void @hls_top(i32 %starting_node, i32 %levels, i32 %node, i32* "fpga.decayed.dim.hint"="256" %xnodes_b, i32* "fpga.decayed.dim.hint"="256" %xnodes_e, i32* "fpga.decayed.dim.hint"="4096" %xedges, i32* "fpga.decayed.dim.hint"="256" %xlevel, i32* "fpga.decayed.dim.hint"="10" %xlevel_counts, i32* %flag, i32* "fpga.decayed.dim.hint"="20" %cap) #0 !dbg !101468 !fpga.function.pragma !101471 {
entry:
...
for.body75:                                       ; preds = %for.cond72
  ...
  %15 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer15, i32 %i71.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101527
  ...
  store %struct.Cap %store.16, %struct.Cap* %agg.tmp3, align 4, !dbg !101539
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xlevel, i32 %i71.0, i32 %15, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539
...
for.body87:                                       ; preds = %for.cond84
  ...
  %16 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer17, i32 %i83.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101527
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xlevel_counts, i32 %i83.0, i32 %16, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101539
