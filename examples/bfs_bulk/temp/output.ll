...
; Function Attrs: nounwind
define void @_Z7hls_topiiiPiS_S_S_S_(i32 %starting_node, i32 %levels, i32 %node, i32* "fpga.decayed.dim.hint"="256" %xnodes_b, i32* "fpga.decayed.dim.hint"="256" %xnodes_e, i32* "fpga.decayed.dim.hint"="4096" %xedges, i32* "fpga.decayed.dim.hint"="256" %xlevel, i32* "fpga.decayed.dim.hint"="10" %xlevel_counts, i32* %flag, i32* "fpga.decayed.dim.hint"="20" %cap) #3 !dbg !101603 !fpga.function.pragma !101606 {
entry:
...
for.end70:                                        ; preds = %if.then66, %for.cond30
  ...
  %cap.arrayidx15b = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 8, !dbg !101539
  %store.15b = load %struct.Cap, %struct.Cap* %cap.arrayidx15b, align 4, !dbg !101539
  store %struct.Cap %store.15b, %struct.Cap* %agg.tmp8, align 4, !dbg !101539

  call void @_Z18cheri_stream_writejPiS_Pj3CapS1_(i32 %node, i32* %xlevel, i32* %decay.15, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101539
  ...
  %cap.arrayidx16b = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 9, !dbg !101539
  %store.16b = load %struct.Cap, %struct.Cap* %cap.arrayidx16b, align 4, !dbg !101539
  store %struct.Cap %store.16b, %struct.Cap* %agg.tmp9, align 4, !dbg !101539

  call void @_Z18cheri_stream_writejPiS_Pj3CapS1_(i32 %levels, i32* %xlevel_counts, i32* %decay.16, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101539
...
attributes #9000 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="1280" "xlx.source"="user" }
attributes #9001 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="0" "xlx.source"="user" }
attributes #9002 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="960" "xlx.source"="user" }
