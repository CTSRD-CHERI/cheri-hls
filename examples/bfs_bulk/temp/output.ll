...
define void @hls_top(i32 %starting_node, i32 %levels, i32 %node, i32* "fpga.decayed.dim.hint"="256" %xnodes_b, i32* "fpga.decayed.dim.hint"="256" %xnodes_e, i32* "fpga.decayed.dim.hint"="4096" %xedges, i32* "fpga.decayed.dim.hint"="256" %xlevel, i32* "fpga.decayed.dim.hint"="10" %xlevel_counts, i32* %flag, i32* "fpga.decayed.dim.hint"="40" %cap) #0 !dbg !101665 !fpga.function.pragma !101668 {
entry:
  ...
  call void @_Z10create_capiP3Capi(i32 256, %struct.Cap* %cap.arraydecay1, i32 5), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 256, %struct.Cap* %cap.arraydecay1, i32 6), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 4096, %struct.Cap* %cap.arraydecay1, i32 7), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 256, %struct.Cap* %cap.arraydecay1, i32 8), !dbg !101542
  call void @_Z10create_capiP3Capi(i32 10, %struct.Cap* %cap.arraydecay1, i32 9), !dbg !101542
...
for.body:                                         ; preds = %for.cond
  %cap.arrayidx0 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 0, !dbg !101550
  ...
  %7 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xnodes_b, i32 %i.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp0), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %7, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer1 = getelementptr inbounds [256 x i32], [256 x i32]* %node_edge_begin, i32 0, i32 0, !dbg !101555
  %cap.arrayidx1 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 5, !dbg !101550
  ...
  store %struct.Cap %store.1, %struct.Cap* %agg.tmp5, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer1, i32 %i.0, i32 %7, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101564
...
for.body7:                                        ; preds = %for.cond4
  %cap.arrayidx2 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 1, !dbg !101550
  ...
  %8 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xnodes_e, i32 %i3.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp1), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %8, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer3 = getelementptr inbounds [256 x i32], [256 x i32]* %node_edge_end, i32 0, i32 0, !dbg !101555
  %cap.arrayidx3 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 6, !dbg !101550
  ...
  store %struct.Cap %store.3, %struct.Cap* %agg.tmp6, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer3, i32 %i3.0, i32 %8, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101564
...
for.body19:                                       ; preds = %for.cond16
  %cap.arrayidx4 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 2, !dbg !101550
  ...
  %9 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %xedges, i32 %i15.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp2), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %9, metadata !101521, metadata !DIExpression()), !dbg !101554
  %arraypointer5 = getelementptr inbounds [4096 x i32], [4096 x i32]* %edges_dst, i32 0, i32 0, !dbg !101555
  %cap.arrayidx5 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 7, !dbg !101550
  ...
  store %struct.Cap %store.5, %struct.Cap* %agg.tmp7, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer5, i32 %i15.0, i32 %9, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101564
...
for.end26:                                        ; preds = %for.cond.cleanup18
  %arraypointer6 = getelementptr inbounds [256 x i32], [256 x i32]* %level, i32 0, i32 0, !dbg !101555
  %cap.arrayidx6 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 8, !dbg !101550
  ...
  store %struct.Cap %store.6, %struct.Cap* %agg.tmp8, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer6, i32 %starting_node, i32 0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101564
  %arraypointer7 = getelementptr inbounds [10 x i32], [10 x i32]* %level_counts, i32 0, i32 0, !dbg !101555
  %cap.arrayidx7 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 9, !dbg !101550
  ...
  store %struct.Cap %store.7, %struct.Cap* %agg.tmp9, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer7, i32 0, i32 1, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101564
...
for.body35:                                       ; preds = %for.cond33
  %arraypointer8 = getelementptr inbounds [256 x i32], [256 x i32]* %level, i32 0, i32 0, !dbg !101555
  %cap.arrayidx8 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 8, !dbg !101550
  ...
  %10 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer8, i32 %n.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101552
...
if.then:                                          ; preds = %for.body35
  %arraypointer9 = getelementptr inbounds [256 x i32], [256 x i32]* %node_edge_begin, i32 0, i32 0, !dbg !101555
  %cap.arrayidx9 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 5, !dbg !101550
  ...
  %11 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer9, i32 %n.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp5), !dbg !101552
  ...
  %arraypointer10 = getelementptr inbounds [256 x i32], [256 x i32]* %node_edge_end, i32 0, i32 0, !dbg !101555
  %cap.arrayidx10 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 6, !dbg !101550
  ...
  %12 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer10, i32 %n.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp6), !dbg !101552
...
for.body45:                                       ; preds = %for.cond43
  %arraypointer11 = getelementptr inbounds [4096 x i32], [4096 x i32]* %edges_dst, i32 0, i32 0, !dbg !101555
  %cap.arrayidx11 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 7, !dbg !101550
  ...
  %13 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer11, i32 %e.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp7), !dbg !101552
  ...
  %arraypointer12 = getelementptr inbounds [256 x i32], [256 x i32]* %level, i32 0, i32 0, !dbg !101555
  %cap.arrayidx12 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 8, !dbg !101550
  ...
  %14 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer12, i32 %13, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101552
...
if.then51:                                        ; preds = %for.body45
  ...
  %arraypointer13 = getelementptr inbounds [256 x i32], [256 x i32]* %level, i32 0, i32 0, !dbg !101555
  %cap.arrayidx13 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 8, !dbg !101550
  ...
  store %struct.Cap %store.13, %struct.Cap* %agg.tmp8, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer13, i32 %13, i32 %add, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101564
...
for.end61:                                        ; preds = %for.cond33
  ...
  %arraypointer14 = getelementptr inbounds [10 x i32], [10 x i32]* %level_counts, i32 0, i32 0, !dbg !101555
  %cap.arrayidx14 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 9, !dbg !101550
  call void @llvm.dbg.value(metadata i32 %cnt.0, metadata !101528, metadata !DIExpression()), !dbg !101562
  %store.14 = load %struct.Cap, %struct.Cap* %cap.arrayidx14, align 4, !dbg !101563
  store %struct.Cap %store.14, %struct.Cap* %agg.tmp9, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %arraypointer14, i32 %add62, i32 %cnt.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101564
...
for.end70:                                        ; preds = %if.then66, %for.cond30
  br label %VITIS_LOOP_98_4, !dbg !197

VITIS_LOOP_98_4:                                  ; preds = %for.end70
  call void @llvm.dbg.value(metadata i32 0, metadata !199, metadata !DIExpression()), !dbg !201
  br label %for.cond72, !dbg !202

for.cond72:                                       ; preds = %for.inc80, %VITIS_LOOP_98_4
  %i71.0 = phi i32 [ 0, %VITIS_LOOP_98_4 ], [ %inc81, %for.inc80 ]
...
for.body75:                                       ; preds = %for.cond72
  %arraypointer15 = getelementptr inbounds [256 x i32], [256 x i32]* %level, i32 0, i32 0, !dbg !101555
  ...
  %15 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer15, i32 %i71.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp8), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %15, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx16 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 3, !dbg !101550
  ...
  store %struct.Cap %store.16, %struct.Cap* %agg.tmp3, align 4, !dbg !101563
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xlevel, i32 %i71.0, i32 %15, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101564
...
for.end82:                                        ; preds = %for.cond.cleanup74
  br label %VITIS_LOOP_101_5, !dbg !212

VITIS_LOOP_101_5:                                 ; preds = %for.end82
  call void @llvm.dbg.value(metadata i32 0, metadata !214, metadata !DIExpression()), !dbg !216
  br label %for.cond84, !dbg !217

for.cond84:                                       ; preds = %for.inc92, %VITIS_LOOP_101_5
  %i83.0 = phi i32 [ 0, %VITIS_LOOP_101_5 ], [ %inc93, %for.inc92 ]
...
for.body87:                                       ; preds = %for.cond84
  %arraypointer17 = getelementptr inbounds [10 x i32], [10 x i32]* %level_counts, i32 0, i32 0, !dbg !101555
  %cap.arrayidx17 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 9, !dbg !101550
  ...
  %16 = call i32 @_Z10cheri_loadPiiPj3Cap(i32* %arraypointer17, i32 %i83.0, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp9), !dbg !101552
  call void @llvm.dbg.value(metadata i32 %16, metadata !101521, metadata !DIExpression()), !dbg !101554
  %cap.arrayidx18 = getelementptr inbounds [10 x %struct.Cap], [10 x %struct.Cap]* %caps, i64 0, i64 4, !dbg !101550
  ...
  call void @_Z11cheri_storePiiiPj3Cap(i32* %xlevel_counts, i32 %i83.0, i32 %16, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101564
...
!122 = distinct !DILexicalBlock(scope: !7, file: !8, line: 74, column: 3)
!123 = !DILocation(line: 74, column: 29, scope: !124)
!124 = distinct !DILexicalBlock(scope: !122, file: !8, line: 74, column: 3)
!125 = !DILocation(line: 74, column: 3, scope: !122)
!126 = !DILocalVariable(name: "cnt", scope: !7, file: !8, line: 54, type: !65)
!127 = !DILocation(line: 54, column: 16, scope: !7)
!128 = !DILocation(line: 75, column: 5, scope: !129)
!129 = distinct !DILexicalBlock(scope: !124, file: !8, line: 74, column: 50)
!130 = !DILocalVariable(name: "n", scope: !7, file: !8, line: 51, type: !11)
!131 = !DILocation(line: 51, column: 15, scope: !7)
!132 = !DILocation(line: 78, column: 10, scope: !133)
!133 = distinct !DILexicalBlock(scope: !129, file: !8, line: 78, column: 5)
!134 = !DILocation(line: 78, column: 19, scope: !135)
!135 = distinct !DILexicalBlock(scope: !133, file: !8, line: 78, column: 5)
!136 = !DILocation(line: 78, column: 5, scope: !133)
!137 = !DILocation(line: 79, column: 11, scope: !138)
!138 = distinct !DILexicalBlock(scope: !139, file: !8, line: 79, column: 11)
!139 = distinct !DILexicalBlock(scope: !135, file: !8, line: 78, column: 32)
!140 = !DILocation(line: 79, column: 20, scope: !138)
!141 = !DILocation(line: 79, column: 11, scope: !139)
!142 = !DILocation(line: 80, column: 34, scope: !143)
!143 = distinct !DILexicalBlock(scope: !138, file: !8, line: 79, column: 32)
!144 = !DILocalVariable(name: "tmp_begin", scope: !143, file: !8, line: 80, type: !65)
!145 = !DILocation(line: 80, column: 22, scope: !143)
!146 = !DILocation(line: 81, column: 32, scope: !143)
!147 = !DILocalVariable(name: "tmp_end", scope: !143, file: !8, line: 81, type: !65)
!148 = !DILocation(line: 81, column: 22, scope: !143)
!149 = !DILocation(line: 81, column: 9, scope: !143)
!150 = !DILocalVariable(name: "e", scope: !7, file: !8, line: 52, type: !65)
!151 = !DILocation(line: 52, column: 16, scope: !7)
!152 = !DILocation(line: 83, column: 14, scope: !153)
!153 = distinct !DILexicalBlock(scope: !143, file: !8, line: 83, column: 9)
!154 = !DILocation(line: 83, column: 31, scope: !155)
!155 = distinct !DILexicalBlock(scope: !153, file: !8, line: 83, column: 9)
!156 = !DILocation(line: 83, column: 9, scope: !153)
!157 = !DILocation(line: 84, column: 34, scope: !158)
!158 = distinct !DILexicalBlock(scope: !155, file: !8, line: 83, column: 47)
!159 = !DILocalVariable(name: "tmp_dst", scope: !158, file: !8, line: 84, type: !11)
!160 = !DILocation(line: 84, column: 24, scope: !158)
!161 = !DILocation(line: 85, column: 31, scope: !158)
!162 = !DILocalVariable(name: "tmp_level", scope: !158, file: !8, line: 85, type: !60)
!163 = !DILocation(line: 85, column: 19, scope: !158)
!164 = !DILocation(line: 87, column: 25, scope: !165)
!165 = distinct !DILexicalBlock(scope: !158, file: !8, line: 87, column: 15)
!166 = !DILocation(line: 87, column: 15, scope: !158)
!167 = !DILocation(line: 88, column: 38, scope: !168)
!168 = distinct !DILexicalBlock(scope: !165, file: !8, line: 87, column: 33)
!169 = !DILocation(line: 88, column: 13, scope: !168)
!170 = !DILocation(line: 88, column: 28, scope: !168)
!171 = !DILocation(line: 89, column: 13, scope: !168)
!172 = !DILocation(line: 90, column: 11, scope: !168)
!173 = !DILocation(line: 91, column: 9, scope: !158)
!174 = !DILocation(line: 83, column: 43, scope: !155)
!175 = !DILocation(line: 83, column: 9, scope: !155)
!176 = distinct !{!176, !156, !177, !178}
!177 = !DILocation(line: 91, column: 9, scope: !153)
!178 = !{!"llvm.loop.name", !"loop_neighbors"}
!179 = !DILocation(line: 92, column: 7, scope: !143)
!180 = !DILocation(line: 93, column: 5, scope: !139)
!181 = !DILocation(line: 78, column: 28, scope: !135)
!182 = !DILocation(line: 78, column: 5, scope: !135)
!183 = distinct !{!183, !136, !184, !185}
!184 = !DILocation(line: 93, column: 5, scope: !133)
!185 = !{!"llvm.loop.name", !"loop_nodes"}
!186 = !DILocation(line: 94, column: 31, scope: !187)
!187 = distinct !DILexicalBlock(scope: !129, file: !8, line: 94, column: 9)
!188 = !DILocation(line: 94, column: 10, scope: !187)
!189 = !DILocation(line: 94, column: 36, scope: !187)
!190 = !DILocation(line: 94, column: 43, scope: !187)
!191 = !DILocation(line: 94, column: 9, scope: !129)
!192 = !DILocation(line: 95, column: 7, scope: !187)
!193 = !DILocation(line: 96, column: 3, scope: !129)
!194 = !DILocation(line: 74, column: 46, scope: !124)
!195 = !DILocation(line: 74, column: 3, scope: !124)
!196 = distinct !{!196, !125, !197, !198}
!197 = !DILocation(line: 96, column: 3, scope: !122)
!198 = !{!"llvm.loop.name", !"loop_horizons"}
!199 = !DILocalVariable(name: "i", scope: !200, file: !8, line: 98, type: !12)
!200 = distinct !DILexicalBlock(scope: !7, file: !8, line: 98, column: 20)
!201 = !DILocation(line: 98, column: 29, scope: !200)
!202 = !DILocation(line: 98, column: 25, scope: !200)
!203 = !DILocation(line: 98, column: 38, scope: !204)
!204 = distinct !DILexicalBlock(scope: !200, file: !8, line: 98, column: 20)
!205 = !DILocation(line: 98, column: 20, scope: !200)
!206 = !DILocation(line: 99, column: 17, scope: !204)
!207 = !DILocation(line: 99, column: 5, scope: !204)
!208 = !DILocation(line: 99, column: 15, scope: !204)
!209 = !DILocation(line: 98, column: 47, scope: !204)
!210 = !DILocation(line: 98, column: 20, scope: !204)
!211 = distinct !{!211, !205, !212, !213}
!212 = !DILocation(line: 99, column: 24, scope: !200)
!213 = !{!"llvm.loop.name", !"VITIS_LOOP_98_4"}
!214 = !DILocalVariable(name: "i", scope: !215, file: !8, line: 101, type: !12)
!215 = distinct !DILexicalBlock(scope: !7, file: !8, line: 101, column: 21)
!216 = !DILocation(line: 101, column: 30, scope: !215)
!217 = !DILocation(line: 101, column: 26, scope: !215)
!218 = !DILocation(line: 101, column: 39, scope: !219)
!219 = distinct !DILexicalBlock(scope: !215, file: !8, line: 101, column: 21)
!220 = !DILocation(line: 101, column: 21, scope: !215)
!221 = !DILocation(line: 102, column: 24, scope: !219)
!222 = !DILocation(line: 102, column: 5, scope: !219)
!223 = !DILocation(line: 102, column: 22, scope: !219)
!224 = !DILocation(line: 101, column: 50, scope: !219)
!225 = !DILocation(line: 101, column: 21, scope: !219)
!226 = distinct !{!226, !220, !227, !228}
!227 = !DILocation(line: 102, column: 38, scope: !215)
!228 = !{!"llvm.loop.name", !"VITIS_LOOP_101_5"}
!229 = !DILocation(line: 103, column: 1, scope: !7)
