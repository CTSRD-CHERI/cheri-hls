...
for.end70:                                        ; preds = %if.then66, %for.cond30
  ...
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 %node, i32* %xlevel, i32* %decay.3, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp3), !dbg !101539
  ...
  call void @_Z21cheri_stream_write_nljPiS_Pj3Cap(i32 %levels, i32* %xlevel_counts, i32* %decay.4, i32* %flag_buf, %struct.Cap* byval align 4 %agg.tmp4), !dbg !101539
