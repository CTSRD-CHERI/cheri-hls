    ...
    for (int j = 0; j < size; j++)
      for (int k = 0; k < size; k++)
        n_points[i * blockSide * blockSide + j * blockSide + k] =
            xn_points[i * blockSide * blockSide + j * blockSide + k];

  for (int i = 0; i < size; i++)
    for (int j = 0; j < size; j++)
      for (int k = 0; k < size; k++)
        for (int h = 0; h < densityFactor; h++)
          force_ox[i * blockSide * blockSide * densityFactor +
                   j * blockSide * densityFactor + k * densityFactor + h] =
              force_x[i * blockSide * blockSide * densityFactor +
                      j * blockSide * densityFactor + k * densityFactor + h];
  for (int i = 0; i < size; i++)
    for (int j = 0; j < size; j++)
      for (int k = 0; k < size; k++)
        for (int h = 0; h < densityFactor; h++)
          force_oy[i * blockSide * blockSide * densityFactor +
                   j * blockSide * densityFactor + k * densityFactor + h] =
              force_y[i * blockSide * blockSide * densityFactor +
                      j * blockSide * densityFactor + k * densityFactor + h];
  for (int i = 0; i < size; i++)
    for (int j = 0; j < size; j++)
      for (int k = 0; k < size; k++)
        for (int h = 0; h < densityFactor; h++)
          force_oz[i * blockSide * blockSide * densityFactor +
                   j * blockSide * densityFactor + k * densityFactor + h] =
              force_z[i * blockSide * blockSide * densityFactor +
                      j * blockSide * densityFactor + k * densityFactor + h];
  for (int i = 0; i < size; i++)
    for (int j = 0; j < size; j++)
      for (int k = 0; k < size; k++)
        for (int h = 0; h < densityFactor; h++)
          position_ox[i * blockSide * blockSide * densityFactor +
                      j * blockSide * densityFactor + k * densityFactor + h] =
              position_x[i * blockSide * blockSide * densityFactor +
                         j * blockSide * densityFactor + k * densityFactor + h];
  for (int i = 0; i < size; i++)
    for (int j = 0; j < size; j++)
      for (int k = 0; k < size; k++)
        for (int h = 0; h < densityFactor; h++)
          position_oy[i * blockSide * blockSide * densityFactor +
                      j * blockSide * densityFactor + k * densityFactor + h] =
              position_y[i * blockSide * blockSide * densityFactor +
                         j * blockSide * densityFactor + k * densityFactor + h];
  for (int i = 0; i < size; i++)
    for (int j = 0; j < size; j++)
      for (int k = 0; k < size; k++)
        for (int h = 0; h < densityFactor; h++)
          position_oz[i * blockSide * blockSide * densityFactor +
                      j * blockSide * densityFactor + k * densityFactor + h] =
              position_z[i * blockSide * blockSide * densityFactor +
                         j * blockSide * densityFactor + k * densityFactor + h];
